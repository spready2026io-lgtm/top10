    ...
    <div className="min-h-screen bg-[var(--ss-page)] text-[var(--ss-ink)]">
      ...
      <header className="border-b border-[var(--ss-border)] px-4 py-4 flex items-center justify-between">
        ...
        <span className="flex items-center gap-3">
          <ThemeToggle />
          <Link href="/conviction" className="text-[var(--ss-green)] hover:text-[var(--ss-green-text)] text-xs transition-colors">Conviction Board</Link>
        </span>
      </header>
        ...
        <div className="mb-8 p-6 bg-[var(--ss-card)] border border-[var(--ss-border)] rounded-2xl">
          ...
          {world && (
            <p className="text-sm text-[var(--ss-text)] leading-relaxed mt-3 max-w-2xl">
              ...
              the <Link href="/markets" className="text-[var(--ss-ink)] underline decoration-[var(--ss-border-strong)] hover:decoration-[var(--ss-muted)]">World Markets</Link> board.
            </p>
          )}
                ...
                {'markets' in world ? (
                  <>
                    ...
                    <p className="text-[11px] text-[var(--ss-text)] mt-3 leading-relaxed">
                      ...
                      <Link href="/markets" className="text-[var(--ss-ink)] underline decoration-[var(--ss-border-strong)] hover:decoration-[var(--ss-muted)]"> World Markets</Link> board.
