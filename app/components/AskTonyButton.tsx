...
export default function AskTonyButton() {
  ...
  return (
    <Link
      ...
      title="Ask Tony"
      className="group fixed bottom-6 right-6 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#059669] hover:bg-[#047857] text-white shadow-lg shadow-[#059669]/25 active:scale-95 transition-all"
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-md border border-[#e6e9ef] bg-white px-2.5 py-1 text-xs font-semibold text-[#0B1220] opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100">
        Ask Tony
      </span>
    </Link>
  );
