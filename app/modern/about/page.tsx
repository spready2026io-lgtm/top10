  ...
  return (
    <main className="min-h-screen" style={{ background: 'var(--ss-page)', color: 'var(--ss-ink)' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-14">
        ...
        {/* Hero */}
        <section>
          <h2 className="text-2xl font-bold text-[var(--ss-ink)] mb-3">What is Stockscout?</h2>
        ...
        {/* What is an ETF */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">What is an ETF?</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
          ...
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
            Stockscout tracks <span className="text-[var(--ss-ink)] font-semibold">{totalEtfs} ETFs</span>
          ...
          {/* ETF table */}
          <div className="mt-5 rounded-xl border border-[var(--ss-border)] bg-[var(--ss-card)] overflow-hidden">
            <div className="px-4 py-3 border-b border-[var(--ss-border)] flex items-center justify-between">
              <p className="text-[var(--ss-ink)] text-xs font-semibold uppercase tracking-wider">Tracked ETFs, {totalEtfs} funds</p>
              <p className="text-[var(--ss-muted)] text-xs">as of {SCAN_TIMESTAMP_NY}</p>
            </div>
            {THEMES.map((theme, i) => {
              const list = THEME_ETFS[theme];
              return (
                <div key={theme} className={`px-4 py-3 text-sm ${i % 2 === 0 ? 'bg-[var(--ss-card)]' : 'bg-[var(--ss-inset)]'}`}>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[var(--ss-ink)] font-semibold w-36 flex-shrink-0">{theme}</span>
                    <span className="text-[var(--ss-muted)] text-xs">{list.length} ETFs</span>
                  </div>
                  <span className="text-[var(--ss-muted)] text-xs font-mono">{list.join(', ')}</span>
                </div>
              );
            })}
          </div>
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">And the rest of the world?</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
            The conviction rankings are built from US-listed active funds. The rest of the world gets
            its own board.
          </p>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
            The <Link href="/modern/markets" className="text-[var(--ss-green)] hover:text-[var(--ss-green-text)] font-semibold">World Markets</Link> page
          ...
          <p className="text-[var(--ss-text)] text-sm leading-relaxed">
            ...
            {' '}<Link href="/modern/portfolio" className="text-[var(--ss-green)] hover:text-[var(--ss-green-text)] font-semibold">Portfolio Builder</Link>.
        ...
        {/* The scores */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">The Scores</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-5">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-[var(--ss-border)] bg-[var(--ss-card)] p-5">
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center border text-xs font-bold px-2 py-0.5 rounded-full bg-[var(--ss-green-tint)] border-[var(--ss-green-tint-border)] text-[var(--ss-green-text)]">{aiN - 1}/{aiN}</span>
                <h3 className="text-[var(--ss-ink)] font-semibold">Coverage Score</h3>
              </div>
              <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-2">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <span className="inline-flex items-center border text-xs font-bold px-1.5 py-0.5 rounded-full bg-[var(--ss-green-tint)] border-[var(--ss-green-tint-border)] text-[var(--ss-green-text)]">{aiN}/{aiN}</span>
                  <span className="text-[var(--ss-text)]">100% coverage. Every ETF in the theme holds this stock. Maximum breadth.</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="inline-flex items-center border text-xs font-bold px-1.5 py-0.5 rounded-full bg-[var(--ss-avatar-blue-1)] border-[var(--ss-avatar-blue-2)] text-[var(--ss-blue)]">8/{aiN}</span>
                  <span className="text-[var(--ss-text)]">Strong. ~{Math.round((8 / aiN) * 100)}% coverage. A few ETFs are out. Still a high-conviction name.</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="inline-flex items-center border text-xs font-bold px-1.5 py-0.5 rounded-full bg-[var(--ss-amber-bg)] border-[var(--ss-amber-border)] text-[var(--ss-amber-text)]">5/{aiN}</span>
                  <span className="text-[var(--ss-text)]">Moderate. ~{Math.round((5 / aiN) * 100)}% coverage. Held by roughly half the theme. More specialised exposure.</span>
                </li>
              </ul>
              <p className="text-[var(--ss-muted)] text-xs mt-3">
            ...
            <div className="rounded-xl border border-[var(--ss-border)] bg-[var(--ss-card)] p-5">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-[var(--ss-green)] font-bold text-sm">6.16% avg wt</span>
                <h3 className="text-[var(--ss-ink)] font-semibold">Weight Score</h3>
              </div>
              <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-2">
                The average portfolio weight this stock receives across every theme ETF, counting funds that do not
                hold it as 0%. The full formula is: <span className="text-[var(--ss-text)] font-mono text-xs">avgWeight x coverage</span>.
            ...
            <div className="rounded-xl border border-[var(--ss-border)] bg-[var(--ss-card)] p-5">
              <div className="flex items-center gap-2 mb-2">
                <span className="inline-flex items-center gap-1 bg-emerald-500/15 border border-emerald-500/30 text-[var(--ss-green-text)] text-xs font-bold px-2 py-0.5 rounded-full">+45% Velocity</span>
                <h3 className="text-[var(--ss-ink)] font-semibold">Velocity Score</h3>
              </div>
              <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-2">
              ...
              <ul className="space-y-1 text-sm mt-3">
                <li className="flex items-start gap-2">
                  <span className="text-[var(--ss-green)] font-bold flex-shrink-0 mt-0.5">+</span>
                  <span className="text-[var(--ss-text)]">Positive VS (green). Conviction is growing. Funds are adding or weighting up.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--ss-amber)] font-bold flex-shrink-0 mt-0.5">-</span>
                  <span className="text-[var(--ss-text)]">Negative VS (red). Conviction is fading. Funds are trimming or dropping the stock.</span>
                </li>
              </ul>
              <p className="text-[var(--ss-muted)] text-xs mt-3">
        ...
        {/* The chart */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">Top10 vs S&P500 Chart</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
          ...
          <ul className="space-y-2 mb-4">
            <li className="flex items-start gap-2">
              ...
              <div>
                <span className="text-[var(--ss-ink)] text-sm font-semibold">Top10 line (green).</span>
                <span className="text-[var(--ss-text)] text-sm"> The equal-weighted average return of the 10 highest-conviction names in this theme.</span>
              </div>
            </li>
            <li className="flex items-start gap-2">
              <div className="w-4 h-0.5 bg-sky-400 rounded-full mt-2 flex-shrink-0 opacity-65" />
              <div>
                <span className="text-[var(--ss-ink)] text-sm font-semibold">S&P500 line (blue).</span>
                <span className="text-[var(--ss-text)] text-sm"> The return of the broader U.S. market over the same period.</span>
              </div>
            </li>
          </ul>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
        ...
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">Theme ETF Performance Tile</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
        ...
        {/* Tile detail */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">Reading a Stock Tile</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-[var(--ss-border)] bg-[var(--ss-card)] p-4">
              <p className="text-[var(--ss-ink)] font-semibold text-sm mb-2">Front face</p>
              <ul className="space-y-1.5 text-sm text-[var(--ss-text)]">
                <li><span className="text-[var(--ss-text)] font-medium">Logo and name.</span> Company identity at a glance.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Ticker.</span> The stock symbol.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Coverage badge.</span> ETF ownership breadth (x/n, relative to theme).</li>
                <li><span className="text-[var(--ss-text)] font-medium">Price and period return.</span> Current price and return for the selected period.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Weight Score.</span> Average ETF weighting across holders.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Velocity Score badge.</span> Green (+) or red (-) showing how fast Weight Score is changing.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Price chart.</span> Adjust the period using 1W / 1M / YTD / 6M / 1Y.</li>
              </ul>
            </div>
            <div className="rounded-xl border border-[var(--ss-green-tint-border)] bg-[var(--ss-card)] p-4">
              <p className="text-[var(--ss-ink)] font-semibold text-sm mb-2">Back face</p>
              <ul className="space-y-1.5 text-sm text-[var(--ss-text)]">
                <li><span className="text-[var(--ss-text)] font-medium">ETF presence.</span> Which ETFs hold the stock and which do not.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Key financials.</span> Market cap, P/E, EPS, revenue growth, gross margin, dividend yield.</li>
                <li><span className="text-[var(--ss-text)] font-medium">Tony&apos;s Analysis.</span> Investment thesis, key risks, and what to watch.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        {/* Tony's analysis */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">Tony&apos;s Analysis</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
        ...
        {/* How to use */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">How to Use Stockscout</h2>
          <ol className="space-y-3">
            {[
              ...
              <li key={n} className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--ss-green-tint)] border border-[var(--ss-green-tint-border)] text-[var(--ss-green-text)] text-xs font-bold flex items-center justify-center mt-0.5">
                  {n}
                </span>
                <p className="text-[var(--ss-text)] text-sm leading-relaxed">
                  <span className="text-[var(--ss-ink)] font-semibold">{title}</span>{' '}
                  {body}
                </p>
              </li>
            ))}
        ...
        {/* The data */}
        <section>
          <h2 className="text-xl font-bold text-[var(--ss-ink)] mb-4">The Data</h2>
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
        ...
        {/* Disclaimer */}
        <p className="text-xs border-t pt-6" style={{ color: 'var(--ss-muted)', borderColor: 'var(--ss-border)' }}>
