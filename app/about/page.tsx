    ...
    <main className="min-h-screen" style={{ background: 'var(--ss-page)', color: 'var(--ss-ink)' }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-14">
        ...
        <section>
          ...
          <p className="text-[var(--ss-text)] text-sm leading-relaxed mb-3">
            The <Link href="/markets" className="text-[var(--ss-green)] hover:text-[var(--ss-green-text)] font-semibold">World Markets</Link> page
          ...
          <p className="text-[var(--ss-text)] text-sm leading-relaxed">
            ...
            {' '}<Link href="/portfolio" className="text-[var(--ss-green)] hover:text-[var(--ss-green-text)] font-semibold">Portfolio Builder</Link>.
