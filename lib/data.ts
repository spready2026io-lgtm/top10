...
export const SCAN_TIMESTAMP    = '2026-06-03T10:31:26.275Z';
export const SCAN_TIMESTAMP_NY = 'June 3, 2026 at 6:31 AM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 15.61, bestProScore: 7.11, price: 1064.10, weeklyChange: 14.62 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.23, bestProScore: 5.18, price: 521.54, weeklyChange: 5.25 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 10.83, bestProScore: 5.64, price: 222.82, weeklyChange: 4.81 },
  { ticker: 'AVGO', name: `Broadcom Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 7.64, bestProScore: 3.43, price: 481.57, weeklyChange: 14.15 },
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 5.68, bestProScore: 2.57, price: 290.79, weeklyChange: 46.35 },
  { ticker: 'POWL', name: `Powell Industries, Inc.`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 6.66, bestProScore: 4.05, price: 299.07, weeklyChange: 1.06 },
  { ticker: 'TSM', name: `Taiwan Semiconductor Manufacturing Co Ltd ADR`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 4.39, bestProScore: 2.53, price: 446.69, weeklyChange: 5.67 },
  { ticker: 'ETN', name: `Eaton Corp PLC`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 3.55, bestProScore: 2.41, price: 417.62, weeklyChange: 2.77 },
  { ticker: 'INTC', name: `INTEL CORPORATION`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 3.40, bestProScore: 2.33, price: 107.93, weeklyChange: -11.37 },
  { ticker: 'LRCX', name: `LAM RESEARCH CORP`, themeCount: 2, themes: ['Semiconductors', 'Broad Tech'], aggregateScore: 3.34, bestProScore: 1.90, price: 334.41, weeklyChange: 4.85 },
];
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'AI & ML': [
    {
      ticker: 'MU', name: 'Micron Technology Inc', easyScore: 9, avgWeight: 7.08, proScore: 5.79, coverage: 0.818,
      ...
      velocityScore: { '1D': -11.7, '1W': -4.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.2T', pe: 50.2, revenueGrowth: 196, eps: 21.18, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { AIS: 8.22, ARTY: 7.51, BAI: 5.92, IVEP: false, IGPT: 12.36, IVES: 5.88, ALAI: 1.16, CHAT: 6.32, AIFD: 6.46, SPRX: false, AOTG: 9.91 },
    ...
    },
    {
      ...
      velocityScore: { '1D': -4.4, '1W': 2.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.4T', pe: 34.1, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.45,
      etfPresence: { AIS: 2.5, ARTY: 3.59, BAI: 4.61, IVEP: false, IGPT: 5.93, IVES: 4.62, ALAI: 13.38, CHAT: 5.84, AIFD: 6.74, SPRX: 3.99, AOTG: 10.84 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 4.46, ARTY: 7.1, BAI: 4.89, IVEP: false, IGPT: 7.03, IVES: 4.61, ALAI: 1.05, CHAT: 5.51, AIFD: false, SPRX: 0.54, AOTG: 14.82 },
    ...
    {
      ticker: 'AVGO', name: 'Broadcom Inc', easyScore: 8, avgWeight: 3.89, proScore: 2.83, coverage: 0.727,
      ...
      velocityScore: { '1D': -13.2, '1W': -12.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.3T', pe: 93.5, revenueGrowth: 30, eps: 5.15, grossMargin: 77, dividendYield: 0.54,
      etfPresence: { AIS: 0.79, ARTY: 3.8, BAI: 5.46, IVEP: false, IGPT: false, IVES: 4.98, ALAI: 4.94, CHAT: 3.37, AIFD: 6.14, SPRX: false, AOTG: 1.68 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 3.16, ARTY: false, BAI: 4.3, IVEP: false, IGPT: false, IVES: 4.74, ALAI: 5.56, CHAT: false, AIFD: 3.2, SPRX: false, AOTG: 6.88 },
    ...
    {
      ticker: 'GOOGL', name: 'ALPHABET INC CLASS A', easyScore: 6, avgWeight: 4.61, proScore: 2.52, coverage: 0.545,
      ...
      velocityScore: { '1D': -28.4, '1W': -32.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4.4T', pe: 27.6, revenueGrowth: 22, eps: 13.1, grossMargin: 60, dividendYield: 0.24,
      etfPresence: { AIS: false, ARTY: false, BAI: 3.56, IVEP: false, IGPT: 6, IVES: 4.07, ALAI: false, CHAT: 5.07, AIFD: 5.02, SPRX: false, AOTG: 3.97 },
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 6, avgWeight: 3.68, proScore: 2.01, coverage: 0.545,
      ...
      velocityScore: { '1D': -21.2, '1W': -15.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$254B', pe: 99.9, revenueGrowth: 28, eps: 2.91, grossMargin: 52, dividendYield: 0.08,
      etfPresence: { AIS: 4.37, ARTY: 6.67, BAI: 1.05, IVEP: false, IGPT: false, IVES: false, ALAI: false, CHAT: 1.74, AIFD: 4.95, SPRX: 3.32, AOTG: false },
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 5, avgWeight: 3.78, proScore: 1.72, coverage: 0.455,
      ...
      velocityScore: { '1D': -31.5, '1W': -31.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$3.3T', pe: 26.3, revenueGrowth: 18, eps: 16.77, grossMargin: 68, dividendYield: 0.82,
      etfPresence: { AIS: false, ARTY: 1.88, BAI: false, IVEP: false, IGPT: false, IVES: 4.6, ALAI: 5.53, CHAT: 2.91, AIFD: false, SPRX: false, AOTG: 3.98 },
    ...
    {
      ticker: 'ALAB', name: 'Astera Labs Inc', easyScore: 6, avgWeight: 2.87, proScore: 1.56, coverage: 0.545,
      ...
      velocityScore: { '1D': -26.8, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$61B', pe: 238.8, revenueGrowth: 93, eps: 1.49, grossMargin: 76, dividendYield: null,
      etfPresence: { AIS: 1.76, ARTY: 1.47, BAI: false, IVEP: false, IGPT: 0.8, IVES: false, ALAI: 1.76, CHAT: 3.75, AIFD: false, SPRX: 7.66, AOTG: false },
    ...
    {
      ticker: 'ANET', name: 'Arista Networks Inc', easyScore: 7, avgWeight: 2.34, proScore: 1.49, coverage: 0.636,
      ...
      etfPresence: { AIS: 1.44, ARTY: 2, BAI: 1.42, IVEP: false, IGPT: false, IVES: false, ALAI: 1.03, CHAT: 2.42, AIFD: 4.93, SPRX: 3.17, AOTG: false },
    ...
    {
      ticker: 'META', name: 'Meta Platforms Inc', easyScore: 5, avgWeight: 3.17, proScore: 1.44, coverage: 0.455,
      ...
      velocityScore: { '1D': -29.4, '1W': -46.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.5T', pe: 21.7, revenueGrowth: 33, eps: 27.49, grossMargin: 82, dividendYield: 0.35,
      etfPresence: { AIS: false, ARTY: false, BAI: false, IVEP: false, IGPT: 4.55, IVES: 4.13, ALAI: 3.85, CHAT: 2.19, AIFD: false, SPRX: false, AOTG: 1.1 },
    ...
    {
      ticker: 'WDC', name: 'Western Digital Corp', easyScore: 6, avgWeight: 2.6, proScore: 1.42, coverage: 0.545,
      ...
      velocityScore: { '1D': null, '1W': -29, '1M': null, '6M': null }, isNew: true,
      marketCap: '$194B', pe: 33.7, revenueGrowth: 46, eps: 16.72, grossMargin: 45, dividendYield: 0.11,
      etfPresence: { AIS: 1.5, ARTY: 2.58, BAI: 2.83, IVEP: false, IGPT: 3.05, IVES: false, ALAI: 4.5, CHAT: 1.13, AIFD: false, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'VRT', name: 'Vertiv Holdings Co', easyScore: 5, avgWeight: 2.96, proScore: 1.35, coverage: 0.455,
      ...
      etfPresence: { AIS: 3.75, ARTY: false, BAI: 1.96, IVEP: 4.22, IGPT: false, IVES: false, ALAI: false, CHAT: 0.85, AIFD: 4.03, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'ORCL', name: 'ORACLE CORP', easyScore: 4, avgWeight: 3.57, proScore: 1.3, coverage: 0.364,
      ...
      velocityScore: { '1D': -29.3, '1W': -29.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$703B', pe: 44, revenueGrowth: 22, eps: 5.56, grossMargin: 67, dividendYield: 0.82,
      etfPresence: { AIS: false, ARTY: 4.62, BAI: false, IVEP: false, IGPT: false, IVES: 4.42, ALAI: false, CHAT: 1.73, AIFD: false, SPRX: false, AOTG: 3.51 },
    ...
    {
      ticker: 'LITE', name: 'LUMENTUM HOLDINGS INC', easyScore: 4, avgWeight: 3.33, proScore: 1.21, coverage: 0.364,
      ...
      velocityScore: { '1D': -38.3, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$80B', pe: 181.8, revenueGrowth: 90, eps: 5.66, grossMargin: 41, dividendYield: null,
      etfPresence: { AIS: false, ARTY: false, BAI: 2.8, IVEP: false, IGPT: false, IVES: false, ALAI: false, CHAT: 1.13, AIFD: 5.95, SPRX: 3.44, AOTG: false },
    ...
    {
      ticker: 'INTC', name: 'Intel Corp', easyScore: 3, avgWeight: 3.91, proScore: 1.07, coverage: 0.273,
      ...
      velocityScore: { '1D': -48.3, '1W': -62.5, '1M': null, '6M': null }, isNew: false,
  ...
  'Semiconductors': [
    {
      ticker: 'MU', name: 'MICRON TECHNOLOGY INC', easyScore: 4, avgWeight: 7.11, proScore: 7.11, coverage: 1,
      price: 1064.1, weeklyPrices: [928.41, 923.52, 971.00, 1035.50, 1064.10], weeklyChange: 14.62, sortRank: 0, periodReturns: { '1M': 96.3, '6M': 344.3, '1Y': 940.7 },
      priceHistory: { '1W': [928.41, 923.52, 971, 1035.5, 1064.1], '1M': [576.45, 640.2, 666.59, 646.63, 746.81, 795.33, 766.58, 803.63, 776.01, 724.66, 681.54, 698.74, 731.99, 762.1, 751, 895.88, 928.41, 923.52, 971, 1035.5, 1064.1], '6M': [239.49, 252.42, 232.51, 276.27, 285.41, 327.02, 336.63, 399.65, 414.88, 394.69, 411.66, 420.97, 412.67, 370.3, 426.13, 422.9, 357.22, 377.76, 426.56, 448.42, 524.56, 576.45, 795.33, 681.54, 895.88, 1064.1], '1Y': [102.25, 114.14, 120.34, 127.25, 121.74, 123.11, 116.43, 109.83, 114.74, 108.78, 124.27, 117.21, 117.75, 124.21, 150.57, 168.89, 161.71, 182.15, 196.54, 191.94, 198.47, 226.63, 237.5, 244.9, 225.92, 230.26, 234.16, 263.71, 225.52, 286.68, 315.42, 345.09, 362.75, 389.09, 437.8, 383.5, 411.66, 420.97, 412.67, 389.32, 441.8, 404.35, 321.8, 377.58, 465.66, 449.38, 524.56, 576.45, 795.33, 681.54, 895.88, 1064.1] },
      velocityScore: { '1D': -1.5, '1W': 10.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.2T', pe: 50.2, revenueGrowth: 196, eps: 21.18, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { SOXX: 12.33, PSI: 7.97, XSD: 3.75, DRAM: 4.4 },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
      ticker: 'AMD', name: 'ADVANCED MICRO DEVICES INC', easyScore: 3, avgWeight: 6.91, proScore: 5.18, coverage: 0.75,
      price: 521.54, weeklyPrices: [495.54, 518.09, 516.10, 510.13, 521.54], weeklyChange: 5.25, sortRank: 0, periodReturns: { '1M': 44.7, '6M': 142.3, '1Y': 344.6 },
      priceHistory: { '1W': [495.54, 518.09, 516.1, 510.13, 521.54], '1M': [341.54, 355.26, 421.39, 408.46, 455.19, 458.79, 448.29, 445.5, 449.7, 424.1, 420.99, 414.05, 447.58, 449.59, 467.51, 503.89, 495.54, 518.09, 516.1, 510.13, 521.54], '6M': [215.24, 221.62, 209.17, 214.9, 214.16, 204.68, 227.92, 259.68, 236.73, 208.44, 207.32, 196.6, 198.62, 192.43, 193.39, 201.33, 201.99, 220.18, 246.83, 274.95, 334.63, 341.54, 458.79, 420.99, 503.89, 521.54], '1Y': [117.31, 123.24, 127.1, 143.4, 138.52, 144.16, 160.08, 158.65, 179.51, 163.12, 184.42, 165.2, 167.13, 161.79, 155.67, 157.92, 160.88, 164.01, 235.56, 238.6, 230.23, 264.33, 256.33, 258.89, 223.55, 214.24, 217.6, 221.42, 198.11, 215.04, 223.47, 203.17, 231.83, 251.31, 246.27, 216, 207.32, 196.6, 198.62, 202.68, 196.58, 202.68, 196.04, 221.53, 255.07, 284.49, 334.63, 341.54, 458.79, 420.99, 503.89, 521.54] },
      velocityScore: { '1D': -14.2, '1W': -11, '1M': null, '6M': null }, isNew: false,
      marketCap: '$850B', pe: 172.7, revenueGrowth: 38, eps: 3.02, grossMargin: 53, dividendYield: null,
      etfPresence: { SOXX: 9.33, PSI: 7.62, XSD: 3.77, DRAM: false },
      tonyNote: 'AMD scores highest in Semiconductors at 7.0% average weight, held by 3 of 4 chip ETFs. Revenue grew 38% with 53% gross margins and EPS of $2.99 — improving but still stretched at a P/E of 172x. The 1-year return of 366% compresses future upside; the weight score says ETF managers are committed, but valuation is the variable to watch.',
    },
    {
      ticker: 'MXL', name: 'MaxLinear Inc', easyScore: 2, avgWeight: 7.1, proScore: 3.55, coverage: 0.5,
      ...
      velocityScore: { '1D': -30.1, '1W': -34, '1M': null, '6M': null }, isNew: false,
      marketCap: '$8B', pe: null, revenueGrowth: 43, eps: -1.52, grossMargin: 57, dividendYield: null,
      etfPresence: { SOXX: false, PSI: 8.3, XSD: 5.9, DRAM: false },
    ...
    {
      ticker: 'AVGO', name: 'BROADCOM INC', easyScore: 3, avgWeight: 4.58, proScore: 3.43, coverage: 0.75,
      price: 481.57, weeklyPrices: [421.86, 426.58, 446.77, 459.97, 481.57], weeklyChange: 14.15, sortRank: 0, periodReturns: { '1M': 14.3, '6M': 26.2, '1Y': 87.5 },
      priceHistory: { '1W': [421.86, 426.58, 446.77, 459.97, 481.57], '1M': [416.5, 427.36, 425.44, 412.56, 430, 428.43, 419.3, 416.79, 439.79, 425.19, 420.71, 411.07, 417.76, 414.57, 414.14, 422.01, 421.86, 426.58, 446.77, 459.97, 481.57], '6M': [381.57, 406.29, 341.3, 349.32, 346.1, 332.48, 343.02, 320.05, 331.3, 332.92, 325.17, 330.34, 318.82, 330.48, 322.16, 310.51, 300.68, 314.43, 379.75, 399.63, 418.2, 416.5, 428.43, 420.71, 422.01, 481.57], '1Y': [256.85, 244.63, 249.37, 264.65, 269.9, 275.4, 280.81, 283.69, 302.62, 301.67, 309.09, 291.17, 300.25, 306.1, 359.63, 345.35, 339.31, 333.39, 345.5, 351.33, 340.3, 385.98, 358.98, 355.22, 354.42, 397.57, 380.61, 412.97, 326.02, 350.22, 347.62, 344.97, 351.71, 324.85, 331.11, 343.94, 325.17, 330.34, 318.82, 345.75, 324.92, 322.51, 293.41, 333.97, 380.78, 402.17, 418.2, 416.5, 428.43, 420.71, 422.01, 481.57] },
      velocityScore: { '1D': -13.6, '1W': -3.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.3T', pe: 93.5, revenueGrowth: 30, eps: 5.15, grossMargin: 77, dividendYield: 0.54,
      etfPresence: { SOXX: 7.07, PSI: 4.62, XSD: 2.04, DRAM: false },
      tonyNote: 'Broadcom appears in 6 of 8 AI ETFs and 3 of 4 Semiconductor ETFs, making it one of the most consistent cross-theme holdings. Revenue grew 30%, gross margin is 77% — the highest in the theme — and it pays a 0.58% dividend. The 87x P/E is the only friction; ETF managers are paying a premium for a recurring-revenue AI infrastructure name.',
    },
    {
      ticker: 'NVDA', name: 'NVIDIA CORP', easyScore: 3, avgWeight: 3.89, proScore: 2.92, coverage: 0.75,
      price: 222.82, weeklyPrices: [212.60, 214.25, 211.14, 224.36, 222.82], weeklyChange: 4.81, sortRank: 0, periodReturns: { '1M': 12.3, '6M': 22.8, '1Y': 57.8 },
      priceHistory: { '1W': [212.6, 214.25, 211.14, 224.36, 222.82], '1M': [198.48, 196.5, 207.83, 211.5, 215.2, 219.44, 220.78, 225.83, 235.74, 225.32, 222.32, 220.61, 223.47, 219.51, 215.33, 214.86, 212.6, 214.25, 211.14, 224.36, 222.82], '6M': [181.46, 184.97, 177.72, 189.21, 186.5, 185.04, 187.05, 187.67, 191.13, 185.41, 182.81, 191.55, 182.48, 177.82, 180.25, 172.7, 167.52, 177.64, 189.31, 202.06, 216.61, 198.48, 219.44, 222.32, 214.86, 222.82], '1Y': [141.22, 143.96, 144.12, 154.31, 157.25, 164.1, 171.37, 170.78, 179.27, 179.42, 181.59, 175.4, 181.6, 171.66, 177.17, 176.24, 176.97, 187.24, 189.11, 179.83, 180.28, 207.04, 195.21, 193.8, 186.52, 180.26, 179.59, 183.78, 170.94, 188.61, 188.85, 184.86, 186.23, 186.47, 185.61, 190.04, 182.81, 191.55, 182.48, 182.65, 183.22, 175.64, 165.17, 178.1, 196.51, 199.88, 216.61, 198.48, 219.44, 222.32, 214.86, 222.82] },
      velocityScore: { '1D': -14.9, '1W': -9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.4T', pe: 34.1, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.45,
      etfPresence: { SOXX: 6.22, PSI: 3.61, XSD: 1.83, DRAM: false },
      tonyNote: 'NVIDIA sits at 88% AI ETF coverage with a 5.6% average weight — the broadest institutional consensus in the theme. At a $5.1T market cap and 74% gross margin, the business is printing cash, but the 1-year return of 56% signals the easy money has been made. The score reflects the depth of institutional commitment, not a fresh entry signal.',
    },
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 2, avgWeight: 5.13, proScore: 2.57, coverage: 0.5,
      price: 290.79, weeklyPrices: [198.70, 204.83, 205.00, 219.43, 290.79], weeklyChange: 46.35, sortRank: 0, periodReturns: { '1M': 76.3, '6M': 213, '1Y': 366.3 },
      priceHistory: { '1W': [198.7, 204.83, 205, 219.43, 290.79], '1M': [163.66, 168.75, 172.15, 160.01, 170.13, 170.84, 164.5, 177.95, 182.58, 176.89, 168.93, 176.27, 186.8, 190.69, 196.33, 208.26, 198.7, 204.83, 205, 219.43, 290.79], '6M': [92.89, 88.9, 84.07, 87.68, 84.98, 83.45, 80.38, 80.23, 78.92, 80.28, 78.61, 77.79, 80.86, 89.57, 87.86, 87.91, 94.88, 109.51, 131.3, 147.84, 158.21, 163.66, 170.84, 168.93, 208.26, 290.79], '1Y': [62.36, 68.84, 69.99, 75.93, 74.25, 73.36, 70.85, 73.27, 81.74, 75.32, 79.32, 71.22, 74.79, 64.1, 66.59, 74.23, 80.09, 83.89, 92.5, 88.89, 81.05, 90.15, 92.9, 89.33, 81.32, 87.72, 100.2, 92.47, 81.7, 86.49, 89.39, 83.22, 80.46, 81.77, 78.66, 82.35, 78.61, 77.79, 80.86, 92.65, 91.58, 90.16, 87.81, 109.38, 133.83, 151.31, 158.21, 163.66, 170.84, 168.93, 208.26, 290.79] },
      velocityScore: { '1D': -29.2, '1W': -24.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$254B', pe: 99.9, revenueGrowth: 28, eps: 2.91, grossMargin: 52, dividendYield: 0.08,
      etfPresence: { SOXX: 6.59, PSI: false, XSD: 3.68, DRAM: false },
      tonyNote: 'Marvell scores across three themes — AI, Semiconductors, and Broad Tech — at average weights of 3.7-4.7%. Revenue grew 28%, gross margin at 52%, P/E of 70x. Custom AI silicon for hyperscalers is the thesis, and the 241% 1-year return says the market is pricing it aggressively. The cross-theme ETF presence is the strongest signal of institutional conviction.',
    },
    {
      ticker: 'TXN', name: 'TEXAS INSTRUMENT INC', easyScore: 3, avgWeight: 3.38, proScore: 2.54, coverage: 0.75,
      ...
      velocityScore: { '1D': -13.3, '1W': -19.1, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'INTC', name: 'INTEL CORPORATION', easyScore: 2, avgWeight: 4.67, proScore: 2.33, coverage: 0.5,
      price: 107.93, weeklyPrices: [121.77, 120.89, 114.68, 109.33, 107.93], weeklyChange: -11.37, sortRank: 0, periodReturns: { '1M': 8.3, '6M': 148.3, '1Y': 431.9 },
      priceHistory: { '1W': [121.77, 120.89, 114.68, 109.33, 107.93], '1M': [95.78, 108.15, 113.01, 109.62, 124.92, 129.44, 120.61, 120.29, 115.93, 108.77, 108.17, 110.8, 118.96, 118.5, 119.84, 123.52, 121.77, 120.89, 114.68, 109.33, 107.93], '6M': [43.47, 40.5, 37.31, 36.35, 36.9, 41.11, 48.32, 45.07, 46.47, 50.59, 46.79, 43.63, 45.5, 43.42, 45.77, 43.87, 43.13, 50.78, 65.18, 65.7, 84.99, 95.78, 129.44, 108.17, 123.52, 107.93], '1Y': [20.29, 22.08, 20.8, 22.2, 21.88, 23.82, 22.69, 23.49, 20.34, 20.41, 22.22, 23.54, 24.85, 24.61, 24.61, 30.57, 31.22, 35.94, 37.43, 37.15, 36.92, 41.34, 38.38, 37.89, 35.11, 36.81, 43.76, 40.78, 36.05, 36.16, 39.38, 45.55, 46.96, 42.49, 48.81, 50.24, 46.79, 43.63, 45.5, 45.58, 45.76, 44.01, 41.19, 52.91, 63.81, 66.26, 84.99, 95.78, 129.44, 108.17, 123.52, 107.93] },
      velocityScore: { '1D': -29.4, '1W': -36.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$542B', pe: null, revenueGrowth: 7, eps: -0.6, grossMargin: 37, dividendYield: null,
      etfPresence: { SOXX: 5.88, PSI: false, XSD: 3.45, DRAM: false },
      tonyNote: 'Intel is a turnaround bet — negative EPS, no dividend, 37% gross margin, and only 7% revenue growth. It appears in 3 AI ETFs and 2 Semiconductor ETFs because of its foundry ambitions, not current performance. The 487% 1-year return is price recovery off a historic low; at current levels the weight score reflects speculative positioning, not fundamental conviction.',
    },
    {
      ticker: 'ON', name: 'ON SEMICONDUCTOR CORP', easyScore: 3, avgWeight: 2.87, proScore: 2.16, coverage: 0.75,
      ...
      velocityScore: { '1D': 11.3, '1W': 9.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$50B', pe: 94.6, revenueGrowth: 5, eps: 1.36, grossMargin: 43, dividendYield: null,
      etfPresence: { SOXX: 2.4, PSI: 3.14, XSD: 3.09, DRAM: false },
    ...
    {
      ticker: 'AMAT', name: 'APPLIED MATERIAL INC', easyScore: 2, avgWeight: 4.28, proScore: 2.14, coverage: 0.5,
      ...
      velocityScore: { '1D': -28.9, '1W': -26.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$389B', pe: 46.1, revenueGrowth: 11, eps: 10.63, grossMargin: 49, dividendYield: 0.43,
      etfPresence: { SOXX: 4.5, PSI: 4.06, XSD: false, DRAM: false },
    ...
    {
      ticker: 'MPWR', name: 'MONOLITHIC POWER SYSTEMS INC', easyScore: 3, avgWeight: 2.59, proScore: 1.95, coverage: 0.75,
      ...
      velocityScore: { '1D': 0.5, '1W': -4.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$80B', pe: 116.3, revenueGrowth: 26, eps: 13.97, grossMargin: 55, dividendYield: 0.49,
      etfPresence: { SOXX: 3.31, PSI: 2.3, XSD: 2.18, DRAM: false },
    ...
    {
      ticker: 'LRCX', name: 'LAM RESEARCH CORP', easyScore: 2, avgWeight: 3.81, proScore: 1.9, coverage: 0.5,
      ...
      etfPresence: { SOXX: 3.33, PSI: 4.28, XSD: false, DRAM: false },
    ...
    {
      ticker: 'KLAC', name: 'KLA CORP', easyScore: 2, avgWeight: 3.69, proScore: 1.85, coverage: 0.5,
      ...
      velocityScore: { '1D': -29.1, '1W': -29.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$267B', pe: 57.8, revenueGrowth: 12, eps: 35.38, grossMargin: 61, dividendYield: 0.45,
      etfPresence: { SOXX: 3.12, PSI: 4.27, XSD: false, DRAM: false },
    ...
    {
      ticker: 'MCHP', name: 'MICROCHIP TECHNOLOGY INC', easyScore: 3, avgWeight: 2.25, proScore: 1.69, coverage: 0.75,
      price: 96.96, weeklyPrices: [96.85, 96.04, 94.65, 91.52, 96.96], weeklyChange: 0.11, sortRank: 0, periodReturns: { '1M': 3.2, '6M': 71, '1Y': 51.9 },
      priceHistory: { '1W': [96.85, 96.04, 94.65, 91.52, 96.96], '1M': [95.3, 98.48, 102.92, 101.58, 99.09, 99.03, 97.7, 96.71, 97.04, 93.85, 92.76, 91.81, 94.02, 91.11, 93.43, 98.05, 96.85, 96.04, 94.65, 91.52, 96.96], '6M': [56.71, 66.85, 65.9, 65.35, 63.72, 73.53, 74.45, 74.71, 75.92, 76.01, 78.56, 76.6, 74.31, 64.77, 61.94, 62.97, 62, 67.22, 73.55, 80.39, 86.84, 95.3, 99.03, 92.76, 98.05, 96.96], '1Y': [63.84, 69.59, 67.69, 71.6, 73.16, 75.08, 74.43, 70.25, 70.29, 66.17, 65.75, 66.76, 66.65, 64.43, 65.02, 66.26, 65.85, 64.11, 66.92, 65.21, 64.5, 62.54, 60.8, 55.63, 50.8, 52.57, 63.61, 67.9, 63.99, 65.36, 65.03, 75.22, 74.7, 74.79, 78.08, 74.41, 78.56, 76.6, 74.31, 65, 63.83, 64.34, 60.06, 67.51, 74.5, 80.93, 86.84, 95.3, 99.03, 92.76, 98.05, 96.96] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$53B', pe: 440.7, revenueGrowth: 35, eps: 0.22, grossMargin: 58, dividendYield: 1.88,
      etfPresence: { SOXX: 2.46, PSI: 2.19, XSD: 2.11, DRAM: false },
    ...
    {
      ticker: 'ADI', name: 'ANALOG DEVICES INC', easyScore: 3, avgWeight: 2.24, proScore: 1.68, coverage: 0.75,
      price: 423.2, weeklyPrices: [416.88, 419.01, 413.85, 402.69, 423.20], weeklyChange: 1.52, sortRank: 0, periodReturns: { '1M': 6.4, '6M': 55, '1Y': 93.7 },
      priceHistory: { '1W': [416.88, 419.01, 413.85, 402.69, 423.2], '1M': [397.02, 404.77, 415.63, 408.52, 416.52, 422.73, 419.65, 432.39, 426.79, 417.49, 418.58, 414.31, 398.05, 384.21, 397.07, 419.94, 416.88, 419.01, 413.85, 402.69, 423.2], '6M': [272.97, 276.24, 278.4, 276.73, 271.2, 299.16, 302.1, 305.6, 310.88, 320.45, 337.1, 355.15, 352.41, 315.81, 306.07, 309.43, 307.44, 327.36, 350.01, 381.05, 392.59, 397.02, 422.73, 418.58, 419.94, 423.2], '1Y': [218.43, 233.34, 227.44, 234.68, 245.15, 245.13, 240.61, 228.08, 231.11, 220.69, 237.63, 244.87, 255.5, 246.11, 248.24, 249.05, 248.61, 239.28, 237.93, 238.15, 240.36, 235.04, 236, 241.44, 232.2, 257.92, 278.24, 281.57, 271.04, 277.56, 273.74, 300.93, 300.25, 304.01, 316.86, 322.97, 337.1, 355.15, 352.41, 319.71, 310.92, 312.19, 303.1, 327.41, 348.6, 375.27, 392.59, 397.02, 422.73, 418.58, 419.94, 423.2] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$206B', pe: 62.9, revenueGrowth: 37, eps: 6.73, grossMargin: 64, dividendYield: 1.04,
      etfPresence: { SOXX: 2.78, PSI: 2.03, XSD: 1.91, DRAM: false },
      tonyNote: 'ANALOG DEVICES INC appears in 3 of 4 Semiconductors ETFs (75% coverage) with average weight 2.2% — high conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'QCOM', name: 'QUALCOMM INC', easyScore: 2, avgWeight: 3.27, proScore: 1.63, coverage: 0.5,
      ...
      velocityScore: { '1D': -29.4, '1W': -33.7, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'MTSI', name: 'MACOM TECHNOLOGY SOLUTIONS INC', easyScore: 3, avgWeight: 2.08, proScore: 1.56, coverage: 0.75,
      price: 382.35, weeklyPrices: [400.66, 391.09, 364.64, 353.79, 382.35], weeklyChange: -4.57, sortRank: 0, periodReturns: { '1M': 34.5, '6M': 114.9, '1Y': 201.4 },
      priceHistory: { '1W': [400.66, 391.09, 364.64, 353.79, 382.35], '1M': [291.72, 303.57, 309.81, 344.47, 359.88, 365.88, 362.76, 381.55, 383.56, 375.6, 356.25, 358.98, 375.71, 380.45, 385.98, 409.68, 400.66, 391.09, 364.64, 353.79, 382.35], '6M': [177.91, 188.08, 175.69, 176.28, 171.28, 167.66, 218.93, 219.26, 219.06, 235.87, 244.16, 245.53, 258.54, 207.51, 217.8, 218.96, 225.44, 233.04, 263.63, 281.08, 279.44, 291.72, 365.88, 356.25, 409.68, 382.35], '1Y': [126.86, 128.27, 130.72, 139.17, 139.81, 137.19, 137.76, 137.19, 140.02, 139.03, 125.99, 121.15, 129.63, 131.89, 131.07, 129.73, 126.66, 126.56, 133.19, 136.83, 135.91, 152.66, 149.68, 170.89, 161.57, 168.06, 183.46, 186.23, 168.31, 175.81, 174.96, 174.87, 220.68, 218.89, 228.56, 235.7, 244.16, 245.53, 258.54, 218.73, 224.92, 229.26, 209.49, 236.99, 263.92, 285.71, 279.44, 291.72, 365.88, 356.25, 409.68, 382.35] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$29B', pe: 164.1, revenueGrowth: 23, eps: 2.33, grossMargin: 56, dividendYield: null,
      etfPresence: { SOXX: 1.2, PSI: 2.63, XSD: 2.4, DRAM: false },
      tonyNote: 'MACOM TECHNOLOGY SOLUTIONS INC appears in 3 of 4 Semiconductors ETFs (75% coverage) with average weight 2.1% — high conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'ALAB', name: 'ASTERA LABS INC', easyScore: 2, avgWeight: 3.05, proScore: 1.53, coverage: 0.5,
      price: 355.76, weeklyPrices: [325.33, 349.17, 342.85, 320.09, 355.76], weeklyChange: 9.35, sortRank: 0, periodReturns: { '1M': 75.5, '6M': 148.9, '1Y': 274.1 },
      priceHistory: { '1W': [325.33, 349.17, 342.85, 320.09, 355.76], '1M': [201.25, 215.69, 213.91, 195.65, 199.79, 207.35, 204.42, 224.09, 228.64, 232.68, 215.58, 244.26, 287.48, 297.84, 306.88, 318.72, 325.33, 349.17, 342.85, 320.09, 355.76], '6M': [142.94, 167.08, 144.94, 168.83, 166.36, 156.73, 174.45, 169.66, 150.62, 169.85, 129.32, 128.24, 120.55, 119.2, 120.31, 116.04, 112.47, 117.99, 166.79, 175.8, 196.64, 201.25, 207.35, 215.58, 318.72, 355.76], '1Y': [95.09, 91.46, 92.91, 89.63, 88.57, 97.02, 91.94, 119.48, 128.87, 174.39, 193.64, 172.45, 179.2, 187.95, 232.9, 251.88, 205.27, 194.5, 219.36, 161.46, 154.85, 173.62, 181.94, 157.79, 142.01, 154.22, 152.5, 164.32, 140.24, 169.97, 179.56, 162.61, 182, 163.25, 152.44, 187.67, 129.32, 128.24, 120.55, 122.31, 127.48, 123.87, 100.27, 118.99, 170.6, 191.97, 196.64, 201.25, 207.35, 215.58, 318.72, 355.76] },
      velocityScore: { '1D': -29.2, '1W': -26.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$61B', pe: 238.8, revenueGrowth: 93, eps: 1.49, grossMargin: 76, dividendYield: null,
      etfPresence: { SOXX: 2.21, PSI: false, XSD: 3.89, DRAM: false },
      tonyNote: 'Astera Labs is a connectivity silicon company for AI data centers — high bandwidth, low latency PCIe and CXL interconnects that GPU clusters require. Revenue growth is strong and the company is one of the cleaner AI infrastructure pure-plays in the semiconductor universe; ETF managers have begun building positions but coverage is still selective.',
    },
    {
      ticker: 'SITM', name: 'SiTime Corp', easyScore: 2, avgWeight: 2.91, proScore: 1.46, coverage: 0.5,
    ...
    {
      ticker: 'SMTC', name: 'Semtech Corp', easyScore: 2, avgWeight: 2.9, proScore: 1.45, coverage: 0.5,
      ...
      etfPresence: { SOXX: false, PSI: 3.15, XSD: 2.64, DRAM: false },
      tonyNote: 'Semtech Corp appears in 2 of 4 Semiconductors ETFs (50% coverage) with average weight 2.9% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
  ],
  ...
  'Broad Tech': [
    ...
    {
      ticker: 'LRCX', name: 'Lam Research Corp', easyScore: 5, avgWeight: 3.75, proScore: 1.44, coverage: 0.385,
      price: 334.41, weeklyPrices: [318.93, 318.00, 318.18, 317.12, 334.41], weeklyChange: 4.85, sortRank: 0, periodReturns: { '1M': 30.3, '6M': 111.4, '1Y': 299.7 },
      priceHistory: { '1W': [318.93, 318, 318.18, 317.12, 334.41], '1M': [258.57, 275.8, 297.17, 286.52, 294.05, 296.05, 289.24, 295.44, 299.15, 284.72, 277.96, 273.38, 292.09, 302.24, 305.35, 322.68, 318.93, 318, 318.18, 317.12, 334.41], '6M': [158.19, 165.81, 163.26, 175.16, 171.18, 200.96, 217.47, 217.94, 233.46, 231.01, 235.53, 242.27, 231, 199.33, 212.2, 228.36, 211.41, 220.65, 267.32, 263.16, 259.47, 258.57, 296.05, 277.96, 322.68, 334.41], '1Y': [83.66, 91, 92.66, 96.02, 98.83, 101.06, 100.37, 97.1, 99.09, 95.94, 106.74, 99.15, 103.67, 100.42, 115.58, 126.32, 128.32, 142.79, 142.54, 144.78, 141.25, 160.67, 165.05, 161.42, 148.8, 155.14, 159.75, 168.26, 154.98, 177.33, 185.06, 218.36, 222.96, 222.87, 237.5, 229.28, 235.53, 242.27, 231, 211.15, 219.4, 233.31, 199.93, 224.35, 272.41, 258.37, 259.47, 258.57, 296.05, 277.96, 322.68, 334.41] },
      velocityScore: { '1D': -36.6, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$418B', pe: 63.3, revenueGrowth: 24, eps: 5.28, grossMargin: 50, dividendYield: 0.31,
      etfPresence: { PTF: 2.56, WCLD: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: false, FRWD: 5.62, BCTK: 6.38, FWD: 1.66, CBSE: 2.54, FCUS: false, WGMI: false },
      tonyNote: 'Lam Research is a wafer fab equipment holding, appearing in 2 Semiconductor ETFs. Its positioning is tied to the same logic as AMAT — equipment spending follows leading-edge node transitions and memory capacity additions. The gross margin and revenue profile are consistent with the duopoly pricing power that LRCX and AMAT share in etch and deposition equipment.',
    },
    {
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 3, avgWeight: 5.27, proScore: 1.22, coverage: 0.231,
      price: 441.31, weeklyPrices: [412.67, 426.99, 450.24, 460.52, 441.31], weeklyChange: 6.94, sortRank: 0, periodReturns: { '1M': 6.5, '6M': -9.9, '1Y': -4.7 },
      priceHistory: { '1W': [412.67, 426.99, 450.24, 460.52, 441.31], '1M': [413.62, 411.38, 413.96, 420.77, 415.12, 412.66, 407.77, 405.21, 409.43, 421.92, 423.54, 417.42, 421.06, 419.09, 418.57, 416.03, 412.67, 426.99, 450.24, 460.52, 441.31], '6M': [490, 492.02, 476.39, 486.85, 483.62, 478.11, 456.66, 465.95, 430.29, 401.14, 401.32, 384.47, 398.55, 408.96, 395.55, 381.87, 356.77, 372.88, 384.37, 418.07, 424.82, 413.62, 412.66, 423.54, 416.03, 441.31], '1Y': [462.97, 470.92, 478.04, 492.27, 491.09, 501.48, 505.62, 505.87, 513.24, 524.94, 520.58, 505.72, 506.74, 507.97, 501.01, 508.45, 510.15, 519.71, 524.85, 513.43, 520.54, 541.55, 507.16, 511.14, 487.12, 485.5, 477.73, 478.56, 476.12, 488.02, 472.94, 479.28, 459.86, 470.28, 423.37, 413.6, 401.32, 384.47, 398.55, 409.41, 399.95, 383, 358.96, 372.29, 393.11, 424.16, 424.82, 413.62, 412.66, 423.54, 416.03, 441.31] },
      velocityScore: { '1D': -70.7, '1W': -75.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$3.3T', pe: 26.3, revenueGrowth: 18, eps: 16.77, grossMargin: 68, dividendYield: 0.82,
    ...
    {
      ticker: 'CIFR', name: 'CIPHER DIGITAL INC', easyScore: 2, avgWeight: 7.83, proScore: 1.2, coverage: 0.154,
    ...
    {
      ticker: 'PANW', name: 'PANW', easyScore: 3, avgWeight: 4.57, proScore: 1.05, coverage: 0.231,
      ...
      velocityScore: { '1D': -52.3, '1W': -51.4, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'PLTR', name: 'PALANTIR TECHNOLOGIES INC CLASS A', easyScore: 3, avgWeight: 4.44, proScore: 1.02, coverage: 0.231,
      ...
      velocityScore: { '1D': null, '1W': -55.5, '1M': null, '6M': null }, isNew: true,
    ...
    },
    {
      ...
      price: 117.01, weeklyPrices: [106.60, 115.03, 118.71, 124.12, 117.01], weeklyChange: 9.77, sortRank: 0, periodReturns: { '1M': -8.3, '6M': -25.4, '1Y': 11.3 },
      priceHistory: { '1W': [106.6, 115.03, 118.71, 124.12, 117.01], '1M': [127.55, 107.63, 105.44, 111.74, 110.41, 102.54, 99.84, 95.4, 97.42, 100.28, 102.39, 101.01, 105.01, 104.86, 103, 104.9, 106.6, 115.03, 118.71, 124.12, 117.01], '6M': [156.83, 159.89, 163.14, 169.53, 160.97, 168.28, 157.99, 137.89, 131.23, 112.05, 112.7, 117.28, 119.38, 130.2, 122.96, 116.78, 111.85, 118.8, 114.97, 135.14, 124.23, 127.55, 102.54, 102.39, 104.9, 117.01], '1Y': [105.11, 110.26, 106.53, 113.89, 114.77, 115.16, 120, 122.21, 123.01, 154.9, 150.09, 137.29, 139.89, 145.15, 145.03, 152.11, 148.83, 149.57, 166.43, 156.21, 162.01, 179.01, 162.92, 156.59, 146, 159.34, 160, 168.42, 161.73, 169.45, 157.2, 164.48, 155.81, 136.31, 132.2, 118.4, 112.7, 117.28, 119.38, 133.5, 126.58, 121.1, 111.77, 117.06, 117.64, 131.13, 124.23, 127.55, 102.54, 102.39, 104.9, 117.01] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$152B', pe: 114.7, revenueGrowth: 34, eps: 1.02, grossMargin: 48, dividendYield: null,
  ...
  'Electrification': [
    {
      ticker: 'POWL', name: 'Powell Industries Inc', easyScore: 3, avgWeight: 5.41, proScore: 4.05, coverage: 0.75,
      ...
      velocityScore: { '1D': -19.8, '1W': -19.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$11B', pe: 58.5, revenueGrowth: 7, eps: 5.11, grossMargin: 30, dividendYield: 0.12,
      etfPresence: { POW: 6.56, VOLT: 8.03, PBD: false, PBW: 1.63 },
    ...
    {
      ticker: 'BELFB', name: 'Bel Fuse Inc', easyScore: 3, avgWeight: 3.82, proScore: 2.87, coverage: 0.75,
      ...
      velocityScore: { '1D': -22.4, '1W': -21.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4B', pe: 65, revenueGrowth: 17, eps: 4.14, grossMargin: 39, dividendYield: 0.1,
      etfPresence: { POW: 3.09, VOLT: 7.15, PBD: false, PBW: 1.23 },
    ...
    {
      ticker: 'PWR', name: 'Quanta Services Inc', easyScore: 3, avgWeight: 3.78, proScore: 2.83, coverage: 0.75,
      ...
      velocityScore: { '1D': -20.1, '1W': -22.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$106B', pe: 97.1, revenueGrowth: 26, eps: 7.27, grossMargin: 15, dividendYield: 0.06,
      etfPresence: { POW: 4.65, VOLT: 5.46, PBD: false, PBW: 1.22 },
    ...
    {
      ticker: 'HUBB', name: 'Hubbell Inc', easyScore: 3, avgWeight: 2.25, proScore: 1.69, coverage: 0.75,
      ...
      velocityScore: { '1D': -19.5, '1W': -19.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$25B', pe: 28.4, revenueGrowth: 11, eps: 16.91, grossMargin: 36, dividendYield: 1.18,
      etfPresence: { POW: 2.79, VOLT: 3.28, PBD: 0.69, PBW: false },
    ...
    {
      ticker: 'AEIS', name: 'Advanced Energy Industries Inc', easyScore: 3, avgWeight: 1.94, proScore: 1.45, coverage: 0.75,
      ...
      velocityScore: { '1D': -13.2, '1W': -21.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$12B', pe: 64.9, revenueGrowth: 26, eps: 4.81, grossMargin: 39, dividendYield: 0.13,
      etfPresence: { POW: 0.93, VOLT: 3.95, PBD: false, PBW: 0.93 },
    ...
    {
      ticker: 'PRY', name: 'Prysmian SpA', easyScore: 2, avgWeight: 2.71, proScore: 1.35, coverage: 0.5,
      price: 0, weeklyPrices: [0.00], weeklyChange: 0, sortRank: 0, periodReturns: { '1M': 0, '6M': 0, '1Y': 0 },
      priceHistory: undefined,
      velocityScore: { '1D': -38.4, '1W': -36.9, '1M': null, '6M': null }, isNew: false,
      marketCap: 'N/A', pe: null, revenueGrowth: 0, eps: 0, grossMargin: 0, dividendYield: null,
      etfPresence: { POW: 4.54, VOLT: false, PBD: 0.88, PBW: false },
    ...
    },
    {
      ...
      price: 6.38, weeklyPrices: [6.09, 6.19, 6.29, 6.30, 6.38], weeklyChange: 4.76, sortRank: 0, periodReturns: { '1M': 88.2, '6M': 135.4, '1Y': 390.8 },
      priceHistory: { '1W': [6.09, 6.19, 6.29, 6.3, 6.38], '1M': [3.29, 4.33, 4.78, 4.7, 4.13, 4.17, 4.16, 4.14, 4.13, 4.45, 4.33, 4.18, 4.76, 5.43, 5.54, 5.94, 6.09, 6.19, 6.29, 6.3, 6.38], '6M': [2.71, 2.82, 2.65, 2.67, 2.54, 2.73, 2.7, 2.64, 2.33, 2.15, 2.15, 2.11, 2.16, 2.01, 2.39, 2.41, 2.39, 2.53, 2.7, 3.17, 3.25, 3.29, 4.17, 4.33, 5.94, 6.38], '1Y': [1.3, 1.67, 1.57, 1.4, 1.67, 1.94, 1.81, 2.02, 1.83, 1.83, 1.87, 1.9, 2.02, 1.85, 2.05, 2.62, 2.99, 2.96, 3.61, 3.76, 3.28, 3.54, 3.65, 3.43, 2.85, 2.78, 2.67, 2.78, 2.53, 2.69, 2.68, 2.76, 2.79, 2.56, 2.31, 2.17, 2.15, 2.11, 2.16, 1.99, 2.53, 2.51, 2.3, 2.4, 2.94, 3.1, 3.25, 3.29, 4.17, 4.33, 5.94, 6.38] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
    ...
    {
      ticker: 'ENPH', name: 'Enphase Energy Inc', easyScore: 3, avgWeight: 1.32, proScore: 0.99, coverage: 0.75,
      price: 72.33, weeklyPrices: [70.28, 69.50, 68.36, 63.74, 72.33], weeklyChange: 2.92, sortRank: 0, periodReturns: { '1M': 113.7, '6M': 148.4, '1Y': 65.3 },
      priceHistory: { '1W': [70.28, 69.5, 68.36, 63.74, 72.33], '1M': [32.54, 36.02, 35.8, 35.47, 36.45, 37.65, 37.48, 42, 48.01, 52.89, 49.69, 46.76, 53.15, 62.34, 64.03, 66.9, 70.28, 69.5, 68.36, 63.74, 72.33], '6M': [29.12, 31.55, 31.86, 32.22, 32.05, 35.43, 35.36, 39.46, 36.98, 49.8, 43.49, 47.4, 44.71, 40.23, 44.07, 44.11, 37.84, 33.64, 31.37, 33.88, 35.24, 32.54, 37.65, 49.69, 66.9, 72.33], '1Y': [43.75, 45.08, 34.92, 38.11, 40.97, 42.97, 39.03, 36.48, 33.4, 30.11, 34.22, 35.68, 37.56, 36.52, 37.32, 38.44, 37.99, 37.01, 36.03, 37.54, 36.08, 31.14, 32.2, 30.71, 26.89, 27.82, 29.39, 32.79, 31.61, 32.85, 33.75, 35.22, 34.98, 39.42, 36.47, 50.3, 43.49, 47.4, 44.71, 40.86, 45.89, 40.76, 35.64, 32.04, 32, 33.62, 35.24, 32.54, 37.65, 49.69, 66.9, 72.33] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$10B', pe: 71.6, revenueGrowth: -21, eps: 1.01, grossMargin: 27, dividendYield: null,
      etfPresence: { POW: 0.99, VOLT: false, PBD: 1.21, PBW: 1.75 },
      tonyNote: 'Enphase Energy Inc appears in 3 of 4 Electrification ETFs (75% coverage) with average weight 1.3% — high conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'SEDG', name: 'SolarEdge Technologies Inc', easyScore: 3, avgWeight: 1.28, proScore: 0.96, coverage: 0.75,
      price: 78.51, weeklyPrices: [73.23, 73.19, 76.35, 75.80, 78.51], weeklyChange: 7.21, sortRank: 0, periodReturns: { '1M': 83, '6M': 140.4, '1Y': 333.5 },
      priceHistory: { '1W': [73.23, 73.19, 76.35, 75.8, 78.51], '1M': [41.52, 44.64, 40.61, 38.61, 41.3, 41.79, 40.42, 42.77, 50.24, 61.76, 55.23, 54.53, 56.22, 63, 61.95, 70.75, 73.23, 73.19, 76.35, 75.8, 78.51], '6M': [32.66, 30.26, 29.48, 30.48, 28.85, 30.26, 33.84, 34.6, 30.95, 35.92, 35.53, 39.38, 40.6, 33.41, 37.44, 51.73, 51.76, 45.09, 43.21, 39.82, 47.38, 41.52, 41.79, 55.23, 70.75, 78.51], '1Y': [18.11, 20.93, 15.96, 19.09, 23.6, 27.57, 24.96, 29.07, 25.81, 25.79, 26.46, 32.06, 33.09, 34.16, 29.49, 34.71, 37.47, 38.62, 35.66, 40.53, 37.5, 36.3, 41.02, 42.51, 33.46, 35.47, 31.61, 31.56, 28.92, 30.74, 31.36, 32.89, 33.91, 34.41, 30.64, 36.8, 35.53, 39.38, 40.6, 34.59, 40.71, 46.73, 47.37, 43.85, 42.98, 40.57, 47.38, 41.52, 41.79, 55.23, 70.75, 78.51] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$5B', pe: null, revenueGrowth: 42, eps: -6.13, grossMargin: 18, dividendYield: null,
      etfPresence: { POW: 0.51, VOLT: false, PBD: 1.68, PBW: 1.66 },
      tonyNote: 'SolarEdge Technologies Inc appears in 3 of 4 Electrification ETFs (75% coverage) with average weight 1.3% — high conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'XEL', name: 'Xcel Energy Inc', easyScore: 2, avgWeight: 1.9, proScore: 0.95, coverage: 0.5,
      price: 77.87, weeklyPrices: [81.00, 79.26, 79.50, 76.41, 77.87], weeklyChange: -3.86, sortRank: 0, periodReturns: { '1M': -5.7, '6M': -1.5, '1Y': 12.3 },
      priceHistory: { '1W': [81, 79.26, 79.5, 76.41, 77.87], '1M': [81.17, 81.45, 80.55, 80.43, 79.39, 80.6, 79.9, 79.91, 80.03, 77.92, 78.1, 79.73, 79.86, 80.2, 81.08, 80.78, 81, 79.26, 79.5, 76.41, 77.87], '6M': [79.04, 75.72, 73.73, 74.01, 73.86, 73.38, 75.36, 75.01, 76.06, 75.9, 81.59, 83.35, 83.8, 82.52, 81.91, 76.77, 78.09, 80.39, 80.45, 80.32, 79.41, 81.17, 80.6, 78.1, 80.78, 77.87], '1Y': [69.33, 68.96, 65.65, 67.32, 67.56, 68.45, 69.17, 72.5, 72.39, 73.3, 72.92, 73.17, 72.87, 72.24, 72.85, 72.17, 77.93, 80.31, 81.85, 81.8, 80.69, 79.69, 81.19, 80.72, 79.67, 81.25, 78.39, 74.62, 73.14, 74.09, 74.68, 74.26, 75.61, 75.73, 74.5, 76.43, 81.59, 83.35, 83.8, 82.1, 81.63, 76.95, 79.17, 80.54, 79.83, 79.08, 79.41, 81.17, 80.6, 78.1, 80.78, 77.87] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$49B', pe: 22.4, revenueGrowth: 3, eps: 3.47, grossMargin: 46, dividendYield: 3.04,
    ...
    {
      ticker: 'FCEL', name: 'FuelCell Energy Inc', easyScore: 1, avgWeight: 3.7, proScore: 0.92, coverage: 0.25,
      ...
      velocityScore: { '1D': -44.6, '1W': -52.3, '1M': null, '6M': null }, isNew: false,
  ...
  'Industrials': [
    {
      ticker: 'POWL', name: 'Powell Industries, Inc.', easyScore: 3, avgWeight: 4.34, proScore: 2.61, coverage: 0.6,
      price: 299.07, weeklyPrices: [295.94, 288.90, 284.42, 288.12, 299.07], weeklyChange: 1.06, sortRank: 0, periodReturns: { '1M': 8.6, '6M': 178.2, '1Y': 416.8 },
      priceHistory: { '1W': [295.94, 288.9, 284.42, 288.12, 299.07], '1M': [269.95, 294.69, 320.3, 305.93, 309.39, 322.05, 308.05, 300.84, 296.98, 292.65, 266.8, 261.58, 271.05, 270.75, 279.22, 291.97, 295.94, 288.9, 284.42, 288.12, 299.07], '6M': [107.5, 115.02, 110.88, 112.88, 106.26, 119.94, 135.18, 139.32, 147.86, 194.74, 195.02, 181.38, 177.5, 161.22, 167.57, 172, 179.35, 186.72, 228.99, 241.65, 260.52, 269.95, 322.05, 266.8, 291.97, 299.07], '1Y': [57.87, 61.92, 60.3, 63.42, 72.84, 70.96, 72.53, 78.32, 76.88, 75.95, 86.57, 82.17, 91.46, 90.24, 97.47, 101.43, 97.88, 105.74, 105.13, 109.92, 110.96, 136.12, 131.92, 118.74, 95.1, 107.26, 107.83, 119.95, 105.77, 112.06, 117.51, 121.83, 139.99, 141.15, 146.79, 187.3, 195.02, 181.38, 177.5, 173.36, 170.61, 180.86, 167.52, 201.7, 234.42, 240.97, 260.52, 269.95, 322.05, 266.8, 291.97, 299.07] },
      velocityScore: { '1D': -21.6, '1W': 40.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$11B', pe: 58.5, revenueGrowth: 7, eps: 5.11, grossMargin: 30, dividendYield: 0.12,
      etfPresence: { AIRR: 2.68, PRN: 2.43, RSHO: 7.92, IDEF: false, BILT: false },
      tonyNote: 'Powell Industries is an industrial electrical equipment manufacturer — switchgear and power distribution for data centers and energy infrastructure. It appears in Industrials ETFs because data center power infrastructure spending is driving a backlog expansion that the market is pricing through a revenue growth multiple.',
    },
    {
      ticker: 'STRL', name: 'Sterling Infrastructure, Inc.', easyScore: 2, avgWeight: 5.51, proScore: 2.2, coverage: 0.4,
    ...
    {
      ticker: 'SPXC', name: 'SPX Technologies', easyScore: 3, avgWeight: 2.37, proScore: 1.42, coverage: 0.6,
      price: 230.08, weeklyPrices: [215.34, 213.82, 216.66, 220.92, 230.08], weeklyChange: 6.84, sortRank: 0, periodReturns: { '1M': 10.5, '6M': 10, '1Y': 45.6 },
      priceHistory: { '1W': [215.34, 213.82, 216.66, 220.92, 230.08], '1M': [201.12, 207.81, 212.74, 205.27, 202.84, 203.24, 198.99, 203.79, 203.5, 200.99, 200.47, 195.79, 205.55, 205.39, 207.8, 219.08, 215.34, 213.82, 216.66, 220.92, 230.08], '6M': [209.18, 209.32, 216.89, 205.46, 200.06, 207.44, 213.61, 211.03, 208.41, 222.32, 239, 237.18, 225.02, 204.62, 199.45, 186.77, 200, 196.9, 221.27, 217.61, 222.45, 201.12, 203.24, 200.47, 219.08, 230.08], '1Y': [158.02, 163.22, 155.12, 161.46, 172.55, 173.08, 175.13, 175.58, 181.26, 203.53, 191.88, 186.26, 192.47, 186.63, 190.25, 190.48, 182.39, 185.92, 188.45, 185.21, 187.4, 200, 223.06, 219.09, 205.32, 215.87, 209.57, 217.69, 207.33, 208.48, 203.26, 207.51, 217.65, 215.21, 212.73, 223.86, 239, 237.18, 225.02, 209.8, 203.42, 194.52, 190.71, 195.43, 224.82, 216.49, 222.45, 201.12, 203.24, 200.47, 219.08, 230.08] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$12B', pe: 44.1, revenueGrowth: 17, eps: 5.22, grossMargin: 41, dividendYield: null,
      etfPresence: { AIRR: 1.64, PRN: 1.61, RSHO: 3.87, IDEF: false, BILT: false },
    ...
    {
      ticker: 'PL', name: 'Planet Labs PBC', easyScore: 2, avgWeight: 3.54, proScore: 1.42, coverage: 0.4,
      ...
      velocityScore: { '1D': -36, '1W': -61, '1M': null, '6M': null }, isNew: false,
      marketCap: '$17B', pe: null, revenueGrowth: 41, eps: -0.8, grossMargin: 56, dividendYield: null,
      etfPresence: { AIRR: false, PRN: 5.19, RSHO: false, IDEF: 1.89, BILT: false },
    ...
    {
      ticker: 'RTX', name: 'RTX CORP', easyScore: 1, avgWeight: 6.99, proScore: 1.4, coverage: 0.2,
    ...
    {
      ticker: 'MTZ', name: 'MasTec, Inc.', easyScore: 2, avgWeight: 3.38, proScore: 1.35, coverage: 0.4,
      ...
      velocityScore: { '1D': null, '1W': -53.1, '1M': null, '6M': null }, isNew: true,
      marketCap: '$29B', pe: 64.2, revenueGrowth: 35, eps: 5.71, grossMargin: 13, dividendYield: null,
      etfPresence: { AIRR: 3.81, PRN: 2.95, RSHO: false, IDEF: false, BILT: false },
    ...
    {
      ticker: 'DY', name: 'Dycom Industries, Inc.', easyScore: 2, avgWeight: 3.23, proScore: 1.29, coverage: 0.4,
      ...
      velocityScore: { '1D': null, '1W': -43.7, '1M': null, '6M': null }, isNew: true,
      marketCap: '$15B', pe: 46.5, revenueGrowth: 56, eps: 10.45, grossMargin: 20, dividendYield: null,
      etfPresence: { AIRR: 3.74, PRN: 2.72, RSHO: false, IDEF: false, BILT: false },
    ...
    {
      ticker: 'LMT', name: 'LOCKHEED MARTIN CORP', easyScore: 1, avgWeight: 6.21, proScore: 1.24, coverage: 0.2,
    ...
    {
      ticker: 'UNP', name: 'UNION PACIFIC CORP', easyScore: 1, avgWeight: 5.59, proScore: 1.12, coverage: 0.2,
      ...
      velocityScore: { '1D': -55.2, '1W': null, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'PLTR', name: 'PALANTIR TECHNOLOGIES INC CLASS A', easyScore: 1, avgWeight: 5.29, proScore: 1.06, coverage: 0.2,
      price: 152.17, weeklyPrices: [132.51, 143.34, 156.54, 160.65, 152.17], weeklyChange: 14.84, sortRank: 0, periodReturns: { '1M': 5.6, '6M': -10.9, '1Y': 14.3 },
      priceHistory: { '1W': [132.51, 143.34, 156.54, 160.65, 152.17], '1M': [146.03, 135.91, 133.79, 137.05, 137.8, 136.89, 136, 130.05, 133.73, 133.99, 135.14, 135.26, 137.15, 137.41, 136.88, 136.6, 132.51, 143.34, 156.54, 160.65, 152.17], '6M': [170.69, 181.84, 187.75, 194.13, 177.75, 176.86, 177.07, 169.6, 146.59, 135.9, 131.41, 130.6, 145.17, 157.16, 150.95, 150.68, 143.06, 147.93, 132.37, 145.89, 143.1, 146.03, 136.89, 135.14, 136.6, 152.17], '1Y': [133.17, 132.81, 138.2, 142.9, 132.12, 142.5, 150.91, 154.63, 158.61, 179.54, 184.37, 156.01, 156.72, 156.14, 164.36, 176.97, 179.56, 184.95, 183.56, 179.62, 175.49, 198.81, 187.9, 184.17, 165.42, 165.77, 176.08, 187.91, 177.29, 194.17, 167.86, 177.49, 170.96, 167.47, 147.76, 142.91, 131.41, 130.6, 145.17, 156.43, 152.72, 160.84, 137.55, 150.07, 135.7, 145.97, 143.1, 146.03, 136.89, 135.14, 136.6, 152.17] },
      velocityScore: { '1D': -55.3, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$365B', pe: 172.9, revenueGrowth: 85, eps: 0.88, grossMargin: 84, dividendYield: null,
    ...
    {
      ticker: 'PH', name: 'Parker-Hannifin Corp', easyScore: 2, avgWeight: 2.61, proScore: 1.04, coverage: 0.4,
      price: 836.32, weeklyPrices: [856.68, 852.81, 844.63, 823.30, 836.32], weeklyChange: -2.38, sortRank: 0, periodReturns: { '1M': -5.2, '6M': -2.6, '1Y': 25.8 },
      priceHistory: { '1W': [856.68, 852.81, 844.63, 823.3, 836.32], '1M': [867.75, 872.69, 902.66, 886.85, 878.83, 874.36, 881.34, 882.37, 880.43, 862.72, 858.43, 852.56, 859.44, 864.73, 866.96, 868.03, 856.68, 852.81, 844.63, 823.3, 836.32], '6M': [858.94, 862.93, 874.49, 887.14, 878.96, 906.47, 944.58, 927.99, 935.84, 976.49, 1001.75, 1008.97, 1011.41, 923.72, 889.86, 894.41, 888.44, 912.1, 989.49, 996.44, 974.34, 867.75, 874.36, 858.43, 868.03, 836.32], '1Y': [664.71, 670.93, 652.21, 673.51, 711.46, 714.3, 710.22, 728.17, 732.03, 697.13, 762.05, 742.97, 768.1, 756.96, 769.67, 755.7, 748.76, 755.22, 753.34, 737.86, 741.39, 775.03, 774.15, 854.32, 820.67, 861.49, 869.2, 889.25, 863.19, 887.76, 893.98, 920.99, 944.27, 933.05, 952, 978.87, 1001.75, 1008.97, 1011.41, 932.17, 894.64, 906.06, 861.48, 912.97, 985, 972.69, 974.34, 867.75, 874.36, 858.43, 868.03, 836.32] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$105B', pe: 30.9, revenueGrowth: 11, eps: 27.1, grossMargin: 37, dividendYield: 0.96,
      etfPresence: { AIRR: false, PRN: 1.91, RSHO: 3.31, IDEF: false, BILT: false },
