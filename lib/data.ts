...
export const SCAN_TIMESTAMP    = '2026-05-25T13:34:30.808Z';
export const SCAN_TIMESTAMP_NY = 'May 25, 2026 at 9:34 AM ET';
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'Semiconductors': [
    ...
    {
      ticker: 'MU', name: 'MICRON TECHNOLOGY INC', easyScore: 4, proScore: 5.79, coverage: 1,
      price: 751, weeklyPrices: [728.47, 735.98, 739.74, 745.74, 751.00], weeklyChange: -1.46, sortRank: 0, periodReturns: { '1M': 54.1, '6M': 262.2, '1Y': 704.3 },
      velocityScore: { '1D': -1.5, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$847B', pe: 35.5, revenueGrowth: 196, eps: 21.18, grossMargin: 58, dividendYield: 0.08,
      etfPresence: { SOXX: 9.51, PSI: 5.91, XSD: 2.88, DRAM: 4.86 },
    ...
    },
    {
      ...
      marketCap: '$762B', pe: 156.4, revenueGrowth: 38, eps: 2.99, grossMargin: 53, dividendYield: null,
      etfPresence: { SOXX: 9.1, PSI: 7.19, XSD: 3.46, DRAM: false },
    ...
    {
      ticker: 'INTC', name: 'INTEL CORPORATION CORP', easyScore: 2, proScore: 3.81, coverage: 0.5,
      price: 119.84, weeklyPrices: [116.24, 117.44, 118.04, 119.00, 119.84], weeklyChange: 1.13, sortRank: 0, periodReturns: { '1M': 83.6, '6M': 247.4, '1Y': 497.7 },
      velocityScore: { '1D': -0.8, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$602B', pe: null, revenueGrowth: 7, eps: -0.6, grossMargin: 37, dividendYield: null,
      etfPresence: { SOXX: 6.86, PSI: false, XSD: 3.91, DRAM: false },
    ...
    {
      ticker: 'AVGO', name: 'BROADCOM INC', easyScore: 3, proScore: 3.72, coverage: 0.75,
      price: 414.14, weeklyPrices: [401.72, 405.86, 407.93, 411.24, 414.14], weeklyChange: -0.1, sortRank: 0, periodReturns: { '1M': -2, '6M': 21.7, '1Y': 81.1 },
      velocityScore: { '1D': -1.1, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.0T', pe: 80.6, revenueGrowth: 30, eps: 5.14, grossMargin: 77, dividendYield: 0.63,
      etfPresence: { SOXX: 6.77, PSI: 4.18, XSD: 1.92, DRAM: false },
    ...
    {
      ticker: 'NVDA', name: 'NVIDIA CORP', easyScore: 3, proScore: 3.43, coverage: 0.75,
      price: 215.33, weeklyPrices: [208.87, 211.02, 212.10, 213.82, 215.33], weeklyChange: -1.9, sortRank: 0, periodReturns: { '1M': 6.3, '6M': 20.4, '1Y': 64 },
      velocityScore: { '1D': -2.3, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.2T', pe: 33, revenueGrowth: 85, eps: 6.52, grossMargin: 74, dividendYield: 0.02,
      etfPresence: { SOXX: 6.35, PSI: 3.67, XSD: 1.87, DRAM: false },
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 2, proScore: 3.4, coverage: 0.5,
      price: 196.33, weeklyPrices: [190.44, 192.40, 193.39, 194.96, 196.33], weeklyChange: 2.96, sortRank: 0, periodReturns: { '1M': 24.8, '6M': 153.5, '1Y': 223.5 },
      velocityScore: { '1D': 0.3, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$172B', pe: 64.2, revenueGrowth: 22, eps: 3.06, grossMargin: 51, dividendYield: 0.12,
      etfPresence: { SOXX: 6.28, PSI: false, XSD: 3.34, DRAM: false },
    ...
    },
    {
      ...
      etfPresence: { SOXX: 3.81, PSI: 4.77, XSD: 2.38, DRAM: false },
    ...
    },
    {
      ...
      price: 1478.68, weeklyPrices: [1434.32, 1449.11, 1456.50, 1468.33, 1478.68], weeklyChange: -4.12, sortRank: 0, periodReturns: { '1M': 51, '6M': 638.3, '1Y': 3866.4 },
      velocityScore: { '1D': 0, '1W': null, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': 0, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$247B', pe: 53.5, revenueGrowth: 12, eps: 35.31, grossMargin: 61, dividendYield: 0.49,
    ...
    {
      ticker: 'QCOM', name: 'QUALCOMM INC', easyScore: 2, proScore: 2.43, coverage: 0.5,
      ...
      etfPresence: { SOXX: 4.37, PSI: false, XSD: 2.51, DRAM: false },
    ...
    },
    {
      ...
      etfPresence: { SOXX: 2.25, PSI: false, XSD: 3.78, DRAM: false },
    ...
    },
    {
      ...
      etfPresence: { SOXX: 3.64, PSI: false, XSD: 2.36, DRAM: false },
    ...
    },
    {
      ...
      etfPresence: { SOXX: 3.63, PSI: false, XSD: 2.3, DRAM: false },
    ...
    {
      ticker: 'ON', name: 'ON SEMICONDUCTOR CORP', easyScore: 2, proScore: 1.9, coverage: 0.5,
      ...
      etfPresence: { SOXX: 2.46, PSI: false, XSD: 2.92, DRAM: false },
  ...
  'Broad Tech': [
    ...
    },
    {
      ...
      velocityScore: { '1D': 0, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$79B', pe: null, revenueGrowth: 64, eps: -0.33, grossMargin: 37, dividendYield: null,
    ...
    },
    {
      ...
      etfPresence: { QQQ: false, QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: 7.04, FDTX: 3.01, GTEK: false, ARKK: 3.06, MARS: false },
