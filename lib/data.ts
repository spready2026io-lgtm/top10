...
export const SCAN_TIMESTAMP    = '2026-06-02T12:02:46.249Z';
export const SCAN_TIMESTAMP_NY = 'June 2, 2026 at 8:02 AM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 17.17, bestProScore: 7.04, price: 1035.50, weeklyChange: 15.58 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 14.23, bestProScore: 6.09, price: 510.13, weeklyChange: 1.24 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 13.58, bestProScore: 5.88, price: 224.36, weeklyChange: 4.42 },
  { ticker: 'AVGO', name: `Broadcom Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 9.39, bestProScore: 3.92, price: 459.97, weeklyChange: 9.00 },
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 8.37, bestProScore: 3.49, price: 219.43, weeklyChange: 5.36 },
  { ticker: 'LRCX', name: `LAM RESEARCH CORP`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 6.73, bestProScore: 2.70, price: 317.12, weeklyChange: -1.72 },
  { ticker: 'POWL', name: `Powell Industries, Inc.`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 8.38, bestProScore: 5.05, price: 288.12, weeklyChange: -1.32 },
  { ticker: 'MSFT', name: `MICROSOFT CORP`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 6.72, bestProScore: 4.21, price: 460.52, weeklyChange: 10.69 },
  { ticker: 'GOOGL', name: `ALPHABET INC CLASS A`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 6.52, bestProScore: 3.53, price: 376.37, weeklyChange: -3.22 },
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'AI & ML': [
    {
      ticker: 'MU', name: 'Micron Technology Inc', easyScore: 9, avgWeight: 7.18, proScore: 6.49, coverage: 0.818,
      ...
      velocityScore: { '1D': 2.7, '1W': 23.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.2T', pe: 48.8, revenueGrowth: 196, eps: 21.23, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { AIS: 8.84, ARTY: 7.33, BAI: 5.4, IVEP: false, IGPT: 12.36, IVES: 7.35, ALAI: 1.14, CHAT: 6.24, AIFD: 6.7, SPRX: false, AOTG: 9.22 },
    ...
    {
      ticker: 'NVDA', name: 'NVIDIA Corp', easyScore: 10, avgWeight: 6.17, proScore: 5.88, coverage: 0.909,
      ...
      velocityScore: { '1D': 13.1, '1W': 3.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.4T', pe: 34.4, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.45,
      etfPresence: { AIS: 2.62, ARTY: 3.52, BAI: 4.51, IVEP: false, IGPT: 5.93, IVES: 4.29, ALAI: 13.49, CHAT: 5.97, AIFD: 6.58, SPRX: 3.96, AOTG: 10.8 },
    ...
    {
      ticker: 'AMD', name: 'Advanced Micro Devices Inc', easyScore: 9, avgWeight: 6, proScore: 5.43, coverage: 0.818,
      ...
      velocityScore: { '1D': 4.8, '1W': 7.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$832B', pe: 169.5, revenueGrowth: 38, eps: 3.01, grossMargin: 53, dividendYield: null,
      etfPresence: { AIS: 4.54, ARTY: 7.48, BAI: 5.03, IVEP: false, IGPT: 7.03, IVES: 7.19, ALAI: 1.03, CHAT: 5.48, AIFD: false, SPRX: 0.53, AOTG: 15.71 },
    ...
    {
      ticker: 'GOOGL', name: 'ALPHABET INC CLASS A', easyScore: 6, avgWeight: 4.78, proScore: 3.53, coverage: 0.545,
      ...
      velocityScore: { '1D': 0.9, '1W': -6.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4.6T', pe: 28.7, revenueGrowth: 22, eps: 13.1, grossMargin: 60, dividendYield: 0.23,
      etfPresence: { AIS: false, ARTY: false, BAI: 3.65, IVEP: false, IGPT: 6, IVES: 4.15, ALAI: false, CHAT: 5.35, AIFD: 5.26, SPRX: false, AOTG: 4.29 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 0.79, ARTY: 3.84, BAI: 5.48, IVEP: false, IGPT: false, IVES: 4.73, ALAI: 4.73, CHAT: 3.27, AIFD: 6.19, SPRX: false, AOTG: 1.63 },
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 5, avgWeight: 3.9, proScore: 2.63, coverage: 0.455,
      ...
      velocityScore: { '1D': 16.9, '1W': 12.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$192B', pe: 75.1, revenueGrowth: 28, eps: 2.92, grossMargin: 52, dividendYield: 0.11,
      etfPresence: { AIS: 3.43, ARTY: 6.48, BAI: false, IVEP: false, IGPT: false, IVES: false, ALAI: false, CHAT: 1.34, AIFD: 4.98, SPRX: 3.25, AOTG: false },
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 5, avgWeight: 3.73, proScore: 2.51, coverage: 0.455,
      ...
      etfPresence: { AIS: false, ARTY: 1.91, BAI: false, IVEP: false, IGPT: false, IVES: 3.96, ALAI: 5.83, CHAT: 3.09, AIFD: false, SPRX: false, AOTG: 3.85 },
    ...
    {
      ticker: 'ALAB', name: 'Astera Labs Inc', easyScore: 5, avgWeight: 3.19, proScore: 2.15, coverage: 0.455,
      ...
      etfPresence: { AIS: 1.65, ARTY: 1.64, BAI: false, IVEP: false, IGPT: false, IVES: false, ALAI: 1.58, CHAT: 3.42, AIFD: false, SPRX: 7.65, AOTG: false },
    ...
    {
      ticker: 'VRT', name: 'Vertiv Holdings Co', easyScore: 5, avgWeight: 2.96, proScore: 2, coverage: 0.455,
      ...
      velocityScore: { '1D': 7, '1W': 0, '1M': null, '6M': null }, isNew: false,
      marketCap: '$124B', pe: 81.3, revenueGrowth: 30, eps: 3.98, grossMargin: 37, dividendYield: 0.08,
      etfPresence: { AIS: 3.77, ARTY: false, BAI: 1.9, IVEP: 4.23, IGPT: false, IVES: false, ALAI: false, CHAT: 0.83, AIFD: 4.08, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'LITE', name: 'LUMENTUM HOLDINGS INC', easyScore: 4, avgWeight: 3.23, proScore: 1.95, coverage: 0.364,
      ...
      etfPresence: { AIS: false, ARTY: false, BAI: 2.69, IVEP: false, IGPT: false, IVES: false, ALAI: false, CHAT: 1.01, AIFD: 5.82, SPRX: 3.39, AOTG: false },
      tonyNote: 'LUMENTUM HOLDINGS INC appears in 4 of 11 AI & ML ETFs (36% coverage) with average weight 3.2% — selective across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
    ...
    {
      ticker: 'ANET', name: 'Arista Networks Inc', easyScore: 7, avgWeight: 2.26, proScore: 1.81, coverage: 0.636,
      ...
      etfPresence: { AIS: 1.46, ARTY: 1.95, BAI: 1.24, IVEP: false, IGPT: false, IVES: false, ALAI: 1.01, CHAT: 2.39, AIFD: 4.77, SPRX: 3.02, AOTG: false },
    ...
    {
      ticker: 'ORCL', name: 'ORACLE CORP', easyScore: 3, avgWeight: 3.45, proScore: 1.8, coverage: 0.273,
      ...
      velocityScore: { '1D': -11.8, '1W': -4.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$714B', pe: 44.6, revenueGrowth: 22, eps: 5.56, grossMargin: 67, dividendYield: 0.81,
      etfPresence: { AIS: false, ARTY: 4.37, BAI: false, IVEP: false, IGPT: false, IVES: 4.18, ALAI: false, CHAT: 1.79, AIFD: false, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'LRCX', name: 'LAM RESEARCH CORP', easyScore: 2, avgWeight: 4.12, proScore: 1.76, coverage: 0.182,
  ...
  'Semiconductors': [
    {
      ticker: 'MU', name: 'MICRON TECHNOLOGY INC', easyScore: 4, avgWeight: 7.04, proScore: 7.04, coverage: 1,
      price: 1035.5, weeklyPrices: [895.88, 928.41, 923.52, 971.00, 1035.50], weeklyChange: 15.58, sortRank: 0, periodReturns: { '1M': 91, '6M': 330.6, '1Y': 954.7 },
      priceHistory: { '1W': [895.88, 928.41, 923.52, 971, 1035.5], '1M': [542.21, 576.45, 640.2, 666.59, 646.63, 746.81, 795.33, 766.58, 803.63, 776.01, 724.66, 681.54, 698.74, 731.99, 762.1, 751, 895.88, 928.41, 923.52, 971, 1035.5], '6M': [240.46, 246.92, 237.5, 276.59, 292.63, 339.55, 333.35, 397.58, 435.79, 382.89, 413.97, 428.17, 412.37, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 455.07, 496.72, 542.21, 746.81, 724.66, 751, 1035.5], '1Y': [98.18, 110.95, 119.84, 127.91, 120.89, 122.24, 120.11, 109.22, 111.96, 109.06, 127.75, 122.05, 116.5, 118.72, 140, 159.99, 166.41, 167.32, 185.69, 187.06, 202.29, 221.91, 218.03, 241.11, 228.5, 224.53, 239.49, 252.42, 232.51, 276.27, 285.41, 327.02, 336.63, 399.65, 414.88, 394.69, 413.97, 428.17, 412.37, 370.3, 426.13, 422.9, 357.22, 377.76, 426.56, 448.42, 496.72, 542.21, 746.81, 724.66, 751, 1035.5] },
      velocityScore: { '1D': 2.9, '1W': 22.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.2T', pe: 48.8, revenueGrowth: 196, eps: 21.23, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { SOXX: 11.62, PSI: 8.15, XSD: 3.75, DRAM: 4.65 },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
      ...
      marketCap: '$832B', pe: 169.5, revenueGrowth: 38, eps: 3.01, grossMargin: 53, dividendYield: null,
      etfPresence: { SOXX: 9.49, PSI: 7.84, XSD: 3.77, DRAM: false },
      tonyNote: 'AMD scores highest in Semiconductors at 7.0% average weight, held by 3 of 4 chip ETFs. Revenue grew 38% with 53% gross margins and EPS of $2.99 — improving but still stretched at a P/E of 172x. The 1-year return of 366% compresses future upside; the weight score says ETF managers are committed, but valuation is the variable to watch.',
    },
    {
    ...
    {
      ticker: 'AVGO', name: 'BROADCOM INC', easyScore: 3, avgWeight: 4.53, proScore: 3.92, coverage: 0.75,
      price: 459.97, weeklyPrices: [422.01, 421.86, 426.58, 446.77, 459.97], weeklyChange: 9, sortRank: 0, periodReturns: { '1M': 9.2, '6M': 19.1, '1Y': 84.9 },
      priceHistory: { '1W': [422.01, 421.86, 426.58, 446.77, 459.97], '1M': [421.28, 416.5, 427.36, 425.44, 412.56, 430, 428.43, 419.3, 416.79, 439.79, 425.19, 420.71, 411.07, 417.76, 414.57, 414.14, 422.01, 421.86, 426.58, 446.77, 459.97], '6M': [386.08, 401.1, 339.81, 341.45, 349.85, 343.5, 339.89, 325.49, 330.73, 310.51, 331.17, 332.65, 319.55, 332.77, 335.97, 319.84, 309.42, 314.55, 371.55, 406.54, 422.76, 421.28, 430, 425.19, 414.14, 459.97], '1Y': [248.71, 244.28, 252.1, 263.77, 264.74, 277.9, 280.94, 278.59, 297.42, 292.93, 312.83, 294.91, 298.01, 302.39, 369.57, 346.17, 338.94, 329.91, 336.41, 344.13, 342.66, 372.97, 351.94, 351.96, 340.5, 385.03, 381.57, 406.29, 341.3, 349.32, 346.1, 332.48, 343.02, 320.05, 331.3, 332.92, 331.17, 332.65, 319.55, 330.48, 322.16, 310.51, 300.68, 314.43, 379.75, 399.63, 422.76, 421.28, 430, 425.19, 414.14, 459.97] },
      velocityScore: { '1D': 2.1, '1W': 6.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.2T', pe: 89.3, revenueGrowth: 30, eps: 5.15, grossMargin: 77, dividendYield: 0.57,
      etfPresence: { SOXX: 6.9, PSI: 4.65, XSD: 2.04, DRAM: false },
      tonyNote: 'Broadcom appears in 6 of 8 AI ETFs and 3 of 4 Semiconductor ETFs, making it one of the most consistent cross-theme holdings. Revenue grew 30%, gross margin is 77% — the highest in the theme — and it pays a 0.58% dividend. The 87x P/E is the only friction; ETF managers are paying a premium for a recurring-revenue AI infrastructure name.',
    },
    {
    ...
    {
      ticker: 'NVDA', name: 'NVIDIA CORP', easyScore: 3, avgWeight: 3.85, proScore: 3.33, coverage: 0.75,
      price: 224.36, weeklyPrices: [214.86, 212.60, 214.25, 211.14, 224.36], weeklyChange: 4.42, sortRank: 0, periodReturns: { '1M': 13.1, '6M': 24.7, '1Y': 63.3 },
      priceHistory: { '1W': [214.86, 212.6, 214.25, 211.14, 224.36], '1M': [198.45, 198.48, 196.5, 207.83, 211.5, 215.2, 219.44, 220.78, 225.83, 235.74, 225.32, 222.32, 220.61, 223.47, 219.51, 215.33, 214.86, 212.6, 214.25, 211.14, 224.36], '6M': [179.92, 185.55, 176.29, 183.69, 187.54, 189.11, 183.14, 184.84, 192.51, 171.88, 186.94, 189.82, 177.19, 183.34, 183.14, 178.56, 171.24, 177.39, 188.63, 201.68, 208.27, 198.45, 215.2, 225.32, 215.33, 224.36], '1Y': [137.38, 142.63, 144.69, 147.9, 153.3, 162.88, 170.7, 167.03, 175.51, 178.26, 183.16, 175.64, 181.77, 170.62, 177.33, 170.29, 178.43, 186.58, 185.04, 180.03, 181.16, 201.03, 198.69, 193.16, 181.36, 177.82, 181.46, 184.97, 177.72, 189.21, 186.5, 185.04, 187.05, 187.67, 191.13, 185.41, 186.94, 189.82, 177.19, 177.82, 180.25, 172.7, 167.52, 177.64, 189.31, 202.06, 208.27, 198.45, 215.2, 225.32, 215.33, 224.36] },
      velocityScore: { '1D': 3.7, '1W': -2.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.4T', pe: 34.4, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.45,
      etfPresence: { SOXX: 5.88, PSI: 3.83, XSD: 1.83, DRAM: false },
      tonyNote: 'NVIDIA sits at 88% AI ETF coverage with a 5.6% average weight — the broadest institutional consensus in the theme. At a $5.1T market cap and 74% gross margin, the business is printing cash, but the 1-year return of 56% signals the easy money has been made. The score reflects the depth of institutional commitment, not a fresh entry signal.',
    },
    {
      ticker: 'AMAT', name: 'APPLIED MATERIAL INC', easyScore: 2, avgWeight: 4.22, proScore: 2.99, coverage: 0.5,
      ...
      velocityScore: { '1D': 1.4, '1W': 2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$364B', pe: 43.1, revenueGrowth: 11, eps: 10.63, grossMargin: 49, dividendYield: 0.46,
      etfPresence: { SOXX: 4.45, PSI: 4, XSD: false, DRAM: false },
    ...
    {
      ticker: 'TXN', name: 'TEXAS INSTRUMENT INC', easyScore: 3, avgWeight: 3.44, proScore: 2.98, coverage: 0.75,
      ...
      velocityScore: { '1D': -1.7, '1W': -5.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$267B', pe: 50, revenueGrowth: 19, eps: 5.86, grossMargin: 57, dividendYield: 1.94,
      etfPresence: { SOXX: 3.56, PSI: 4.52, XSD: 2.24, DRAM: false },
    ...
    {
      ticker: 'LRCX', name: 'LAM RESEARCH CORP', easyScore: 2, avgWeight: 3.81, proScore: 2.7, coverage: 0.5,
      price: 317.12, weeklyPrices: [322.68, 318.93, 318.00, 318.18, 317.12], weeklyChange: -1.72, sortRank: 0, periodReturns: { '1M': 23.5, '6M': 104.9, '1Y': 284.5 },
      priceHistory: { '1W': [322.68, 318.93, 318, 318.18, 317.12], '1M': [256.72, 258.57, 275.8, 297.17, 286.52, 294.05, 296.05, 289.24, 295.44, 299.15, 284.72, 277.96, 273.38, 292.09, 302.24, 305.35, 322.68, 318.93, 318, 318.18, 317.12], '6M': [154.79, 162.74, 164.3, 175.26, 173.78, 203.08, 208.79, 220.7, 248.17, 213.31, 231.29, 244.92, 233.89, 214.68, 209.49, 233.99, 211.62, 218.44, 263.66, 267.6, 267.78, 256.72, 294.05, 284.72, 305.35, 317.12], '1Y': [82.48, 88.3, 93.41, 95.63, 96.81, 99.81, 101.07, 97.69, 98.94, 96.68, 105.28, 100.33, 103.63, 97.74, 107.36, 121.9, 131.93, 133.9, 140.35, 138.31, 145.04, 155.62, 155.78, 159.18, 143.24, 151.93, 158.19, 165.81, 163.26, 175.16, 171.18, 200.96, 217.47, 217.94, 233.46, 231.01, 231.29, 244.92, 233.89, 199.33, 212.2, 228.36, 211.41, 220.65, 267.32, 263.16, 267.78, 256.72, 294.05, 284.72, 305.35, 317.12] },
      velocityScore: { '1D': 0.4, '1W': 1.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$397B', pe: 59.8, revenueGrowth: 24, eps: 5.3, grossMargin: 50, dividendYield: 0.33,
      etfPresence: { SOXX: 3.36, PSI: 4.27, XSD: false, DRAM: false },
      tonyNote: 'Lam Research is a wafer fab equipment holding, appearing in 2 Semiconductor ETFs. Its positioning is tied to the same logic as AMAT — equipment spending follows leading-edge node transitions and memory capacity additions. The gross margin and revenue profile are consistent with the duopoly pricing power that LRCX and AMAT share in etch and deposition equipment.',
    },
    {
      ticker: 'KLAC', name: 'KLA CORP', easyScore: 2, avgWeight: 3.68, proScore: 2.61, coverage: 0.5,
      ...
      etfPresence: { SOXX: 3.11, PSI: 4.26, XSD: false, DRAM: false },
    ...
    {
      ticker: 'MPWR', name: 'MONOLITHIC POWER SYSTEMS INC', easyScore: 2, avgWeight: 2.78, proScore: 1.97, coverage: 0.5,
      ...
      velocityScore: { '1D': 0.5, '1W': -4.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$76B', pe: 109.9, revenueGrowth: 26, eps: 14.04, grossMargin: 55, dividendYield: 0.52,
      etfPresence: { SOXX: 3.38, PSI: false, XSD: 2.18, DRAM: false },
    ...
    {
      ticker: 'ON', name: 'ON SEMICONDUCTOR CORP', easyScore: 2, avgWeight: 2.75, proScore: 1.94, coverage: 0.5,
      ...
      etfPresence: { SOXX: 2.41, PSI: false, XSD: 3.09, DRAM: false },
    ...
    },
    {
      ...
      price: 252.53, weeklyPrices: [288.53, 277.79, 275.50, 255.23, 252.53], weeklyChange: -12.48, sortRank: 0, periodReturns: { '1M': 15.8, '6M': 125.8, '1Y': 527.1 },
      priceHistory: { '1W': [288.53, 277.79, 275.5, 255.23, 252.53], '1M': [218.01, 215.06, 225.53, 216.87, 210, 211.02, 228.88, 220.83, 270.77, 280.69, 273.98, 248.07, 251.28, 264.48, 279.01, 283.43, 288.53, 277.79, 275.5, 255.23, 252.53], '6M': [111.86, 118.3, 118.25, 118.35, 120.67, 122.22, 123.2, 129.98, 134.71, 129.08, 133.58, 128.47, 124.87, 120.54, 118.54, 166.08, 174.68, 197.8, 203.59, 226.45, 200.54, 218.01, 211.02, 273.98, 283.43, 252.53], '1Y': [40.27, 41.46, 40.39, 42.65, 42.42, 45, 45.4, 48.83, 47.82, 50.13, 46.1, 50.32, 60, 62.26, 67.65, 67.8, 68.53, 72.3, 72.08, 73.39, 74.39, 80.23, 82.45, 99.78, 96.67, 98, 116.46, 124, 114.86, 121.09, 117.42, 117.33, 124, 128.62, 134.73, 139.04, 133.58, 128.47, 124.87, 110.59, 124.71, 163.63, 171.92, 190.19, 209.47, 224.49, 200.54, 218.01, 211.02, 273.98, 283.43, 252.53] },
      velocityScore: { '1D': null, '1W': -10.9, '1M': null, '6M': null }, isNew: true,
      marketCap: '$30B', pe: 116.4, revenueGrowth: 16, eps: 2.17, grossMargin: 25, dividendYield: null,
  ...
  'Electrification': [
    ...
    },
    {
      ...
      price: 294.65, weeklyPrices: [339.65, 328.34, 317.08, 302.18, 294.65], weeklyChange: -13.25, sortRank: 0, periodReturns: { '1M': -24.3, '6M': 41.8, '1Y': 154.9 },
      priceHistory: { '1W': [339.65, 328.34, 317.08, 302.18, 294.65], '1M': [389.05, 387.03, 345.63, 360.81, 351.94, 357.24, 354.97, 339.42, 339.19, 344.6, 323.46, 309.06, 302.84, 313.05, 323.79, 324.86, 339.65, 328.34, 317.08, 302.18, 294.65], '6M': [207.78, 221.85, 216.87, 217.76, 213.41, 224.4, 237.9, 275.57, 269.12, 257.64, 312.95, 331.23, 335.57, 311.42, 305.82, 327.8, 313.11, 332.31, 379.64, 375.6, 387.24, 389.05, 357.24, 323.46, 324.86, 294.65], '1Y': [115.58, 125.73, 125.26, 132.51, 133.59, 141.13, 139.1, 140.68, 142.21, 139.58, 158.81, 150.41, 154.44, 145.25, 157.25, 157.79, 176.59, 170.14, 173.09, 182.75, 196.58, 204.62, 195.05, 215.98, 199.22, 205.92, 210.94, 221.27, 215.16, 217.51, 209.37, 210.99, 257.29, 262.19, 255.36, 273.26, 312.95, 331.23, 335.57, 290.78, 302.02, 317.21, 310.76, 331.9, 378.94, 380.22, 387.24, 389.05, 357.24, 323.46, 324.86, 294.65] },
  ...
  'Industrials': [
    ...
    },
    {
      ...
      price: 224.3, weeklyPrices: [218.90, 224.30, 228.78, 231.15, 224.30], weeklyChange: 2.47, sortRank: 0, periodReturns: { '1M': -1.4, '6M': 20.3, '1Y': 6.1 },
      priceHistory: { '1W': [218.9, 224.3, 228.78, 231.15, 224.3], '1M': [227.38, 221.3, 224.38, 229.93, 231.03, 237.36, 238.21, 236.87, 240.6, 229.21, 220.49, 220.61, 215.01, 222.2, 219.61, 219.02, 218.9, 224.3, 228.78, 231.15, 224.3], '6M': [186.46, 206.27, 205.5, 216.84, 218.5, 228.12, 242.61, 251.41, 234.04, 236.95, 239.35, 232.03, 227.53, 222.06, 204.76, 201.18, 194.36, 208.22, 217.63, 223.38, 232.44, 227.38, 237.36, 220.49, 219.02, 224.3], '1Y': [211.47, 217.51, 201.7, 200.94, 209.79, 226.6, 230, 228.48, 226.08, 224.86, 232.61, 225, 234.83, 232.38, 227.52, 214.63, 216.34, 215.83, 221.82, 214.3, 217.26, 223.33, 198.05, 195.21, 189.63, 182.44, 205.38, 200.37, 206.71, 216.85, 217.12, 227.38, 247.74, 252.15, 233.72, 243.03, 239.35, 232.03, 227.53, 231.11, 209.89, 195.12, 190.52, 212.3, 222.14, 225.08, 232.44, 227.38, 237.36, 220.49, 219.02, 224.3] },
      velocityScore: { '1D': 0, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$177B', pe: 88.7, revenueGrowth: 14, eps: 2.53, grossMargin: 5, dividendYield: null,
