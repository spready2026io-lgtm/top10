...
const TOP10_RET: Record<Theme, Record<Period, number>> = {
  ...
  'Broad Tech':      { '1W': 5.7, '1M': 20.2, '6M': 31.8, '1Y': 50.3 },
...
export const INDEX_CHART_DATA: Record<Theme, Record<Period, ChartPeriodData>> = {
  ...
  'Broad Tech': {
    '1W': { top10: [100, 102.92, 102.65, 104.67, 105.66], spy: [100, 100.66, 100.65, 101.2, 101.45], top10Return: 5.7, spyReturn: 1.5, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 102.07, 103.91, 104.84, 105.71, 107.83, 106.73, 109.59, 111.06, 108.71, 111.04, 108.83, 108.68, 108.05, 110.75, 111.74, 113.83, 117.34, 117.08, 119.36, 120.23], spy: [100, 100.99, 101.27, 100.9, 101.71, 103.13, 102.81, 103.66, 103.9, 103.74, 105.14, 103.88, 103.8, 103.11, 104.17, 104.38, 104.79, 105.48, 105.46, 106.05, 106.31], top10Return: 20.2, spyReturn: 6.3, xLabels: ["May 4", "May 11", "May 18", "May 25", "Jun 1"] },
    '6M': { top10: [100, 103.86, 100.77, 103.85, 102.44, 104.96, 104.08, 101.01, 105.26, 97.97, 100.52, 100.56, 102.32, 102.36, 100.13, 100.88, 95.86, 98.69, 100.92, 109.63, 112.4, 115.35, 120.82, 123.7, 126.32, 132.91], spy: [100, 100.49, 100.07, 100.67, 100.99, 101.37, 101.48, 100.75, 102.23, 100.87, 101.72, 100.62, 101.33, 100.15, 97.91, 96.99, 94.83, 96.41, 99.88, 103.14, 104.14, 105.64, 107.54, 109.98, 109.18, 111.2], top10Return: 31.8, spyReturn: 10.7, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
    '1Y': { top10: [100, 102.84, 102.16, 104.44, 107.3, 107.54, 107.64, 110.52, 110.74, 108.92, 108.07, 109.66, 109.33, 108.17, 111.26, 113.31, 118.03, 117.95, 121.1, 119.47, 120.5, 123.28, 123.54, 121.26, 114.24, 114.96, 116.86, 121.16, 117.47, 120.34, 118.14, 120.55, 118.87, 118.69, 119.38, 109.37, 114.41, 114.62, 115.92, 116.29, 114.44, 116.37, 112.44, 114.47, 118.12, 128.25, 129.4, 132.04, 139.92, 143.01, 143.17, 150.32], spy: [100, 101.65, 101.29, 101.83, 104.83, 105.25, 106.01, 106.68, 108.07, 107.09, 107.89, 109.15, 109.01, 108.63, 110.34, 111.98, 113.14, 112.6, 113.95, 112.5, 113.9, 116.26, 115.94, 115.62, 112.94, 113.46, 115.42, 115.99, 115.5, 116.19, 116.56, 117, 117.13, 116.9, 117.76, 114.97, 117.4, 116.13, 116.95, 115.6, 113.01, 111.95, 109.45, 111.27, 115.28, 120.49, 120.2, 121.93, 124.12, 126.94, 126.02, 128.35], top10Return: 50.3, spyReturn: 28.3, xLabels: ["Jun '25", "Sep '25", "Dec '25", "Mar '26", "Jun '26"] },
  },
  'Electrification': {
...
export const SCAN_TIMESTAMP    = '2026-06-01T09:08:50.029Z';
export const SCAN_TIMESTAMP_NY = 'June 1, 2026 at 5:08 AM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 15.60, bestProScore: 6.77, price: 971.00, weeklyChange: 29.29 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 14.33, bestProScore: 6.06, price: 516.10, weeklyChange: 10.39 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 12.60, bestProScore: 5.20, price: 211.14, weeklyChange: -1.95 },
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 8.80, bestProScore: 3.35, price: 205.00, weeklyChange: 4.42 },
  { ticker: 'STX', name: `Seagate Technology Holdings PLC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 6.52, bestProScore: 2.49, price: 879.80, weeklyChange: 8.25 },
  { ticker: 'GOOGL', name: `ALPHABET INC CLASS A`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 7.88, bestProScore: 4.38, price: 380.34, weeklyChange: -0.69 },
  { ticker: 'MSFT', name: `MICROSOFT CORP`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 7.67, bestProScore: 5.07, price: 450.24, weeklyChange: 7.57 },
  ...
  { ticker: 'POWL', name: `Powell Industries, Inc.`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 6.75, bestProScore: 4.95, price: 284.42, weeklyChange: 1.86 },
];
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'Semiconductors': [
    {
      ticker: 'MU', name: 'MICRON TECHNOLOGY INC', easyScore: 4, avgWeight: 6.77, proScore: 6.77, coverage: 1,
      price: 971, weeklyPrices: [751.00, 895.88, 928.41, 923.52, 971.00], weeklyChange: 29.29, sortRank: 0, periodReturns: { '1M': 87.3, '6M': 310.6, '1Y': 927.9 },
      priceHistory: { '1W': [751, 895.88, 928.41, 923.52, 971], '1M': [518.46, 517.16, 542.21, 576.45, 640.2, 666.59, 646.63, 746.81, 795.33, 766.58, 776.01, 724.66, 681.54, 698.74, 731.99, 762.1, 751, 895.88, 928.41, 923.52, 971], '6M': [240.46, 246.92, 237.5, 276.59, 292.63, 339.55, 333.35, 389.11, 435.28, 379.4, 410.34, 417.35, 415.56, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 457.23, 481.72, 517.16, 646.63, 776.01, 762.1, 971], '1Y': [94.46, 108.56, 115.6, 122.08, 123.25, 124.42, 118.61, 113.23, 111.25, 107.77, 123.72, 123.55, 116.42, 118.48, 135.24, 158.82, 164.62, 163.9, 190.96, 192.77, 206.77, 220.1, 234.7, 253.3, 241.95, 223.93, 240.46, 246.92, 237.5, 276.59, 292.63, 339.55, 333.35, 397.58, 435.79, 382.89, 410.34, 417.35, 415.56, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 455.07, 481.72, 517.16, 646.63, 776.01, 762.1, 971] },
  ...
  'Broad Tech': [
    {
      ticker: 'TSLA', name: 'Tesla Inc', easyScore: 2, avgWeight: 12.42, proScore: 5.85, coverage: 0.222,
      ...
      velocityScore: { '1D': 13.2, '1W': 12.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.6T', pe: 399.8, revenueGrowth: 16, eps: 1.09, grossMargin: 19, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: 14.29, IGV: false, FDTX: false, GTEK: false, ARKK: 10.55, MARS: false },
    ...
    {
      ticker: 'MSFT', name: 'Microsoft Corp', easyScore: 3, avgWeight: 8.79, proScore: 5.07, coverage: 0.333,
      price: 450.24, weeklyPrices: [418.57, 416.03, 412.67, 426.99, 450.24], weeklyChange: 7.57, sortRank: 0, periodReturns: { '1M': 6.1, '6M': -8.5, '1Y': -2.2 },
      priceHistory: { '1W': [418.57, 416.03, 412.67, 426.99, 450.24], '1M': [424.46, 407.78, 414.44, 413.62, 411.38, 413.96, 420.77, 415.12, 412.66, 407.77, 409.43, 421.92, 423.54, 417.42, 421.06, 419.09, 418.57, 416.03, 412.67, 426.99, 450.24], '6M': [486.74, 491.02, 474.82, 484.92, 487.48, 483.47, 459.38, 444.11, 481.63, 414.19, 404.37, 398.46, 401.72, 410.68, 401.86, 389.02, 365.97, 373.46, 370.87, 420.26, 415.75, 407.78, 420.77, 409.43, 419.09, 450.24], '1Y': [460.36, 470.38, 474.96, 486, 497.41, 496.62, 503.02, 510.06, 512.5, 535.64, 521.77, 517.1, 504.26, 505.12, 498.41, 509.04, 514.45, 514.6, 528.57, 514.05, 516.79, 531.52, 517.03, 506, 507.49, 474, 486.74, 491.02, 474.82, 484.92, 487.48, 483.47, 459.38, 451.14, 433.5, 393.67, 404.37, 398.46, 401.72, 410.68, 401.86, 389.02, 365.97, 373.46, 370.87, 422.79, 415.75, 407.78, 420.77, 409.43, 419.09, 450.24] },
      velocityScore: { '1D': 2.2, '1W': 1.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$3.3T', pe: 26.8, revenueGrowth: 18, eps: 16.79, grossMargin: 68, dividendYield: 0.81,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: 14.29, IGV: 8.01, FDTX: 4.06, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Microsoft appears in 4 of 8 AI ETFs and 2 Broad Tech ETFs at 3.7% average weight. Revenue up 18%, 68% gross margin, P/E of 27x — solid fundamentals for a $3.3T business. The -2.2% 1-year return and -8.5% 6-month return suggest the Copilot monetization narrative has stalled; ETF managers hold the position on long-term Azure and OpenAI leverage, not near-term momentum.',
    },
    {
      ticker: 'RKLB', name: 'Rocket Lab Corp', easyScore: 1, avgWeight: 14.18, proScore: 4.73, coverage: 0.111,
      ...
      velocityScore: { '1D': 7.5, '1W': 5.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$83B', pe: null, revenueGrowth: 64, eps: -0.32, grossMargin: 37, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: 14.18 },
    ...
    {
      ticker: 'GOOGL', name: 'ALPHABET INC-CL A', easyScore: 2, avgWeight: 9.28, proScore: 4.38, coverage: 0.222,
      price: 380.34, weeklyPrices: [382.97, 388.88, 388.83, 390.13, 380.34], weeklyChange: -0.69, sortRank: 0, periodReturns: { '1M': 8.7, '6M': 18.8, '1Y': 121.5 },
      priceHistory: { '1W': [382.97, 388.88, 388.83, 390.13, 380.34], '1M': [349.94, 384.8, 385.69, 383.25, 388.43, 398.04, 397.99, 400.8, 388.64, 387.35, 401.07, 396.78, 396.94, 387.66, 388.91, 387.66, 382.97, 388.88, 388.83, 390.13, 380.34], '6M': [314.89, 313.72, 308.22, 309.78, 313.85, 321.98, 335.84, 328.38, 336.01, 333.04, 310.96, 302.85, 307.38, 300.88, 303.55, 307.13, 280.92, 295.77, 317.24, 336.02, 338.89, 384.8, 397.99, 401.07, 387.66, 380.34], '1Y': [171.74, 173.68, 174.67, 165.19, 176.23, 174.36, 181.56, 190.1, 192.58, 195.04, 201, 203.5, 208.49, 211.35, 239.63, 251.16, 252.53, 244.05, 250.43, 244.15, 256.55, 269.27, 283.72, 290.1, 285.02, 318.58, 314.89, 313.72, 308.22, 309.78, 313.85, 321.98, 335.84, 330.54, 338.25, 331.25, 310.96, 302.85, 307.38, 300.88, 303.55, 307.13, 280.92, 295.77, 317.24, 341.68, 338.89, 384.8, 397.99, 401.07, 387.66, 380.34] },
      velocityScore: { '1D': 5, '1W': 6.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4.6T', pe: 29, revenueGrowth: 22, eps: 13.12, grossMargin: 60, dividendYield: 0.23,
      etfPresence: { QQQA: 4.28, PTF: false, WCLD: false, MAGS: 14.29, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Alphabet holds a 4.95% average weight across 4 AI ETFs, but the 50% coverage is the constraint — half the theme ignores it. Revenue up 22%, gross margin at 60%, P/E of 29x makes it the cheapest mega-cap in the theme. The 1-year return of 121% shows the market has caught up to the AI value story, but at this valuation the upside case depends on sustained cloud and search margin expansion.',
    },
    {
      ticker: 'NVDA', name: 'NVIDIA Corp', easyScore: 4, avgWeight: 6.29, proScore: 4.19, coverage: 0.444,
      price: 211.14, weeklyPrices: [215.33, 214.86, 212.60, 214.25, 211.14], weeklyChange: -1.95, sortRank: 0, periodReturns: { '1M': 0.9, '6M': 19.3, '1Y': 56.2 },
      priceHistory: { '1W': [215.33, 214.86, 212.6, 214.25, 211.14], '1M': [209.25, 199.57, 198.45, 198.48, 196.5, 207.83, 211.5, 215.2, 219.44, 220.78, 235.74, 225.32, 222.32, 220.61, 223.47, 219.51, 215.33, 214.86, 212.6, 214.25, 211.14], '6M': [179.92, 185.55, 176.29, 183.69, 187.54, 189.11, 183.14, 183.32, 191.52, 174.19, 190.05, 187.9, 184.89, 183.34, 183.14, 178.56, 171.24, 177.39, 188.63, 198.35, 199.64, 199.57, 211.5, 235.74, 219.51, 211.14], '1Y': [135.13, 141.72, 141.97, 144.17, 157.99, 160, 164.07, 171.38, 176.75, 180, 182.06, 182.01, 179.81, 170.78, 170.76, 174.88, 183.61, 181.85, 185.54, 188.32, 182.64, 191.49, 206.88, 199.05, 186.6, 182.55, 179.92, 185.55, 176.29, 183.69, 187.54, 189.11, 183.14, 184.84, 192.51, 171.88, 190.05, 187.9, 184.89, 183.34, 183.14, 178.56, 171.24, 177.39, 188.63, 201.68, 199.64, 199.57, 211.5, 235.74, 219.51, 211.14] },
      velocityScore: { '1D': -11.8, '1W': -13.6, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.1T', pe: 32.4, revenueGrowth: 85, eps: 6.52, grossMargin: 74, dividendYield: 0.47,
      etfPresence: { QQQA: false, PTF: 4.42, WCLD: false, MAGS: 14.29, IGV: false, FDTX: 5.27, GTEK: false, ARKK: 1.19, MARS: false },
      tonyNote: 'NVIDIA sits at 88% AI ETF coverage with a 5.6% average weight — the broadest institutional consensus in the theme. At a $5.1T market cap and 74% gross margin, the business is printing cash, but the 1-year return of 56% signals the easy money has been made. The score reflects the depth of institutional commitment, not a fresh entry signal.',
    },
    {
      ticker: 'AMZN', name: 'Amazon.com Inc', easyScore: 3, avgWeight: 7.2, proScore: 4.16, coverage: 0.333,
      price: 270.64, weeklyPrices: [266.32, 265.29, 271.85, 274.00, 270.64], weeklyChange: 1.62, sortRank: 0, periodReturns: { '1M': 2.9, '6M': 16, '1Y': 32 },
      priceHistory: { '1W': [266.32, 265.29, 271.85, 274, 270.64], '1M': [263.04, 265.06, 268.26, 272.05, 273.55, 274.99, 271.17, 272.68, 268.99, 265.82, 267.22, 264.14, 264.86, 259.34, 265.01, 268.46, 266.32, 265.29, 271.85, 274, 270.64], '6M': [233.88, 226.89, 222.54, 228.43, 232.53, 241.56, 236.65, 231.31, 243.01, 232.99, 204.08, 204.86, 207.92, 218.94, 209.53, 208.76, 207.54, 209.77, 238.38, 249.7, 255.08, 265.06, 271.17, 267.22, 268.46, 270.64], '1Y': [205.01, 213.57, 212.1, 208.47, 219.39, 219.36, 225.69, 229.3, 232.79, 211.65, 221.3, 231.49, 227.94, 225.34, 238.24, 234.05, 227.63, 222.17, 220.9, 220.07, 216.48, 226.97, 254, 248.4, 232.87, 226.28, 233.88, 226.89, 222.54, 228.43, 232.53, 241.56, 236.65, 234.34, 241.73, 222.69, 204.08, 204.86, 207.92, 218.94, 209.53, 208.76, 207.54, 209.77, 238.38, 250.56, 255.08, 265.06, 271.17, 267.22, 268.46, 270.64] },
      velocityScore: { '1D': 0.5, '1W': 0, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.9T', pe: 31.7, revenueGrowth: 17, eps: 8.55, grossMargin: 51, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: 14.29, IGV: false, FDTX: 4.64, GTEK: false, ARKK: 2.68, MARS: false },
      tonyNote: 'Amazon is a selective AI holding — 3 of 8 ETFs, 4.7% average weight — positioned on AWS rather than hardware. Revenue growth of 17% looks modest against pure-play AI names, but 51% gross margin and a $2.9T market cap reflect the cloud platform advantage. The 32% 1-year return underperforms the theme; ETF managers hold it as a diversifier, not a conviction AI bet.',
    },
    {
      ticker: 'AAPL', name: 'Apple Inc', easyScore: 3, avgWeight: 6.67, proScore: 3.85, coverage: 0.333,
      price: 312.06, weeklyPrices: [308.82, 308.33, 310.85, 312.51, 312.06], weeklyChange: 1.05, sortRank: 0, periodReturns: { '1M': 15.5, '6M': 11.9, '1Y': 55.4 },
      priceHistory: { '1W': [308.82, 308.33, 310.85, 312.51, 312.06], '1M': [270.17, 271.35, 280.14, 276.83, 284.18, 287.51, 287.44, 293.32, 292.68, 294.8, 298.21, 300.23, 297.84, 298.97, 302.25, 304.99, 308.82, 308.33, 310.85, 312.51, 312.06], '6M': [283.1, 277.89, 274.11, 270.97, 273.08, 260.33, 259.96, 247.65, 256.44, 276.49, 275.5, 260.58, 272.95, 260.29, 255.76, 248.96, 252.89, 255.92, 260.48, 263.4, 273.43, 271.35, 287.44, 298.21, 304.99, 312.06], '1Y': [200.85, 203.92, 196.45, 201.5, 205.17, 210.01, 208.62, 212.48, 214.05, 203.35, 227.18, 230.89, 227.16, 229.72, 234.35, 238.15, 256.08, 254.43, 256.69, 247.66, 262.24, 268.81, 269.05, 269.43, 267.46, 275.92, 283.1, 277.89, 274.11, 270.97, 273.08, 260.33, 259.96, 248.35, 258.28, 275.91, 275.5, 260.58, 272.95, 260.29, 255.76, 248.96, 252.89, 255.92, 260.48, 270.23, 273.43, 271.35, 287.44, 298.21, 304.99, 312.06] },
      velocityScore: { '1D': -10.7, '1W': -11.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4.6T', pe: 37.7, revenueGrowth: 17, eps: 8.27, grossMargin: 48, dividendYield: 0.35,
      etfPresence: { QQQA: false, PTF: 4.51, WCLD: false, MAGS: 14.29, IGV: false, FDTX: 1.22, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Apple is a selective AI holding — only 2 of 8 ETFs hold it at 3.81% average weight. Revenue up 17%, 48% gross margin, P/E of 38x — reasonable for the installed base franchise. The ETF managers treating it as an AI name are betting on on-device AI monetization through the App Store; the majority are not yet convinced, which explains the 25% coverage.',
    },
    {
      ticker: 'META', name: 'Meta Platforms Inc', easyScore: 3, avgWeight: 6.06, proScore: 3.5, coverage: 0.333,
      price: 632.51, weeklyPrices: [610.26, 612.34, 635.26, 635.29, 632.51], weeklyChange: 3.65, sortRank: 0, periodReturns: { '1M': -5.5, '6M': -2.4, '1Y': -2.3 },
      priceHistory: { '1W': [610.26, 612.34, 635.26, 635.29, 632.51], '1M': [669.12, 611.91, 608.75, 610.41, 604.96, 612.88, 616.81, 609.63, 598.86, 603, 618.43, 614.23, 611.21, 602.61, 605.06, 607.38, 610.26, 612.34, 635.26, 635.29, 632.51], '6M': [640.87, 666.8, 647.51, 661.5, 665.95, 648.69, 615.52, 612.96, 668.73, 668.99, 668.69, 644.78, 657.01, 660.57, 638.18, 606.7, 547.54, 574.46, 629.86, 676.87, 659.15, 611.91, 616.81, 618.43, 607.38, 632.51], '1Y': [647.49, 697.71, 682.87, 698.53, 738.09, 720.67, 720.92, 712.97, 717.63, 776.37, 765.87, 767.37, 753.3, 735.11, 765.7, 779, 765.16, 743.4, 715.66, 715.7, 732.17, 750.82, 637.71, 631.76, 602.01, 613.05, 640.87, 666.8, 647.51, 661.5, 665.95, 648.69, 615.52, 647.63, 738.31, 670.21, 668.69, 644.78, 657.01, 660.57, 638.18, 606.7, 547.54, 574.46, 629.86, 688.55, 659.15, 611.91, 616.81, 618.43, 607.38, 632.51] },
      velocityScore: { '1D': 5.1, '1W': 4.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.6T', pe: 23, revenueGrowth: 33, eps: 27.51, grossMargin: 82, dividendYield: 0.33,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: 14.29, IGV: false, FDTX: 3.31, GTEK: false, ARKK: 0.58, MARS: false },
      tonyNote: 'Meta holds a 3.76% average weight across 4 AI ETFs, with the highest EPS in the theme at $27.51 and an 82% gross margin. Revenue grew 33% and the P/E of 23x is the most attractive valuation in the group. The 1-year return of -2.3% is a red flag — the market is not rewarding the AI capex story yet, and the weight score reflects moderate rather than high conviction.',
    },
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 3, avgWeight: 5.55, proScore: 3.2, coverage: 0.333,
      price: 205, weeklyPrices: [196.33, 208.26, 198.70, 204.83, 205.00], weeklyChange: 4.42, sortRank: 0, periodReturns: { '1M': 30.9, '6M': 129.3, '1Y': 240.6 },
      priceHistory: { '1W': [196.33, 208.26, 198.7, 204.83, 205], '1M': [156.57, 165.15, 164.95, 163.66, 168.75, 172.15, 160.01, 170.13, 170.84, 164.5, 182.58, 176.89, 168.93, 176.27, 186.8, 190.69, 196.33, 208.26, 198.7, 204.83, 205], '6M': [91.1, 92, 84.26, 84.8, 86.76, 84.64, 81.21, 82.55, 83.62, 73.73, 81.34, 79.61, 79.29, 75.68, 87.67, 89.53, 97.68, 107.11, 128.49, 133.37, 165.56, 165.15, 160.01, 182.58, 190.69, 205], '1Y': [60.19, 68.35, 67.19, 70.78, 77.4, 71.95, 72.51, 73.06, 75.91, 76.53, 77.28, 76.74, 72.95, 64.6, 66.84, 68.86, 75.53, 82.39, 88.92, 89.39, 85.84, 88.71, 90.37, 93.23, 83.45, 83.79, 91.1, 92, 84.26, 84.8, 86.76, 84.64, 81.21, 83.1, 81.34, 74.21, 81.34, 79.61, 79.29, 75.68, 87.67, 89.53, 97.68, 107.11, 128.49, 139.69, 165.56, 165.15, 160.01, 182.58, 190.69, 205] },
      velocityScore: { '1D': 4.2, '1W': 4.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$179B', pe: 70.4, revenueGrowth: 28, eps: 2.91, grossMargin: 52, dividendYield: 0.12,
      etfPresence: { QQQA: 5.69, PTF: false, WCLD: false, MAGS: false, IGV: false, FDTX: 7.68, GTEK: 3.28, ARKK: false, MARS: false },
      tonyNote: 'Marvell scores across three themes — AI, Semiconductors, and Broad Tech — at average weights of 3.7-4.7%. Revenue grew 28%, gross margin at 52%, P/E of 70x. Custom AI silicon for hyperscalers is the thesis, and the 241% 1-year return says the market is pricing it aggressively. The cross-theme ETF presence is the strongest signal of institutional conviction.',
    },
    {
      ticker: 'AMD', name: 'ADVANCED MICRO DEVICES', easyScore: 2, avgWeight: 6.56, proScore: 3.09, coverage: 0.222,
      price: 516.1, weeklyPrices: [467.51, 503.89, 495.54, 518.09, 516.10], weeklyChange: 10.39, sortRank: 0, periodReturns: { '1M': 53.1, '6M': 137.3, '1Y': 366.1 },
      priceHistory: { '1W': [467.51, 503.89, 495.54, 518.09, 516.1], '1M': [337.11, 354.49, 360.54, 341.54, 355.26, 421.39, 408.46, 455.19, 458.79, 448.29, 449.7, 424.1, 420.99, 414.05, 447.58, 449.59, 467.51, 503.89, 495.54, 518.09, 516.1], '6M': [219.76, 221.11, 207.58, 214.95, 215.34, 210.02, 223.6, 249.8, 252.74, 200.19, 213.58, 203.37, 203.68, 199.45, 197.74, 205.27, 203.77, 217.5, 245.04, 278.26, 305.33, 354.49, 408.46, 449.7, 449.59, 516.1], '1Y': [110.73, 116.19, 116.16, 129.58, 141.9, 137.82, 146.24, 157, 173.66, 176.78, 172.28, 176.14, 163.36, 162.32, 155.82, 160.46, 159.79, 161.36, 203.71, 216.42, 240.56, 259.67, 259.65, 243.98, 240.52, 215.05, 219.76, 221.11, 207.58, 214.95, 215.34, 210.02, 223.6, 253.73, 252.18, 192.5, 213.58, 203.37, 203.68, 199.45, 197.74, 205.27, 203.77, 217.5, 245.04, 278.39, 305.33, 354.49, 408.46, 449.7, 449.59, 516.1] },
      velocityScore: { '1D': 1, '1W': 7.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$842B', pe: 172.6, revenueGrowth: 38, eps: 2.99, grossMargin: 53, dividendYield: null,
      etfPresence: { QQQA: 7.51, PTF: false, WCLD: false, MAGS: false, IGV: false, FDTX: false, GTEK: false, ARKK: 5.6, MARS: false },
      tonyNote: 'AMD scores highest in Semiconductors at 7.0% average weight, held by 3 of 4 chip ETFs. Revenue grew 38% with 53% gross margins and EPS of $2.99 — improving but still stretched at a P/E of 172x. The 1-year return of 366% compresses future upside; the weight score says ETF managers are committed, but valuation is the variable to watch.',
    },
    {
      ticker: 'ASTS', name: 'AST SpaceMobile Inc', easyScore: 1, avgWeight: 8.8, proScore: 2.93, coverage: 0.111,
      ...
      velocityScore: { '1D': -5.8, '1W': 6.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$44B', pe: null, revenueGrowth: 1952, eps: -1.8, grossMargin: 45, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: 8.8 },
    ...
    {
      ticker: 'ARM', name: 'ARM HOLDINGS PLC-ADR', easyScore: 1, avgWeight: 8.47, proScore: 2.82, coverage: 0.111,
      ...
      velocityScore: { '1D': 11.5, '1W': 16.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$377B', pe: 415.6, revenueGrowth: 20, eps: 0.85, grossMargin: 98, dividendYield: null,
      etfPresence: { QQQA: 8.47, PTF: false, WCLD: false, MAGS: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: false },
    ...
    {
      ticker: 'APP', name: 'APPLOVIN CORP-CLASS A', easyScore: 2, avgWeight: 5.56, proScore: 2.62, coverage: 0.222,
      ...
      etfPresence: { QQQA: 5.58, PTF: false, WCLD: false, MAGS: false, IGV: 5.54, FDTX: false, GTEK: false, ARKK: false, MARS: false },
    ...
    {
      ticker: 'PLTR', name: 'PALANTIR TECHNOLOGIES INC CLASS A', easyScore: 3, avgWeight: 4.49, proScore: 2.59, coverage: 0.333,
      ...
      velocityScore: { '1D': 11.6, '1W': 12.6, '1M': null, '6M': null }, isNew: false,
      marketCap: '$375B', pe: 175.9, revenueGrowth: 85, eps: 0.89, grossMargin: 84, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: 7.44, FDTX: 3.01, GTEK: false, ARKK: 3.02, MARS: false },
    ...
    {
      ticker: 'SNDK', name: 'Sandisk Corp/DE', easyScore: 1, avgWeight: 7.61, proScore: 2.54, coverage: 0.111,
      price: 1694.98, weeklyPrices: [1478.69, 1589.55, 1589.94, 1641.64, 1694.98], weeklyChange: 14.63, sortRank: 0, periodReturns: { '1M': 59.3, '6M': 659.1, '1Y': 4397.2 },
      priceHistory: { '1W': [1478.69, 1589.55, 1589.94, 1641.64, 1694.98], '1M': [1064.21, 1096.51, 1187, 1255.86, 1406.32, 1409.98, 1339.96, 1562.34, 1547.56, 1452.02, 1382.72, 1407.61, 1333.01, 1383.29, 1392.56, 1542.24, 1478.69, 1589.55, 1589.94, 1641.64, 1694.98], '6M': [210.17, 225.47, 201.87, 241.05, 240.22, 353.56, 387.81, 501.29, 527.63, 584.55, 599.34, 621.09, 651.9, 565.59, 618.82, 772.09, 603.17, 701.59, 851.77, 919.47, 932.43, 1096.51, 1339.96, 1382.72, 1542.24, 1694.98], '1Y': [37.69, 39.15, 42.5, 46.95, 45.35, 46.17, 42.48, 41.61, 41.89, 42.51, 43.37, 45.52, 46.78, 51.07, 70.51, 91.55, 102.92, 113.5, 121.17, 134.61, 148.04, 176.49, 207.01, 267.95, 265.88, 226.96, 210.17, 225.47, 201.87, 241.05, 240.22, 353.56, 387.81, 503.44, 539.3, 576.2, 599.34, 621.09, 651.9, 565.59, 618.82, 772.09, 603.17, 701.59, 851.77, 920.99, 932.43, 1096.51, 1339.96, 1382.72, 1542.24, 1694.98] },
      velocityScore: { '1D': null, '1W': 16, '1M': null, '6M': null }, isNew: true,
      marketCap: '$251B', pe: 57.8, revenueGrowth: 251, eps: 29.32, grossMargin: 56, dividendYield: null,
      etfPresence: { QQQA: false, PTF: 7.61, WCLD: false, MAGS: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'SanDisk is a NAND flash storage name that has recovered sharply alongside the AI storage demand cycle. The high share price relative to peers reflects post-restructuring equity appreciation. ETF managers hold it alongside WDC as part of the NAND storage infrastructure thesis.',
    },
    {
      ticker: 'ORCL', name: 'ORACLE CORP', easyScore: 2, avgWeight: 5.34, proScore: 2.52, coverage: 0.222,
      price: 225.78, weeklyPrices: [192.08, 193.06, 190.96, 203.70, 225.78], weeklyChange: 17.54, sortRank: 0, periodReturns: { '1M': 37.8, '6M': 11.8, '1Y': 36.4 },
      priceHistory: { '1W': [192.08, 193.06, 190.96, 203.7, 225.78], '1M': [163.83, 161.39, 171.83, 180.29, 185.35, 194.03, 194.59, 195.95, 193.84, 186.83, 195.61, 192.95, 186.61, 181.46, 188.16, 189.77, 192.08, 193.06, 190.96, 203.7, 225.78], '6M': [200.94, 220.54, 184.92, 198.38, 197.21, 192.84, 193.61, 173.88, 172.8, 146.67, 157.16, 156.54, 150.31, 154.79, 159.16, 155.52, 142.81, 146.38, 138.09, 178.34, 176.28, 161.39, 194.59, 195.61, 189.77, 225.78], '1Y': [165.53, 174.02, 215.22, 207.04, 218.63, 234.5, 229.28, 243.54, 247.71, 252.53, 252.68, 249.07, 235.41, 225.3, 241.51, 306.65, 328.15, 282.76, 291.59, 308.01, 277.18, 281.4, 257.85, 240.83, 219.86, 200.28, 200.94, 220.54, 184.92, 198.38, 197.21, 192.84, 193.61, 178.18, 169.01, 136.48, 157.16, 156.54, 150.31, 154.79, 159.16, 155.52, 142.81, 146.38, 138.09, 175.06, 176.28, 161.39, 194.59, 195.61, 189.77, 225.78] },
      velocityScore: { '1D': 10, '1W': 14, '1M': null, '6M': null }, isNew: false,
      marketCap: '$649B', pe: 40.5, revenueGrowth: 22, eps: 5.58, grossMargin: 67, dividendYield: 0.89,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: 9.98, FDTX: 0.7, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Oracle lands in 3 AI ETFs on the strength of its cloud database and AI infrastructure contracts. Revenue grew 22%, 67% gross margin, P/E of 40x. The 17.5% weekly return following a major earnings beat shows how quickly sentiment can reprice; the weight score at 2.04% is still modest, meaning ETF managers have started building positions but conviction is not yet deep.',
    },
    {
      ticker: 'MU', name: 'Micron Technology Inc', easyScore: 2, avgWeight: 5.33, proScore: 2.51, coverage: 0.222,
      price: 971, weeklyPrices: [751.00, 895.88, 928.41, 923.52, 971.00], weeklyChange: 29.29, sortRank: 0, periodReturns: { '1M': 87.3, '6M': 310.6, '1Y': 927.9 },
      priceHistory: { '1W': [751, 895.88, 928.41, 923.52, 971], '1M': [518.46, 517.16, 542.21, 576.45, 640.2, 666.59, 646.63, 746.81, 795.33, 766.58, 776.01, 724.66, 681.54, 698.74, 731.99, 762.1, 751, 895.88, 928.41, 923.52, 971], '6M': [240.46, 246.92, 237.5, 276.59, 292.63, 339.55, 333.35, 389.11, 435.28, 379.4, 410.34, 417.35, 415.56, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 457.23, 481.72, 517.16, 646.63, 776.01, 762.1, 971], '1Y': [94.46, 108.56, 115.6, 122.08, 123.25, 124.42, 118.61, 113.23, 111.25, 107.77, 123.72, 123.55, 116.42, 118.48, 135.24, 158.82, 164.62, 163.9, 190.96, 192.77, 206.77, 220.1, 234.7, 253.3, 241.95, 223.93, 240.46, 246.92, 237.5, 276.59, 292.63, 339.55, 333.35, 397.58, 435.79, 382.89, 410.34, 417.35, 415.56, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 455.07, 481.72, 517.16, 646.63, 776.01, 762.1, 971] },
      velocityScore: { '1D': -7.4, '1W': 0.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.1T', pe: 45.9, revenueGrowth: 196, eps: 21.17, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { QQQA: false, PTF: 4.77, WCLD: false, MAGS: false, IGV: false, FDTX: 5.89, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
      ticker: 'STX', name: 'SEAGATE TECHNOLOGY HOLDINGS', easyScore: 3, avgWeight: 4.31, proScore: 2.49, coverage: 0.333,
      price: 879.8, weeklyPrices: [812.73, 845.76, 870.66, 880.72, 879.80], weeklyChange: 8.25, sortRank: 0, periodReturns: { '1M': 36.8, '6M': 218, '1Y': 646 },
      priceHistory: { '1W': [812.73, 845.76, 870.66, 880.72, 879.8], '1M': [643.3, 673.64, 726.93, 738.54, 771.01, 786.42, 766.44, 782.64, 834.01, 808.8, 804.76, 795.47, 740.84, 733.35, 751.07, 810.46, 812.73, 845.76, 870.66, 880.72, 879.8], '6M': [270.1, 285.41, 285.58, 282.85, 280.08, 308.26, 312.28, 344.22, 442.93, 418.63, 407.25, 408.97, 409.67, 367.34, 373.98, 434.6, 378.79, 429.36, 503.13, 531.81, 587.62, 673.64, 766.44, 804.76, 810.46, 879.8], '1Y': [117.94, 126.97, 127.27, 133.08, 144.33, 144.47, 149.08, 149.63, 150.46, 154.81, 151.69, 158.7, 164, 170.5, 191.59, 211.13, 229.33, 229.14, 242.83, 219.51, 214.4, 230.32, 265.55, 293.99, 261.38, 253.38, 270.1, 285.41, 285.58, 282.85, 280.08, 308.26, 312.28, 346.53, 446.57, 405.45, 407.25, 408.97, 409.67, 367.34, 373.98, 434.6, 378.79, 429.36, 503.13, 547.75, 587.62, 673.64, 766.44, 804.76, 810.46, 879.8] },
      velocityScore: { '1D': 6, '1W': 8.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$199B', pe: 83.3, revenueGrowth: 44, eps: 10.56, grossMargin: 42, dividendYield: 0.34,
      etfPresence: { QQQA: 6.25, PTF: 4.66, WCLD: false, MAGS: false, IGV: false, FDTX: 2.02, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Seagate appears in 4 AI ETFs at 2.73% average weight, positioned alongside WDC as the institutional pair trade on AI storage infrastructure. Revenue grew 44%, gross margin 42%, P/E of 83x — the premium valuation reflects expectations for continued enterprise HDD pricing power. The 646% 1-year return is substantial; at current prices the weight score matters more as a signal of continued institutional support than a fresh entry point.',
    },
    {
      ticker: 'PANW', name: 'PANW', easyScore: 3, avgWeight: 4.25, proScore: 2.46, coverage: 0.333,
      ...
      velocityScore: { '1D': 7.4, '1W': 5.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$228B', pe: 156.5, revenueGrowth: 15, eps: 1.8, grossMargin: 74, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: 2.41, MAGS: false, IGV: 7.59, FDTX: 2.76, GTEK: false, ARKK: false, MARS: false },
    ...
    {
      ticker: 'SATS', name: 'EchoStar Corp', easyScore: 1, avgWeight: 7.22, proScore: 2.41, coverage: 0.111,
      ...
      velocityScore: { '1D': 9.5, '1W': 4.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$37B', pe: null, revenueGrowth: -5, eps: -50.21, grossMargin: 27, dividendYield: null,
      etfPresence: { QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: 7.22 },
  ...
  'Industrials': [
    {
      ticker: 'STRL', name: 'Sterling Infrastructure, Inc.', easyScore: 2, avgWeight: 5.38, proScore: 5.38, coverage: 1,
