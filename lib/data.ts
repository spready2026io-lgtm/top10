...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'Broad Tech': [
    ...
    {
      ticker: 'PLTR', name: 'Palantir Technologies Inc', easyScore: 4, proScore: 3.65,
      price: 135.26, weeklyPrices: [131.20, 132.55, 133.23, 134.31, 135.26], weeklyChange: 0.09, sortRank: 0,
      marketCap: '$324B', pe: 152, revenueGrowth: 85, eps: 0.89, grossMargin: 84, dividendYield: null,
      etfPresence: { QQQ: true, QQQA: false, PTF: false, WCLD: false, MAGS: false, IGV: true, FDTX: true, GTEK: false, ARKK: true, MARS: false },
      tonyNote: 'Palantir Technologies Inc appears in 4 of 8 Broad Tech ETFs (50% coverage) with average weight 3.6% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'STX', name: 'Seagate Technology Holdings PLC', easyScore: 4, proScore: 3.25,
      ...
      etfPresence: { QQQ: true, QQQA: true, PTF: true, WCLD: false, MAGS: false, IGV: false, FDTX: true, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Seagate Technology Holdings PLC appears in 4 of 8 Broad Tech ETFs (50% coverage) with average weight 3.3% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'WDC', name: 'Western Digital Corp', easyScore: 4, proScore: 3.13,
      price: 455.8, weeklyPrices: [442.13, 446.68, 448.96, 452.61, 455.80], weeklyChange: -0.63, sortRank: 0,
      marketCap: '$157B', pe: 27.2, revenueGrowth: 46, eps: 16.73, grossMargin: 45, dividendYield: 0.13,
      etfPresence: { QQQ: true, QQQA: true, PTF: true, WCLD: false, MAGS: false, IGV: false, FDTX: true, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Western Digital Corp appears in 4 of 8 Broad Tech ETFs (50% coverage) with average weight 3.1% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'MPWR', name: 'Monolithic Power Systems Inc', easyScore: 4, proScore: 2.13,
      price: 1468.11, weeklyPrices: [1424.07, 1438.75, 1446.09, 1457.83, 1468.11], weeklyChange: -1.23, sortRank: 0,
      marketCap: '$72B', pe: 105.2, revenueGrowth: 26, eps: 13.95, grossMargin: 55, dividendYield: 0.54,
      etfPresence: { QQQ: true, QQQA: true, PTF: true, WCLD: false, MAGS: false, IGV: false, FDTX: true, GTEK: false, ARKK: false, MARS: false },
      tonyNote: 'Monolithic Power Systems Inc appears in 4 of 8 Broad Tech ETFs (50% coverage) with average weight 2.1% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
