...
export const SCAN_TIMESTAMP    = '2026-06-07T15:20:01.385Z';
export const SCAN_TIMESTAMP_NY = 'June 7, 2026 at 11:20 AM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 13.74, bestProScore: 5.95, price: 864.01, weeklyChange: -16.56 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.10, bestProScore: 5.63, price: 205.10, weeklyChange: -8.58 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 10.83, bestProScore: 4.64, price: 466.38, weeklyChange: -8.58 },
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 7.31, bestProScore: 3.49, price: 263.47, weeklyChange: 20.07 },
  { ticker: 'AVGO', name: `Broadcom Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 5.75, bestProScore: 2.49, price: 385.73, weeklyChange: -16.14 },
  ...
  { ticker: 'TSM', name: `Taiwan Semiconductor Manufacturing Co Ltd ADR`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 4.25, bestProScore: 2.60, price: 415.17, weeklyChange: -4.70 },
  { ticker: 'ETN', name: `Eaton Corp PLC`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 3.52, bestProScore: 2.37, price: 395.94, weeklyChange: -1.03 },
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'AI & ML': [
    {
      ticker: 'NVDA', name: 'NVIDIA Corp', easyScore: 10, avgWeight: 6.19, proScore: 5.63, coverage: 0.909,
      ...
      velocityScore: { '1D': 1.3, '1W': 8.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.0T', pe: 31.5, revenueGrowth: 85, eps: 6.52, grossMargin: 74, dividendYield: 0.49,
      etfPresence: { AIS: 2.56, ARTY: 3.47, BAI: 4.52, IVEP: false, IGPT: 6.04, IVES: 4.71, ALAI: 13.23, CHAT: 5.98, AIFD: 6.57, SPRX: 3.95, AOTG: 10.86 },
    ...
    {
      ticker: 'MU', name: 'Micron Technology Inc', easyScore: 9, avgWeight: 6.59, proScore: 5.39, coverage: 0.818,
      ...
      velocityScore: { '1D': -5.4, '1W': -14.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$974B', pe: 40.8, revenueGrowth: 196, eps: 21.17, grossMargin: 58, dividendYield: 0.07,
      etfPresence: { AIS: 7.43, ARTY: 7.18, BAI: 5.72, IVEP: false, IGPT: 11.49, IVES: 5.29, ALAI: 0.96, CHAT: 5.7, AIFD: 5.75, SPRX: false, AOTG: 9.8 },
    ...
    {
      ticker: 'AMD', name: 'Advanced Micro Devices Inc', easyScore: 9, avgWeight: 5.67, proScore: 4.64, coverage: 0.818,
      ...
      velocityScore: { '1D': -2.3, '1W': -10.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$760B', pe: 156.5, revenueGrowth: 38, eps: 2.98, grossMargin: 53, dividendYield: null,
      etfPresence: { AIS: 4.44, ARTY: 7.23, BAI: 5.04, IVEP: false, IGPT: 7.15, IVES: 4.57, ALAI: 1.01, CHAT: 5.48, AIFD: false, SPRX: 0.52, AOTG: 15.63 },
    ...
    {
      ticker: 'GOOGL', name: 'ALPHABET INC CLASS A', easyScore: 6, avgWeight: 4.94, proScore: 2.7, coverage: 0.545,
      ...
      velocityScore: { '1D': 6.7, '1W': -22.9, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 6, avgWeight: 4.78, proScore: 2.61, coverage: 0.545,
      ...
      velocityScore: { '1D': -1.5, '1W': 16, '1M': null, '6M': null }, isNew: false,
      marketCap: '$230B', pe: 90.9, revenueGrowth: 28, eps: 2.9, grossMargin: 52, dividendYield: 0.09,
      etfPresence: { AIS: 4.4, ARTY: 9.55, BAI: 1.71, IVEP: false, IGPT: false, IVES: false, ALAI: false, CHAT: 1.76, AIFD: 6.34, SPRX: 4.9, AOTG: false },
    ...
    {
      ticker: 'TSM', name: 'Taiwan Semiconductor Manufacturing Co Ltd', easyScore: 6, avgWeight: 4.76, proScore: 2.6, coverage: 0.545,
      ...
      etfPresence: { AIS: 3.27, ARTY: false, BAI: 4.41, IVEP: false, IGPT: false, IVES: 4.88, ALAI: 5.54, CHAT: false, AIFD: 3.25, SPRX: false, AOTG: 7.22 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 0.71, ARTY: 3.43, BAI: 4.85, IVEP: false, IGPT: false, IVES: 4.42, ALAI: 3.93, CHAT: 3.01, AIFD: 5.5, SPRX: false, AOTG: 1.57 },
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 5, avgWeight: 3.8, proScore: 1.73, coverage: 0.455,
      ...
      velocityScore: { '1D': 3, '1W': -33.5, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      etfPresence: { AIS: 1.74, ARTY: 1.63, BAI: false, IVEP: false, IGPT: false, IVES: false, ALAI: 1.59, CHAT: 3.71, AIFD: false, SPRX: 7.36, AOTG: false },
    ...
    },
    {
      ...
      etfPresence: { AIS: 3.75, ARTY: false, BAI: 1.97, IVEP: 3.98, IGPT: false, IVES: false, ALAI: false, CHAT: 0.85, AIFD: 4, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'ORCL', name: 'ORACLE CORP', easyScore: 4, avgWeight: 3.44, proScore: 1.25, coverage: 0.364,
      ...
      velocityScore: { '1D': -0.8, '1W': -38.7, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'LITE', name: 'LUMENTUM HOLDINGS INC', easyScore: 4, avgWeight: 3.43, proScore: 1.25, coverage: 0.364,
    ...
    {
      ticker: 'WDC', name: 'Western Digital Corp', easyScore: 6, avgWeight: 2.2, proScore: 1.2, coverage: 0.545,
      ...
      velocityScore: { '1D': -2.4, '1W': -38.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$176B', pe: 30.6, revenueGrowth: 46, eps: 16.73, grossMargin: 45, dividendYield: 0.12,
      etfPresence: { AIS: 1.52, ARTY: 2.7, BAI: 3, IVEP: false, IGPT: false, IVES: false, ALAI: 4.19, CHAT: 1.14, AIFD: false, SPRX: false, AOTG: 0.67 },
    ...
    },
    {
      ...
      velocityScore: { '1D': -1.8, '1W': -58.3, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': null, '1W': -47.7, '1M': null, '6M': null }, isNew: true,
  ...
  'Electrification': [
    ...
    },
    {
      ...
      velocityScore: { '1D': -7.6, '1W': -57.5, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      price: 145.35, weeklyPrices: [149.30, 154.65, 154.15, 150.60, 145.35], weeklyChange: -2.65, sortRank: 0, periodReturns: { '1M': 4.1, '6M': 71, '1Y': 149.4 },
      priceHistory: { '1W': [149.3, 154.65, 154.15, 150.6, 145.35], '1M': [139.6, 143.8, 143.65, 152.05, 148.8, 154.7, 156.35, 153.15, 147.95, 140.5, 149.3, 149.8, 153, 150.3, 146.5, 150.3, 148, 154.65, 154.15, 150.6, 145.35], '6M': [84.98, 82.64, 85.22, 89.88, 87.28, 93.6, 96.62, 99.22, 99.38, 101.75, 98.08, 100.15, 98.6, 101.2, 100.05, 98.42, 104.65, 119.8, 121.65, 127.4, 126.3, 152.05, 153.15, 149.8, 148, 145.35], '1Y': [58.28, 57.28, 55.7, 57.84, 59.98, 61.32, 64.18, 66.5, 70.38, 70.68, 73.92, 73.58, 76.48, 76, 79.24, 81.28, 81.38, 88, 89.82, 90.5, 88.62, 88.02, 85.62, 84.48, 84.28, 85.44, 82.6, 86.34, 81.92, 85.78, 91.42, 89.26, 94.08, 97.8, 100.7, 103.2, 101.5, 100, 102.2, 101.2, 100.05, 98.42, 104.65, 115.6, 121, 122.5, 127.95, 152.05, 153.15, 149.8, 148, 145.35] },
      velocityScore: { '1D': 0, '1W': -49.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$42B', pe: 31, revenueGrowth: 10, eps: 4.69, grossMargin: 38, dividendYield: 0.62,
    ...
    },
    {
      ...
      velocityScore: { '1D': 1, '1W': -45.6, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': 4.3, '1W': -48.9, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': 5.7, '1W': -48, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': null, '1W': -48.3, '1M': null, '6M': null }, isNew: true,
    ...
    },
    {
      ...
      velocityScore: { '1D': -5.6, '1W': -49.7, '1M': null, '6M': null }, isNew: false,
