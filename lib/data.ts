...
export const SCAN_TIMESTAMP    = '2026-05-24T13:34:25.227Z';
export const SCAN_TIMESTAMP_NY = 'May 24, 2026 at 9:34 AM ET';
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'AI & ML': [
    {
      ticker: 'NVDA', name: 'NVIDIA Corp', easyScore: 7, proScore: 5.76, coverage: 0.875,
      ...
      etfPresence: { AIS: 2.74, ARTY: 4.03, BAI: 5.42, IVEP: false, IGPT: 6.3, IVES: 4.61, ALAI: 13.58, CHAT: 6.44 },
    ...
    {
      ticker: 'MU', name: 'Micron Technology Inc', easyScore: 7, proScore: 5.29, coverage: 0.875,
      ...
      etfPresence: { AIS: 7, ARTY: 6.34, BAI: 4.27, IVEP: false, IGPT: 9.93, IVES: 5.97, ALAI: 1.02, CHAT: 5.09 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 4.54, ARTY: 7.18, BAI: 4.62, IVEP: false, IGPT: 7.13, IVES: 7.38, ALAI: 1.01, CHAT: 5.64 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 0.78, ARTY: 3.92, BAI: 5.36, IVEP: false, IGPT: false, IVES: 4.77, ALAI: 4.54, CHAT: 3.31 },
    ...
    },
    {
      ...
      etfPresence: { AIS: 3.25, ARTY: false, BAI: 4.31, IVEP: false, IGPT: false, IVES: 4.46, ALAI: 5.38, CHAT: false },
    ...
    },
    {
      ...
      etfPresence: { AIS: false, ARTY: 1.96, BAI: false, IVEP: false, IGPT: false, IVES: 4.03, ALAI: 5.48, CHAT: 3.16 },
    ...
    {
      ticker: 'WDC', name: 'Western Digital Corp', easyScore: 5, proScore: 1.91, coverage: 0.625,
      ...
      etfPresence: { AIS: 1.47, ARTY: 2.64, BAI: 2.68, IVEP: false, IGPT: false, IVES: false, ALAI: 4.21, CHAT: 1.11 },
