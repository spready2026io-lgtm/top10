...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'Broad Tech': [
    {
      ticker: 'TSLA', name: 'TSLA', easyScore: 3, avgWeight: 9.45, proScore: 5.18, coverage: 0.3,
