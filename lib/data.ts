...
export const ETF_TOP_HOLDINGS: Record<string, EtfHolding[]> = {
  ...
  SPRX: [{ t: 'ARM', w: 9.0 }, { t: 'COHR', w: 8.4 }, { t: 'ALAB', w: 8.0 }, { t: 'KLAC', w: 7.3 }, { t: 'NET', w: 6.5 }],
  ...
  WCLD: [{ t: 'DOCN', w: 4.0 }, { t: 'FROG', w: 3.1 }, { t: 'DDOG', w: 2.8 }, { t: 'PANW', w: 2.7 }, { t: 'CRWD', w: 2.5 }],
  ...
  FCUS: [{ t: 'WDC', w: 5.2 }, { t: 'SNDK', w: 5.0 }, { t: 'STX', w: 4.9 }, { t: 'INTC', w: 4.7 }, { t: 'DELL', w: 4.4 }],
  ...
  BUZZ: [{ t: 'MU', w: 4.1 }, { t: 'NBIS', w: 3.8 }, { t: 'AMD', w: 3.5 }, { t: 'SOFI', w: 3.3 }, { t: 'HOOD', w: 3.2 }],
...
const TOP10_RET: Record<Theme, Record<Period, number>> = {
  'AI & ML':         { '1W': 7.6, '1M': 17.6, '6M': 63.4, '1Y': 102.7 },
  'Semiconductors':  { '1W': 10.3, '1M': 32.1, '6M': 133.4, '1Y': 184.5 },
  'Broad Tech':      { '1W': 4.6, '1M': 10.1, '6M': 37.9, '1Y': 63.7 },
  'Electrification': { '1W': 4.5, '1M': 3.9, '6M': 37.2, '1Y': 63.5 },
  'Industrials':     { '1W': 1.1, '1M': 4.8, '6M': 29, '1Y': 46.5 },
  'Meme':            { '1W': 5.8, '1M': 11.8, '6M': 36, '1Y': 18.2 },
};
...
export const INDEX_CHART_DATA: Record<Theme, IndexChartByPeriod> = {
  'AI & ML': {
    ...
    '1W': { top10: [100, 102.32, 104.62, 103.1, 107.6], spy: [100, 101.76, 101.16, 99.89, 100.67], top10Return: 7.6, spyReturn: 0.7, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 99.27, 102.45, 104.91, 105.89, 109.91, 110.64, 111.94, 113.92, 117.14, 117.34, 115.52, 105.59, 108.96, 106.78, 105.61, 109.24, 111.81, 114.27, 112.62, 117.61], spy: [100, 99.33, 100.35, 100.55, 100.95, 101.6, 102.16, 102.41, 102.69, 102.83, 102.11, 102.5, 99.85, 100.08, 99.78, 99.88, 100.42, 102.19, 101.58, 100.31, 101.1], top10Return: 17.6, spyReturn: 1.1, xLabels: ["May 23", "May 30", "Jun 6", "Jun 13", "Jun 20"] },
    '6M': { top10: [100, 106.35, 106.85, 108.68, 108.83, 110.33, 109.41, 108.97, 106.98, 109.24, 104.87, 107.04, 107.96, 106.03, 97.69, 107.88, 118.57, 124.36, 125.22, 136.16, 142.55, 138.6, 153.25, 161.21, 146.48, 163.44], spy: [100, 102.05, 101.66, 102.76, 100.16, 102.81, 101.93, 102.31, 101.45, 102.47, 101.28, 99.98, 97.78, 96.56, 96.14, 99.93, 103.47, 105.14, 105.19, 108.48, 109.73, 109.58, 111.55, 111.92, 109.06, 110.39], top10Return: 63.4, spyReturn: 10.4, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
    '1Y': { top10: [100, 105.61, 105.66, 106.42, 109.93, 111.47, 109.73, 113.97, 114.66, 112.85, 114.19, 117.39, 123.73, 127.37, 125.04, 129.84, 127.62, 130.02, 134.28, 138.46, 131.28, 127.34, 119.82, 128.95, 132.35, 127.41, 128.56, 129.93, 134.31, 134.98, 132.72, 138.85, 131.5, 134.6, 133.02, 135.73, 131.65, 133.06, 132.39, 130.79, 126.5, 137.45, 148.28, 155.96, 157.03, 170.53, 178.7, 171.64, 189.97, 199.77, 181.64, 202.73], spy: [100, 103.47, 104.44, 105.14, 105.8, 107.18, 104.62, 107.22, 108.27, 108.59, 108.54, 109.18, 111.21, 112.21, 111.68, 113.01, 109.88, 111.8, 113.96, 114.77, 112.9, 113.07, 110.9, 114.47, 115.03, 114.55, 114.52, 115.75, 116.41, 116.74, 115.33, 117.02, 115.47, 116.44, 115.18, 115.99, 115.29, 113.81, 111.3, 110.52, 110.26, 114.41, 118.07, 119.21, 120.93, 123.1, 124.91, 124.73, 126.98, 127.4, 124.14, 125.65], top10Return: 102.7, spyReturn: 25.7, xLabels: ["Jun '25", "Sep '25", "Dec '25", "Mar '26", "Jun '26"] },
  },
  'Semiconductors': {
    ...
    '1W': { top10: [100, 104.77, 104.36, 102.55, 110.27], spy: [100, 101.76, 101.16, 99.89, 100.67], top10Return: 10.3, spyReturn: 0.7, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 100.43, 104.85, 107.4, 109.08, 117.13, 117.57, 118.01, 119.22, 120.83, 125.49, 122.15, 107.67, 114.13, 112.33, 114.74, 119.54, 125.48, 124.69, 122.8, 132.13], spy: [100, 99.33, 100.35, 100.55, 100.95, 101.6, 102.16, 102.41, 102.69, 102.83, 102.11, 102.5, 99.85, 100.08, 99.78, 99.88, 100.42, 102.19, 101.58, 100.31, 101.1], top10Return: 32.1, spyReturn: 1.1, xLabels: ["May 23", "May 30", "Jun 6", "Jun 13", "Jun 20"] },
    '6M': { top10: [100, 105.73, 110.49, 115.58, 118.82, 119.8, 122.88, 125.29, 126.12, 129.45, 125.97, 130.65, 134.63, 136.54, 127.79, 136.58, 152.04, 166.14, 171.69, 192.09, 201.29, 189.02, 202.83, 216.03, 205.13, 233.41], spy: [100, 102.05, 101.66, 102.76, 100.16, 102.81, 101.93, 102.31, 101.45, 102.47, 101.28, 99.98, 97.78, 96.56, 96.14, 99.93, 103.47, 105.14, 105.19, 108.48, 109.73, 109.58, 111.55, 111.92, 109.06, 110.39], top10Return: 133.4, spyReturn: 10.4, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
    '1Y': { top10: [100, 105.68, 106.36, 110.38, 112.07, 110.44, 109.48, 113.54, 114.47, 116.35, 116.55, 118.11, 121.32, 126.66, 126.73, 132.64, 126.59, 134.13, 137.35, 141.17, 138.41, 138.42, 133.97, 142.05, 153.27, 151.76, 148.42, 152.07, 160.07, 158.74, 159.72, 162.93, 160.38, 170.05, 168.34, 177.91, 170.39, 171.1, 170.6, 179.77, 175.75, 185.28, 186.28, 203.81, 210.1, 225.13, 242.7, 234.84, 262.08, 267.66, 251.38, 284.52], spy: [100, 103.47, 104.44, 105.14, 105.8, 107.18, 104.62, 107.22, 108.27, 108.59, 108.54, 109.18, 111.21, 112.21, 111.68, 113.01, 109.88, 111.8, 113.96, 114.77, 112.9, 113.07, 110.9, 114.47, 115.03, 114.55, 114.52, 115.75, 116.41, 116.74, 115.33, 117.02, 115.47, 116.44, 115.18, 115.99, 115.29, 113.81, 111.3, 110.52, 110.26, 114.41, 118.07, 119.21, 120.93, 123.1, 124.91, 124.73, 126.98, 127.4, 124.14, 125.65], top10Return: 184.5, spyReturn: 25.7, xLabels: ["Jun '25", "Sep '25", "Dec '25", "Mar '26", "Jun '26"] },
  },
  'Broad Tech': {
    ...
    '1W': { top10: [100, 101.93, 104.05, 102.36, 104.59], spy: [100, 101.76, 101.16, 99.89, 100.67], top10Return: 4.6, spyReturn: 0.7, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 99.28, 101.69, 103.47, 104.94, 108.32, 109.12, 110.03, 110.53, 112.59, 112.19, 111.87, 103.69, 105.81, 103.6, 102.44, 105.05, 107.09, 109.41, 107.64, 110.09], spy: [100, 99.33, 100.35, 100.55, 100.95, 101.6, 102.16, 102.41, 102.69, 102.83, 102.11, 102.5, 99.85, 100.08, 99.78, 99.88, 100.42, 102.19, 101.58, 100.31, 101.1], top10Return: 10.1, spyReturn: 1.1, xLabels: ["May 23", "May 30", "Jun 6", "Jun 13", "Jun 20"] },
    '6M': { top10: [100, 104.59, 104.37, 107.44, 107.46, 107.3, 104.28, 105.35, 103.71, 105.95, 104.69, 104.03, 103.68, 102.29, 96.98, 103.97, 112.79, 116.92, 116.64, 126.48, 129.32, 125.11, 133.62, 138.84, 127.33, 137.91], spy: [100, 102.05, 101.66, 102.76, 100.16, 102.81, 101.93, 102.31, 101.45, 102.47, 101.28, 99.98, 97.78, 96.56, 96.14, 99.93, 103.47, 105.14, 105.19, 108.48, 109.73, 109.58, 111.55, 111.92, 109.06, 110.39], top10Return: 37.9, spyReturn: 10.4, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
    '1Y': { top10: [100, 103.48, 106.11, 106.6, 108.51, 109.75, 105.66, 106.97, 108.08, 108.79, 110.53, 110.78, 116.71, 121.69, 120.16, 126.1, 126.36, 128.56, 132.09, 132.15, 128.52, 119.56, 114.3, 123.97, 124.04, 120.66, 120.83, 120.22, 125.51, 127.85, 126.56, 130.04, 124.82, 125.11, 125.85, 128.2, 126.75, 125.46, 125.66, 126.56, 123.37, 129.02, 135.3, 139.02, 137.71, 150.12, 150.68, 145.22, 157.69, 163.49, 151.07, 163.72], spy: [100, 103.47, 104.44, 105.14, 105.8, 107.18, 104.62, 107.22, 108.27, 108.59, 108.54, 109.18, 111.21, 112.21, 111.68, 113.01, 109.88, 111.8, 113.96, 114.77, 112.9, 113.07, 110.9, 114.47, 115.03, 114.55, 114.52, 115.75, 116.41, 116.74, 115.33, 117.02, 115.47, 116.44, 115.18, 115.99, 115.29, 113.81, 111.3, 110.52, 110.26, 114.41, 118.07, 119.21, 120.93, 123.1, 124.91, 124.73, 126.98, 127.4, 124.14, 125.65], top10Return: 63.7, spyReturn: 25.7, xLabels: ["Jun '25", "Sep '25", "Dec '25", "Mar '26", "Jun '26"] },
  },
  'Electrification': {
    ...
    '1W': { top10: [100, 100.95, 103.22, 102.15, 104.46], spy: [100, 101.76, 101.16, 99.89, 100.67], top10Return: 4.5, spyReturn: 0.7, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 97.94, 100.31, 103.13, 104.56, 107.76, 106.89, 107.01, 105.87, 105.53, 106.58, 106.49, 99.83, 99.95, 98.73, 95.53, 99.45, 100.4, 102.66, 101.6, 103.91], spy: [100, 99.33, 100.35, 100.55, 100.95, 101.6, 102.16, 102.41, 102.69, 102.83, 102.11, 102.5, 99.85, 100.08, 99.78, 99.88, 100.42, 102.19, 101.58, 100.31, 101.1], top10Return: 3.9, spyReturn: 1.1, xLabels: ["May 23", "May 30", "Jun 6", "Jun 13", "Jun 20"] },
    '6M': { top10: [100, 104.17, 105.78, 106.69, 111.64, 112.68, 112.65, 116.51, 117.69, 120.56, 115.51, 114.86, 117.01, 115.87, 111.33, 114.9, 124.89, 126.98, 129.85, 138.01, 138.55, 129.36, 140.15, 139.7, 127.61, 137.15], spy: [100, 102.05, 101.66, 102.76, 100.16, 102.81, 101.93, 102.31, 101.45, 102.47, 101.28, 99.98, 97.78, 96.56, 96.14, 99.93, 103.47, 105.14, 105.19, 108.48, 109.73, 109.58, 111.55, 111.92, 109.06, 110.39], top10Return: 37.2, spyReturn: 10.4, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
  ...
  'Industrials': {
    ...
    '1W': { top10: [100, 100.32, 100.55, 100.58, 101.13], spy: [100, 101.76, 101.16, 99.89, 100.67], top10Return: 1.1, spyReturn: 0.7, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 98.83, 100.73, 100.93, 101.85, 104.38, 104.38, 104.87, 104.19, 102.66, 103.75, 104.74, 101.82, 101.98, 102.09, 99.34, 103.55, 103.9, 104.17, 104.19, 104.8], spy: [100, 99.33, 100.35, 100.55, 100.95, 101.6, 102.16, 102.41, 102.69, 102.83, 102.11, 102.5, 99.85, 100.08, 99.78, 99.88, 100.42, 102.19, 101.58, 100.31, 101.1], top10Return: 4.8, spyReturn: 1.1, xLabels: ["May 23", "May 30", "Jun 6", "Jun 13", "Jun 20"] },
    '6M': { top10: [100, 104.64, 104.7, 109.23, 113.92, 112.94, 113.18, 119.1, 120.25, 122.55, 119.74, 116.67, 115.69, 114.03, 108.96, 115.92, 123.28, 122.06, 121.98, 126.58, 126.97, 121.14, 128.16, 127.55, 121.84, 129.05], spy: [100, 102.05, 101.66, 102.76, 100.16, 102.81, 101.93, 102.31, 101.45, 102.47, 101.28, 99.98, 97.78, 96.56, 96.14, 99.93, 103.47, 105.14, 105.19, 108.48, 109.73, 109.58, 111.55, 111.92, 109.06, 110.39], top10Return: 29, spyReturn: 10.4, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
  ...
  'Meme': {
    ...
    '1W': { top10: [100, 103.73, 102.74, 101.92, 105.83], spy: [100, 101.76, 101.16, 99.89, 100.67], top10Return: 5.8, spyReturn: 0.7, xLabels: ["Mon", "Tue", "Wed", "Thu", "Fri"] },
    '1M': { top10: [100, 98.45, 102.26, 108.47, 111.06, 116.12, 118.26, 117.65, 116.58, 118.86, 115.91, 116.55, 104.59, 107.27, 103.43, 104.71, 105.6, 109.48, 108.57, 107.66, 111.83], spy: [100, 99.33, 100.35, 100.55, 100.95, 101.6, 102.16, 102.41, 102.69, 102.83, 102.11, 102.5, 99.85, 100.08, 99.78, 99.88, 100.42, 102.19, 101.58, 100.31, 101.1], top10Return: 11.8, spyReturn: 1.1, xLabels: ["May 23", "May 30", "Jun 6", "Jun 13", "Jun 20"] },
    '6M': { top10: [100, 103.04, 105.79, 109.89, 107.4, 106.67, 103.06, 98.55, 95.93, 98.13, 95.89, 94.51, 94.59, 96.07, 93.99, 100.98, 114.16, 118.13, 111.88, 128, 128.26, 129.11, 145.88, 138.69, 130.95, 135.97], spy: [100, 102.05, 101.66, 102.76, 100.16, 102.81, 101.93, 102.31, 101.45, 102.47, 101.28, 99.98, 97.78, 96.56, 96.14, 99.93, 103.47, 105.14, 105.19, 108.48, 109.73, 109.58, 111.55, 111.92, 109.06, 110.39], top10Return: 36, spyReturn: 10.4, xLabels: ["Dec", "Jan", "Feb", "Mar", "Apr", "May", "Jun"] },
    '1Y': { top10: [100, 103.29, 101.27, 96.72, 97.46, 93, 93.14, 90.26, 86.99, 84.67, 85.51, 86.84, 91.22, 92.31, 89.25, 92.05, 91.04, 90.4, 95.86, 97.38, 92.7, 91.39, 86.52, 84.59, 85.97, 86.94, 87.03, 88.07, 92.23, 92.64, 91.76, 93.8, 91.92, 91.67, 88.41, 90.33, 93.77, 95.59, 102.01, 100.58, 95.95, 95.49, 106.52, 112.18, 112.95, 113, 120.44, 115.98, 119.4, 114.51, 116.55, 118.26], spy: [100, 103.47, 104.44, 105.14, 105.8, 107.18, 104.62, 107.22, 108.27, 108.59, 108.54, 109.18, 111.21, 112.21, 111.68, 113.01, 109.88, 111.8, 113.96, 114.77, 112.9, 113.07, 110.9, 114.47, 115.03, 114.55, 114.52, 115.75, 116.41, 116.74, 115.33, 117.02, 115.47, 116.44, 115.18, 115.99, 115.29, 113.81, 111.3, 110.52, 110.26, 114.41, 118.07, 119.21, 120.93, 123.1, 124.91, 124.73, 126.98, 127.4, 124.14, 125.65], top10Return: 18.2, spyReturn: 25.7, xLabels: ["Jun '25", "Sep '25", "Dec '25", "Mar '26", "Jun '26"] },
  },
};
...
export const SCAN_TIMESTAMP    = '2026-06-20T13:36:32.871Z';
export const SCAN_TIMESTAMP_NY = 'June 20, 2026 at 9:36 AM ET';
...
export const HOLDINGS_COUNT = 1187;
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 13.95, bestProScore: 6.18, avgProScore: 4.65, price: 1133.99, weeklyChange: 15.52 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.52, bestProScore: 6.02, avgProScore: 3.84, price: 210.69, weeklyChange: 2.68 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 10.38, bestProScore: 4.80, avgProScore: 3.46, price: 537.37, weeklyChange: 5.04 },
  { ticker: 'AVGO', name: `Broadcom Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 6.22, bestProScore: 2.93, avgProScore: 2.07, price: 411.35, weeklyChange: 7.66 },
  ...
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 4.92, bestProScore: 2.59, avgProScore: 2.46, price: 310.58, weeklyChange: 11.04 },
  { ticker: 'TSM', name: `Taiwan Semiconductor Manufacturing Co Ltd ADR`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 4.79, bestProScore: 2.95, avgProScore: 2.40, price: 462.12, weeklyChange: 9.01 },
  { ticker: 'POWL', name: `Powell Industries, Inc.`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 4.79, bestProScore: 2.77, avgProScore: 2.40, price: 297.20, weeklyChange: 2.31 },
  { ticker: 'LRCX', name: `LAM RESEARCH CORP`, themeCount: 2, themes: ['Semiconductors', 'Broad Tech'], aggregateScore: 3.89, bestProScore: 2.47, avgProScore: 1.95, price: 389.04, weeklyChange: 6.06 },
  { ticker: 'WDC', name: `Western Digital Corp`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 3.44, bestProScore: 1.82, avgProScore: 1.72, price: 746.23, weeklyChange: 32.56 },
];
...
export const THEME_REPRESENTATIVES: Partial<Record<Theme, ThemeRep>> = {
  'AI & ML': { etfs: ['AIS', 'ARTY'], series: { '1W': [100, 103.44, 104.18, 103.78, 110.12], '1M': [100, 99.22, 103.42, 106.25, 107.69, 113.25, 114.01, 114.72, 117.73, 122.92, 124.9, 121.88, 108.68, 113.65, 111.28, 111.21, 114.69, 118.68, 119.42, 119.03, 126.31], '6M': [100, 105.61, 109.03, 111.4, 113.42, 116.77, 116.54, 116.56, 116.29, 120.72, 113.86, 115.55, 116.78, 114.58, 106.22, 119.02, 132.24, 142.81, 145.69, 162.69, 171.22, 164.12, 184.66, 198.38, 180.38, 204.55], '1Y': [100, 105.88, 105.59, 106.72, 109.82, 111.73, 110, 111.74, 113.05, 111.65, 113.31, 115.12, 121.9, 126.06, 124.94, 131.58, 128.97, 133.41, 138.65, 142.62, 135, 132.13, 122.88, 131.51, 136.88, 131.03, 131.92, 135.59, 143.39, 143.66, 146.54, 153.63, 144.5, 151.85, 150.34, 155.59, 148.42, 149.95, 149.6, 148.18, 142.69, 157.76, 172.5, 186.45, 192.41, 209.2, 222.84, 212.61, 239.34, 256.45, 233.95, 265.09] }, returns: { '1W': 10.1, '1M': 26.3, '6M': 104.6, '1Y': 165.1 } },
  'Semiconductors': { etfs: ['PSI', 'DRAM'], series: { '1W': [100, 106.16, 106.25, 104.94, 113.67], '1M': [100, 100.48, 104.38, 107.81, 107.33, 118.1, 119.44, 119.5, 123.28, 124.27, 127.97, 123.09, 107.29, 114.7, 113.83, 118.06, 122.92, 130.78, 130.48, 129.24, 140.11], '6M': [100, 106.44, 113.09, 119.16, 123.24, 123.82, 130.18, 132.77, 133.57, 138.75, 139.53, 149.87, 158.38, 162.22, 150.54, 155.42, 173.28, 189.71, 195.57, 214.78, 224.32, 203.53, 209.13, 225.34, 221.03, 255.95], '1Y': [100, 105.87, 106.87, 113, 113.69, 111.94, 112.69, 117.84, 116.3, 118.82, 120.02, 120.91, 123.31, 128.14, 128.59, 133.69, 128.14, 134, 138.28, 142.13, 144.54, 149.28, 148.84, 152.36, 167.06, 170.16, 163.26, 169.64, 175.17, 171.81, 170.27, 173.37, 176.3, 186.29, 184, 202.16, 195.53, 197.22, 198.75, 214.3, 209.53, 212.88, 201.87, 219.41, 222.47, 231.99, 252.53, 244.36, 270.45, 268.42, 258.38, 296.74] }, returns: { '1W': 13.7, '1M': 40.1, '6M': 155.9, '1Y': 196.7 } },
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'AI & ML': [
    {
      ...
      velocityScore: { '1D': 0.3, '1W': -4.6, '1M': 3.8, '6M': null }, isNew: false,
      marketCap: '$5.1T', pe: 32.3, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.47,
      etfPresence: { AIS: 2.38, ARTY: 4.41, BAI: 4.02, IGPT: 5.34, IVES: 4.75, ALAI: 12.65, CHAT: 6.39, AIFD: 6.37, SPRX: 3.38, AOTG: 10.53 },
    ...
    },
    {
      ...
      velocityScore: { '1D': 0, '1W': 1.1, '1M': 16.6, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': -3.6, '1W': -2.4, '1M': -4.2, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': 6.9, '1W': 2.8, '1M': -10.4, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      etfPresence: { AIS: 1.38, ARTY: 2.33, BAI: 1.35, IGPT: false, IVES: false, ALAI: 0.96, CHAT: 2.12, AIFD: 4.93, SPRX: 1.6, AOTG: false },
    ...
    },
    {
      ...
      velocityScore: { '1D': 3.9, '1W': 1.7, '1M': -4.2, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': -3.2, '1W': -5.2, '1M': -28.3, '6M': null }, isNew: false,
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 6, avgWeight: 3.88, proScore: 2.33, coverage: 0.6,
      ...
      velocityScore: { '1D': -14.7, '1W': -17.7, '1M': 0.9, '6M': null }, isNew: false,
      marketCap: '$272B', pe: 106.4, revenueGrowth: 28, eps: 2.92, grossMargin: 52, dividendYield: 0.08,
      etfPresence: { AIS: 4.25, ARTY: 4.54, BAI: 2.05, IGPT: false, IVES: false, ALAI: false, CHAT: 1.6, AIFD: 6.54, SPRX: 4.32, AOTG: false },
    ...
    },
    {
      ...
      velocityScore: { '1D': -1.6, '1W': 58.3, '1M': -5.2, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': -0.6, '1W': -5.6, '1M': -35.1, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': -1.3, '1W': -2.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$71B', pe: 285.7, revenueGrowth: 93, eps: 1.46, grossMargin: 76, dividendYield: null,
      etfPresence: { AIS: 2.02, ARTY: 1.31, BAI: false, IGPT: false, IVES: false, ALAI: 1.41, CHAT: 2.77, AIFD: false, SPRX: 7.95, AOTG: false },
    ...
    {
      ticker: 'LITE', name: 'LUMENTUM HOLDINGS INC', easyScore: 5, avgWeight: 2.64, proScore: 1.32, coverage: 0.5,
      ...
      etfPresence: { AIS: false, ARTY: false, BAI: 2.45, IGPT: false, IVES: false, ALAI: 0.38, CHAT: 1.32, AIFD: 5.62, SPRX: 3.45, AOTG: false },
    ...
    {
      ticker: 'CRDO', name: 'Credo Technology Group Holding Ltd', easyScore: 5, avgWeight: 1.91, proScore: 0.96, coverage: 0.5,
      ...
      velocityScore: { '1D': 5.5, '1W': -4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$51B', pe: 108.7, revenueGrowth: 157, eps: 2.5, grossMargin: 68, dividendYield: null,
      etfPresence: { AIS: 1.07, ARTY: 1.24, BAI: 2.09, IGPT: false, IVES: false, ALAI: false, CHAT: 2.23, AIFD: false, SPRX: 2.93, AOTG: false },
    ...
    },
    {
      ...
      velocityScore: { '1D': -22.6, '1W': -24.9, '1M': -49.2, '6M': null }, isNew: false,
    ...
    {
      ticker: 'ARM', name: 'ARM Holdings PLC', easyScore: 4, avgWeight: 3.73, proScore: 1.49, coverage: 0.4,
      ...
      etfPresence: { AIS: 2.27, ARTY: false, BAI: false, IGPT: false, IVES: false, ALAI: 0.55, CHAT: 3.12, AIFD: false, SPRX: 8.97, AOTG: false },
    ...
    },
    {
      ...
      velocityScore: { '1D': 3.5, '1W': 3.5, '1M': -40.5, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': -0.9, '1W': -6.5, '1M': -38.8, '6M': null }, isNew: false,
  ...
  'Semiconductors': [
    ...
    },
    {
      ...
      marketCap: '$339B', pe: 73.3, revenueGrowth: 12, eps: 3.54, grossMargin: 61, dividendYield: 0.35,
  ...
  'Broad Tech': [
    {
      ticker: 'NVDA', name: 'NVIDIA Corp', easyScore: 7, avgWeight: 4.03, proScore: 2.17, coverage: 0.538,
      price: 210.69, weeklyPrices: [205.19, 212.45, 207.41, 204.65, 210.69], weeklyChange: 2.68, dayChange: 2.95, sortRank: 0, periodReturns: { '1M': -5.2, '6M': 21, '1Y': 46.5 },
      priceHistory: { '1D': [204.65, 207.14, 207.72, 208.93, 209.35, 209.32, 209.27, 208.88, 208.19, 209.27, 209.53, 210.97, 210.13, 209.96, 210.06, 210.04, 209.66, 209.85, 210.1, 209.78, 210.06, 209.85, 210.15, 210.69], '1W': [205.19, 212.45, 207.41, 204.65, 210.69], '1M': [222.32, 220.61, 223.47, 219.51, 215.33, 212.6, 214.25, 211.14, 224.36, 222.82, 214.75, 218.66, 205.1, 208.64, 208.19, 204.87, 205.19, 212.45, 207.41, 204.65, 210.69], '6M': [174.14, 190.53, 188.12, 184.94, 178.07, 188.52, 180.34, 188.54, 187.98, 195.56, 183.04, 186.03, 180.4, 175.2, 174.4, 182.08, 198.87, 202.5, 209.25, 207.83, 225.83, 223.47, 214.25, 218.66, 204.87, 210.69], '1Y': [143.85, 157.75, 158.24, 164.07, 171.38, 176.75, 173.72, 182.7, 180.45, 177.99, 174.18, 168.31, 177.75, 183.61, 181.85, 185.54, 183.16, 183.22, 186.26, 202.49, 188.15, 190.17, 178.88, 179.92, 185.55, 176.29, 180.99, 188.22, 187.24, 185.81, 183.32, 191.52, 174.19, 190.05, 187.9, 184.89, 183.04, 186.03, 180.4, 178.68, 175.75, 183.91, 198.35, 199.64, 199.57, 211.5, 225.83, 223.47, 214.25, 218.66, 204.87, 210.69] },
      velocityScore: { '1D': -0.9, '1W': -5.7, '1M': -55.1, '6M': null }, isNew: false,
      marketCap: '$5.1T', pe: 32.3, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.47,
      etfPresence: { PTF: 4.15, WCLD: false, IGV: false, FDTX: 4.62, GTEK: false, ARKK: 1.65, MARS: false, FRWD: 8.21, BCTK: 5.73, FWD: 1.9, CBSE: false, FCUS: false, WGMI: 1.94 },
      tonyNote: 'NVIDIA sits at 88% AI ETF coverage with a 5.6% average weight — the broadest institutional consensus in the theme. At a $5.1T market cap and 74% gross margin, the business is printing cash, but the 1-year return of 56% signals the easy money has been made. The score reflects the depth of institutional commitment, not a fresh entry signal.',
    },
    {
      ticker: 'MU', name: 'Micron Technology Inc', easyScore: 6, avgWeight: 5.12, proScore: 2.36, coverage: 0.462,
      price: 1133.99, weeklyPrices: [981.61, 1087.99, 1020.76, 1043.19, 1133.99], weeklyChange: 15.52, dayChange: 8.7, sortRank: 0, periodReturns: { '1M': 66.4, '6M': 356.2, '1Y': 817.5 },
      priceHistory: { '1D': [1043.19, 1099, 1106.11, 1118.26, 1121.66, 1124.56, 1128.4, 1126.12, 1122.69, 1126.87, 1127.72, 1125.45, 1127.32, 1129.46, 1134.23, 1134.65, 1138.57, 1141.99, 1142.73, 1144.29, 1139.82, 1142.21, 1147.02, 1133.99], '1W': [981.61, 1087.99, 1020.76, 1043.19, 1133.99], '1M': [681.54, 698.74, 731.99, 762.1, 751, 928.41, 923.52, 971, 1035.5, 1064.1, 1079.57, 996, 864.01, 949.28, 935.89, 995.87, 981.61, 1087.99, 1020.76, 1043.19, 1133.99], '6M': [248.55, 284.79, 312.15, 345.87, 365, 410.24, 419.44, 373.25, 420.95, 429, 400.77, 418.69, 461.73, 395.53, 337.84, 406.73, 456.23, 487.48, 518.46, 666.59, 803.63, 731.99, 923.52, 996, 995.87, 1133.99], '1Y': [123.6, 124.76, 119.92, 118.61, 113.23, 111.25, 104.88, 118.89, 120.87, 117.68, 119.01, 131.46, 157.77, 164.62, 163.9, 190.96, 181.6, 202.38, 219.02, 223.77, 237.92, 246.83, 207.37, 240.46, 246.92, 237.5, 265.92, 294.37, 343.43, 338.13, 389.11, 435.28, 379.4, 410.34, 417.35, 415.56, 400.77, 418.69, 461.73, 382.09, 367.85, 421.51, 457.23, 481.72, 517.16, 646.63, 803.63, 731.99, 923.52, 996, 995.87, 1133.99] },
      velocityScore: { '1D': 1.3, '1W': 6.8, '1M': -9.2, '6M': null }, isNew: false,
      marketCap: '$1.3T', pe: 53.5, revenueGrowth: 196, eps: 21.21, grossMargin: 58, dividendYield: 0.05,
      etfPresence: { PTF: 5.24, WCLD: false, IGV: false, FDTX: 9.36, GTEK: false, ARKK: false, MARS: false, FRWD: 4.78, BCTK: 4.57, FWD: false, CBSE: 2.45, FCUS: 4.3, WGMI: false },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
      ticker: 'TSM', name: 'Taiwan Semiconductor Manufacturing Co Ltd ADR', easyScore: 6, avgWeight: 3.99, proScore: 1.84, coverage: 0.462,
      price: 462.12, weeklyPrices: [423.93, 441.40, 425.83, 432.15, 462.12], weeklyChange: 9.01, dayChange: 6.94, sortRank: 0, periodReturns: { '1M': 16.7, '6M': 62.3, '1Y': 120.6 },
      priceHistory: { '1D': [432.15, 446.99, 449.93, 449.07, 450.65, 453.1, 452.18, 451.31, 451.53, 453.84, 454.19, 455.15, 454.76, 457.22, 457.76, 459.14, 459.3, 460.47, 460.26, 460.73, 460.8, 460.2, 462.84, 462.12], '1W': [423.93, 441.4, 425.83, 432.15, 462.12], '1M': [395.95, 392.61, 401.62, 407.15, 404.52, 422.73, 424.86, 418.45, 435.63, 446.69, 436.69, 444.92, 415.17, 426.8, 427.92, 421.07, 423.93, 441.4, 425.83, 432.15, 462.12], '6M': [284.68, 302.84, 322.25, 331.77, 327.16, 338.34, 335.75, 361.91, 362.26, 387.73, 357.44, 354.56, 339.57, 343.25, 337.95, 365.9, 375.1, 387.44, 393.83, 419.5, 399.8, 401.62, 424.86, 444.92, 421.07, 462.12], '1Y': [209.51, 228.57, 229.17, 228.67, 238.85, 242.75, 235.21, 241.83, 238.88, 232.99, 230.87, 247.19, 261.38, 272.63, 273.23, 302.4, 280.66, 295.08, 294.96, 300.43, 286.5, 284.82, 275.06, 287.68, 301.87, 287.74, 288.95, 300.92, 327.43, 331.21, 326.12, 342.3, 325.74, 374.09, 360.39, 376.81, 357.44, 354.56, 339.57, 347.75, 341.49, 365.49, 363.35, 382.66, 396.06, 414.15, 399.8, 401.62, 424.86, 444.92, 421.07, 462.12] },
      velocityScore: { '1D': 1.1, '1W': -3.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.4T', pe: 39.7, revenueGrowth: 35, eps: 11.65, grossMargin: 62, dividendYield: 0.82,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 6, GTEK: false, ARKK: 0.94, MARS: false, FRWD: 5.71, BCTK: 8.07, FWD: false, CBSE: 2.64, FCUS: false, WGMI: 0.6 },
      tonyNote: 'TSMC is the essential picks-and-shovels play in AI hardware, held by 4 AI ETFs at 4.23% average weight. Revenue up 35%, gross margin 62%, P/E 36x — the cleanest risk-adjusted fundamental profile in the semiconductor space. Geopolitical risk is the discount the market applies; the ETF weights say institutional managers are accepting it.',
    },
    {
      ticker: 'SPCX', name: 'SPACE EXPLORATION TECHN-CL A', easyScore: 5, avgWeight: 8.79, proScore: 3.38, coverage: 0.385,
      price: 185, weeklyPrices: [185.00], weeklyChange: -3.56, dayChange: -3.56, sortRank: 0, periodReturns: { '1M': 0, '6M': 0, '1Y': 0 },
      priceHistory: undefined,
      velocityScore: { '1D': 11.2, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.4T', pe: null, revenueGrowth: 15, eps: -0.67, grossMargin: 49, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: false, GTEK: false, ARKK: 4.71, MARS: 24.06, FRWD: 2.84, BCTK: 10.26, FWD: 2.09, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'SPACE EXPLORATION TECHN-CL A appears in 5 of 13 Broad Tech ETFs (38% coverage) with average weight 8.8% — selective across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'AMD', name: 'ADVANCED MICRO DEVICES', easyScore: 5, avgWeight: 4.01, proScore: 1.54, coverage: 0.385,
      price: 537.37, weeklyPrices: [511.57, 547.26, 507.29, 512.48, 537.37], weeklyChange: 5.04, dayChange: 4.86, sortRank: 0, periodReturns: { '1M': 27.6, '6M': 167.3, '1Y': 319 },
      priceHistory: { '1D': [512.48, 530.56, 531.21, 533.45, 530.77, 531.82, 537.11, 531.59, 528.43, 534.62, 533.55, 533.53, 533.4, 534.02, 533.83, 534.64, 532.61, 532.99, 530.67, 531.39, 531.3, 531.07, 534.21, 537.37], '1W': [511.57, 547.26, 507.29, 512.48, 537.37], '1M': [420.99, 414.05, 447.58, 449.59, 467.51, 495.54, 518.09, 516.1, 510.13, 521.54, 542.52, 523.2, 466.38, 490.33, 475.51, 488.45, 511.57, 547.26, 507.29, 512.48, 537.37], '6M': [201.06, 214.99, 221.08, 207.69, 231.92, 252.03, 242.11, 213.57, 200.12, 210.86, 202.07, 204.83, 199.46, 205.37, 203.43, 231.82, 258.12, 303.46, 337.11, 421.39, 445.5, 447.58, 518.09, 523.2, 488.45, 537.37], '1Y': [128.24, 143.81, 134.8, 146.24, 157, 173.66, 171.7, 172.76, 177.51, 167.76, 162.63, 151.41, 161.16, 159.79, 161.36, 203.71, 214.9, 233.08, 252.92, 256.12, 233.54, 246.81, 203.78, 219.76, 221.11, 207.58, 213.43, 215.61, 214.35, 220.97, 249.8, 252.74, 200.19, 213.58, 203.37, 203.68, 202.07, 204.83, 199.46, 220.27, 210.21, 236.64, 278.26, 305.33, 354.49, 408.46, 445.5, 447.58, 518.09, 523.2, 488.45, 537.37] },
      velocityScore: { '1D': -1.9, '1W': -3.7, '1M': -52.9, '6M': null }, isNew: false,
      marketCap: '$876B', pe: 178.5, revenueGrowth: 38, eps: 3.01, grossMargin: 53, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: false, GTEK: false, ARKK: 4.51, MARS: false, FRWD: 6.94, BCTK: 3.25, FWD: 2.07, CBSE: false, FCUS: 3.26, WGMI: false },
      tonyNote: 'AMD scores highest in Semiconductors at 7.0% average weight, held by 3 of 4 chip ETFs. Revenue grew 38% with 53% gross margins and EPS of $2.99 — improving but still stretched at a P/E of 172x. The 1-year return of 366% compresses future upside; the weight score says ETF managers are committed, but valuation is the variable to watch.',
    },
    {
      ticker: 'AVGO', name: 'Broadcom Inc', easyScore: 5, avgWeight: 3.11, proScore: 1.2, coverage: 0.385,
      price: 411.35, weeklyPrices: [382.07, 393.94, 376.71, 392.90, 411.35], weeklyChange: 7.66, dayChange: 4.7, sortRank: 0, periodReturns: { '1M': -2.2, '6M': 24.7, '1Y': 64.5 },
      priceHistory: { '1D': [392.9, 406.62, 406.12, 409.5, 408.61, 409.05, 410.11, 408.8, 406.88, 408.85, 409.38, 408.3, 408.43, 407.4, 407.29, 408.02, 407.77, 407.36, 407.45, 408.21, 408.06, 409.2, 410.79, 411.35], '1W': [382.07, 393.94, 376.71, 392.9, 411.35], '1M': [420.71, 411.07, 417.76, 414.57, 414.14, 421.86, 426.58, 446.77, 459.97, 481.57, 479.23, 418.91, 385.73, 396.6, 392.16, 385.57, 382.07, 393.94, 376.71, 392.9, 411.35], '6M': [329.88, 352.13, 343.42, 352.21, 332.6, 332.79, 320.33, 340.44, 333.51, 332.31, 317.53, 341.57, 315.93, 318.29, 309.51, 350.63, 396.72, 422.65, 405.45, 425.44, 416.79, 417.76, 426.58, 418.91, 385.57, 411.35], '1Y': [249.99, 269.35, 274.18, 275.6, 288.21, 294.3, 288.64, 304.97, 306.34, 294, 297.39, 345.65, 364.09, 338.79, 327.9, 335.49, 324.63, 349.33, 354.13, 369.63, 349.43, 342.46, 340.2, 386.08, 401.1, 339.81, 340.36, 349.39, 343.77, 354.61, 328.8, 333.24, 308.05, 342.76, 333.99, 321.7, 317.53, 341.57, 315.93, 318.81, 313.49, 354.91, 398.47, 419.94, 417.43, 412.56, 416.79, 417.76, 426.58, 418.91, 385.57, 411.35] },
      velocityScore: { '1D': 1.7, '1W': -4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.0T', pe: 68.4, revenueGrowth: 48, eps: 6.01, grossMargin: 76, dividendYield: 0.63,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 0.79, GTEK: false, ARKK: 1.14, MARS: false, FRWD: 5.02, BCTK: 6.69, FWD: 1.92, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'Broadcom appears in 6 of 8 AI ETFs and 3 of 4 Semiconductor ETFs, making it one of the most consistent cross-theme holdings. Revenue grew 30%, gross margin is 77% — the highest in the theme — and it pays a 0.58% dividend. The 87x P/E is the only friction; ETF managers are paying a premium for a recurring-revenue AI infrastructure name.',
    },
    {
      ticker: 'AMZN', name: 'Amazon.com Inc', easyScore: 5, avgWeight: 2.95, proScore: 1.13, coverage: 0.385,
      price: 244.39, weeklyPrices: [238.55, 246.02, 246.00, 237.50, 244.39], weeklyChange: 2.45, dayChange: 2.9, sortRank: 0, periodReturns: { '1M': -7.7, '6M': 7.8, '1Y': 16.5 },
      priceHistory: { '1D': [237.5, 236.45, 238.85, 240.18, 240.06, 239.82, 241.42, 242.35, 242.47, 243.12, 242.57, 244.03, 243.53, 244.56, 245.29, 244.55, 243.72, 242.91, 242.91, 243.15, 242.78, 243.07, 242.78, 244.39], '1W': [238.55, 246.02, 246, 237.5, 244.39], '1M': [264.86, 259.34, 265.01, 268.46, 266.32, 271.85, 274, 270.64, 261.26, 256.52, 250.02, 253.79, 246.03, 245.22, 244.19, 241.51, 238.55, 246.02, 246, 237.5, 244.39], '6M': [226.76, 232.52, 233.06, 246.47, 231, 244.68, 238.62, 206.96, 204.79, 210.64, 216.82, 212.65, 209.87, 207.24, 208.27, 221.25, 248.5, 255.36, 263.04, 274.99, 270.13, 265.01, 274, 253.79, 241.51, 244.39], '1Y': [209.69, 223.3, 223.47, 225.69, 229.3, 232.79, 214.75, 222.69, 231.03, 228.84, 229, 235.84, 231.43, 227.63, 222.17, 220.9, 216.37, 213.04, 224.21, 244.22, 244.41, 234.69, 220.69, 233.88, 226.89, 222.54, 227.35, 232.07, 240.93, 242.6, 231.31, 243.01, 232.99, 204.08, 204.86, 207.92, 216.82, 212.65, 209.87, 211.71, 210.57, 233.65, 249.7, 255.08, 265.06, 271.17, 270.13, 265.01, 274, 253.79, 241.51, 244.39] },
      velocityScore: { '1D': -1.7, '1W': 0.9, '1M': -76, '6M': null }, isNew: false,
      marketCap: '$2.6T', pe: 31.7, revenueGrowth: 17, eps: 7.72, grossMargin: 51, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 4.01, GTEK: false, ARKK: 2.24, MARS: false, FRWD: 2.79, BCTK: 4.24, FWD: 1.45, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'Amazon is a selective AI holding — 3 of 8 ETFs, 4.7% average weight — positioned on AWS rather than hardware. Revenue growth of 17% looks modest against pure-play AI names, but 51% gross margin and a $2.9T market cap reflect the cloud platform advantage. The 32% 1-year return underperforms the theme; ETF managers hold it as a diversifier, not a conviction AI bet.',
    },
    {
      ticker: 'CRWD', name: 'CrowdStrike', easyScore: 5, avgWeight: 2.52, proScore: 0.97, coverage: 0.385,
      ...
      velocityScore: { '1D': 26, '1W': 24.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$174B', pe: null, revenueGrowth: 26, eps: -0.14, grossMargin: 75, dividendYield: null,
      etfPresence: { PTF: false, WCLD: 2.53, IGV: 6.63, FDTX: 1.24, GTEK: false, ARKK: false, MARS: false, FRWD: false, BCTK: 1.16, FWD: 1.04, CBSE: false, FCUS: false, WGMI: false },
    ...
    {
      ticker: 'STX', name: 'Seagate Technology Holdings PLC', easyScore: 4, avgWeight: 5.77, proScore: 1.78, coverage: 0.308,
      ...
      velocityScore: { '1D': 4.1, '1W': 9.2, '1M': -34.8, '6M': null }, isNew: false,
      marketCap: '$240B', pe: 102, revenueGrowth: 44, eps: 10.49, grossMargin: 42, dividendYield: 0.28,
      etfPresence: { PTF: 5.33, WCLD: false, IGV: false, FDTX: 4.04, GTEK: false, ARKK: false, MARS: false, FRWD: 8.82, BCTK: false, FWD: false, CBSE: false, FCUS: 4.9, WGMI: false },
    ...
    {
      ticker: 'WDC', name: 'Western Digital Corp', easyScore: 4, avgWeight: 5.28, proScore: 1.62, coverage: 0.308,
      price: 746.23, weeklyPrices: [562.93, 653.53, 681.08, 712.13, 746.23], weeklyChange: 32.56, dayChange: 4.79, sortRank: 0, periodReturns: { '1M': 62.7, '6M': 326.4, '1Y': 1158.6 },
      priceHistory: { '1D': [712.13, 790.36, 786.06, 783.76, 773.56, 770.57, 772.01, 774.04, 769.58, 762.15, 758.33, 753.26, 743.76, 751.17, 746.33, 744.85, 743.34, 741.61, 746.88, 745.57, 745.06, 751.68, 757, 746.23], '1W': [562.93, 653.53, 681.08, 712.13, 746.23], '1M': [458.68, 455.8, 459.62, 486.46, 484.28, 530.6, 531.18, 531.21, 546.2, 563.1, 594.11, 575.5, 511.72, 526.93, 517.72, 529.29, 562.93, 653.53, 681.08, 712.13, 746.23], '6M': [175.01, 181.54, 187.88, 212.14, 222.97, 252.66, 290.24, 262.56, 296.56, 290.95, 261.3, 268.81, 304.9, 301.05, 270.49, 338.78, 365, 389.1, 412.76, 483.15, 494.09, 459.62, 531.18, 575.5, 529.29, 746.23], '1Y': [59.29, 63.29, 65.22, 66.93, 68.74, 68.99, 76.55, 74.97, 75.06, 76.97, 80.34, 93.29, 102.39, 112.41, 116.74, 125.28, 115.42, 126.2, 129.43, 150.21, 162.96, 157.83, 139.19, 163.54, 169.78, 172.04, 181.08, 179.68, 219.38, 214, 241.9, 279.7, 269.41, 273.74, 284.67, 282.25, 261.3, 268.81, 304.9, 296.14, 297.73, 337.88, 361.69, 403.12, 434.52, 463.91, 494.09, 459.62, 531.18, 575.5, 529.29, 746.23] },
      velocityScore: { '1D': 7.3, '1W': 20, '1M': null, '6M': null }, isNew: false,
      marketCap: '$257B', pe: 44.6, revenueGrowth: 46, eps: 16.72, grossMargin: 45, dividendYield: 0.08,
      etfPresence: { PTF: 6.1, WCLD: false, IGV: false, FDTX: 4, GTEK: false, ARKK: false, MARS: false, FRWD: 5.82, BCTK: false, FWD: false, CBSE: false, FCUS: 5.18, WGMI: false },
      tonyNote: 'Western Digital holds a 2.47% average weight across 5 AI ETFs — the broadest coverage of any storage name in the theme. Revenue up 46%, 45% gross margin, P/E of 32x. The 931% 1-year return is driven by HDD demand for AI training data storage, a durable structural demand shift. The weight score is climbing as ETF managers increase allocation following the NAND market recovery.',
    },
    {
      ticker: 'LRCX', name: 'LRCX', easyScore: 4, avgWeight: 4.61, proScore: 1.42, coverage: 0.308,
      price: 389.04, weeklyPrices: [366.81, 388.92, 369.34, 374.18, 389.04], weeklyChange: 6.06, dayChange: 3.97, sortRank: 0, periodReturns: { '1M': 40, '6M': 136.2, '1Y': 329.9 },
      priceHistory: { '1D': [374.18, 396.01, 399.3, 397.05, 394.71, 397.02, 394.55, 395.86, 396.04, 396.71, 397.52, 397.18, 394.83, 396.38, 395.2, 395.99, 395.21, 392.71, 393.02, 394.14, 393.75, 392.77, 396.11, 389.04], '1W': [366.81, 388.92, 369.34, 374.18, 389.04], '1M': [277.96, 273.38, 292.09, 302.24, 305.35, 318.93, 318, 318.18, 317.12, 334.41, 343.71, 336.41, 303.28, 324.45, 327.16, 362.52, 366.81, 388.92, 369.34, 374.18, 389.04], '6M': [164.7, 178.07, 194.76, 220.4, 222.41, 238.46, 230.1, 226.61, 240.09, 249.48, 222.99, 218.87, 224.71, 238.84, 213.66, 246.49, 265.16, 265.55, 248.75, 297.17, 295.44, 292.09, 318, 336.41, 362.52, 389.04], '1Y': [90.49, 97.2, 98.14, 99.62, 101.74, 98.62, 96.37, 101.75, 99.51, 100.08, 100.15, 105.07, 119.21, 132.2, 131.09, 149.15, 131.37, 141.51, 151.68, 157.46, 159.35, 148.26, 142.65, 154.79, 162.74, 164.3, 172.27, 175.87, 206.96, 214.38, 228.39, 239.58, 209.78, 235.12, 237.39, 239.07, 222.99, 218.87, 224.71, 233.45, 222.01, 258.76, 260.96, 258.56, 257.86, 286.52, 295.44, 292.09, 318, 336.41, 362.52, 389.04] },
      velocityScore: { '1D': 10.9, '1W': 4.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$487B', pe: 73.5, revenueGrowth: 24, eps: 5.29, grossMargin: 50, dividendYield: 0.27,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: false, FRWD: 5.85, BCTK: 7.61, FWD: 1.94, CBSE: 3.05, FCUS: false, WGMI: false },
      tonyNote: 'Lam Research is a wafer fab equipment holding, appearing in 2 Semiconductor ETFs. Its positioning is tied to the same logic as AMAT — equipment spending follows leading-edge node transitions and memory capacity additions. The gross margin and revenue profile are consistent with the duopoly pricing power that LRCX and AMAT share in etch and deposition equipment.',
    },
    {
      ticker: 'SHOP', name: 'Shopify Inc Registered Shs -A- Subord Vtg', easyScore: 4, avgWeight: 2.83, proScore: 0.87, coverage: 0.308,
      ...
      velocityScore: { '1D': -1.1, '1W': -7.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$141B', pe: 106.7, revenueGrowth: 34, eps: 1.02, grossMargin: 48, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 2.89, GTEK: false, ARKK: 4.07, MARS: false, FRWD: 1.83, BCTK: 2.55, FWD: false, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'Shopify Inc Registered Shs -A- Subord Vtg appears in 4 of 13 Broad Tech ETFs (31% coverage) with average weight 2.8% — selective across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'PANW', name: 'Palo Alto Networks', easyScore: 3, avgWeight: 5.09, proScore: 1.17, coverage: 0.231,
      ...
      velocityScore: { '1D': 1.7, '1W': 5.4, '1M': -57.3, '6M': null }, isNew: false,
      marketCap: '$235B', pe: 250.2, revenueGrowth: 31, eps: 1.15, grossMargin: 72, dividendYield: null,
      etfPresence: { PTF: false, WCLD: 2.72, IGV: 8.87, FDTX: 3.67, GTEK: false, ARKK: false, MARS: false, FRWD: false, BCTK: false, FWD: false, CBSE: false, FCUS: false, WGMI: false },
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 3, avgWeight: 4.99, proScore: 1.15, coverage: 0.231,
      price: 379.4, weeklyPrices: [390.74, 399.76, 393.83, 378.91, 379.40], weeklyChange: -2.9, dayChange: 0.13, sortRank: 0, periodReturns: { '1M': -10.4, '6M': -21.6, '1Y': -20.5 },
      priceHistory: { '1D': [378.91, 373.67, 376.46, 379.29, 378.4, 377.14, 375.96, 375.17, 375.35, 377.01, 377.59, 379.21, 378.96, 380.74, 379.7, 379.89, 379.51, 378.54, 377.74, 378.21, 377.58, 378.03, 378.15, 379.4], '1W': [390.74, 399.76, 393.83, 378.91, 379.4], '1M': [423.54, 417.42, 421.06, 419.09, 418.57, 412.67, 426.99, 450.24, 460.52, 441.31, 427.34, 428.05, 416.67, 411.74, 403.41, 390.34, 390.74, 399.76, 393.83, 378.91, 379.4], '6M': [483.98, 487.71, 472.85, 477.18, 454.52, 480.58, 411.21, 413.27, 399.6, 400.6, 405.2, 404.88, 391.79, 372.74, 370.17, 374.33, 411.22, 432.92, 424.46, 413.96, 405.21, 421.06, 426.99, 428.05, 390.34, 379.4], '1Y': [477.4, 495.94, 497.72, 503.02, 510.06, 512.5, 524.11, 522.04, 520.17, 507.23, 506.69, 498.2, 515.36, 514.45, 514.6, 528.57, 510.96, 513.58, 523.61, 517.81, 496.82, 510.18, 472.12, 486.74, 491.02, 474.82, 485.92, 487.1, 478.51, 470.67, 444.11, 481.63, 414.19, 404.37, 398.46, 401.72, 405.2, 404.88, 391.79, 371.04, 369.37, 373.07, 420.26, 415.75, 407.78, 420.77, 405.21, 421.06, 426.99, 428.05, 390.34, 379.4] },
      velocityScore: { '1D': 3.6, '1W': -2.5, '1M': -80.1, '6M': null }, isNew: false,
      marketCap: '$2.8T', pe: 22.6, revenueGrowth: 18, eps: 16.81, grossMargin: 68, dividendYield: 0.96,
      etfPresence: { PTF: false, WCLD: false, IGV: 8.33, FDTX: 3.79, GTEK: false, ARKK: false, MARS: false, FRWD: 2.85, BCTK: false, FWD: false, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'Microsoft appears in 4 of 8 AI ETFs and 2 Broad Tech ETFs at 3.7% average weight. Revenue up 18%, 68% gross margin, P/E of 27x — solid fundamentals for a $3.3T business. The -2.2% 1-year return and -8.5% 6-month return suggest the Copilot monetization narrative has stalled; ETF managers hold the position on long-term Azure and OpenAI leverage, not near-term momentum.',
    },
    {
    ...
    {
      ticker: 'GOOG', name: 'Alphabet Inc Class C', easyScore: 3, avgWeight: 3.7, proScore: 0.85, coverage: 0.231,
      ...
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 3.66, GTEK: false, ARKK: 1.86, MARS: false, FRWD: false, BCTK: 5.58, FWD: false, CBSE: false, FCUS: false, WGMI: false },
    ...
    {
      ticker: 'ASML', name: 'ASML Holding', easyScore: 3, avgWeight: 2.88, proScore: 0.66, coverage: 0.231,
      ...
      velocityScore: { '1D': -1.5, '1W': -7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$744B', pe: 64.1, revenueGrowth: 13, eps: 30.1, grossMargin: 53, dividendYield: 0.46,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: false, GTEK: false, ARKK: false, MARS: false, FRWD: 4.77, BCTK: 2.29, FWD: 1.57, CBSE: false, FCUS: false, WGMI: false },
    ...
    {
      ticker: 'CDNS', name: 'CADENCE DESIGN SYSTEMS INC', easyScore: 3, avgWeight: 2.79, proScore: 0.64, coverage: 0.231,
      price: 387.39, weeklyPrices: [383.74, 384.96, 394.50, 387.85, 387.39], weeklyChange: 0.95, dayChange: -0.57, sortRank: 0, periodReturns: { '1M': 12, '6M': 23.8, '1Y': 31.1 },
      priceHistory: { '1D': [389.6, 387.38, 389.8, 391.73, 393, 392.72, 392.32, 390.32, 390.21, 391.14, 390.63, 391.63, 391.05, 392.11, 391.89, 393.82, 393.79, 393.27, 392.09, 392.02, 392.99, 393.34, 393.76, 387.39], '1W': [383.74, 384.96, 394.5, 387.85, 387.39], '1M': [345.99, 338.12, 350.89, 358.46, 373.59, 381.75, 374.05, 373.85, 374.93, 414.16, 408, 411.68, 376.19, 394.24, 390.9, 385.13, 383.74, 384.96, 394.5, 387.85, 387.39], '6M': [313.02, 317.76, 310.4, 327.31, 317.45, 322.02, 289.19, 291, 283.46, 290.63, 300.63, 293.29, 293.75, 292.52, 270.88, 279.48, 292.37, 325.84, 325.31, 353.63, 358.04, 338.12, 374.05, 408, 385.13, 387.39], '1Y': [295.4, 305.2, 320.3, 317.49, 316.32, 332.19, 356.97, 352.06, 349.88, 349.63, 350.43, 360.64, 351.52, 373.35, 350.11, 347.27, 327, 326.12, 345.1, 338.69, 325.05, 314.93, 302.14, 311.84, 337.53, 323.22, 314.91, 317.71, 314.64, 323.06, 307, 318.37, 268.5, 299, 305.01, 301.84, 305.43, 294.16, 289.64, 284.32, 277.87, 289.5, 304.1, 331.61, 329.95, 354.9, 354.55, 338.12, 374.05, 408, 385.13, 387.39] },
      velocityScore: { '1D': null, '1W': -4.5, '1M': null, '6M': null }, isNew: true,
      marketCap: '$107B', pe: 90.1, revenueGrowth: 19, eps: 4.3, grossMargin: 86, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: 4.1, FDTX: false, GTEK: 2.4, ARKK: false, MARS: false, FRWD: 1.88, BCTK: false, FWD: false, CBSE: false, FCUS: false, WGMI: false },
    ...
    },
    {
      ...
      price: 223, weeklyPrices: [229.90, 233.09, 231.11, 226.63, 223.00], weeklyChange: -3, dayChange: -1.6, sortRank: 0, periodReturns: { '1M': 6.8, '6M': 61.3, '1Y': 74.9 },
      priceHistory: { '1D': [226.63, 217.7, 218.55, 218.61, 220.38, 221.44, 221.45, 220.41, 219.33, 219.51, 219.64, 220.32, 219.9, 222.22, 222.35, 222.78, 223.45, 222.35, 221.55, 221.17, 220.7, 221.41, 222.62, 223], '1W': [229.9, 233.09, 231.11, 226.63, 223], '1M': [208.82, 215.15, 212.24, 218.04, 222.32, 221.81, 225.24, 247.35, 277.49, 269.13, 250.33, 243.6, 234.11, 231.68, 227.34, 234.24, 229.9, 233.09, 231.11, 226.63, 223], '6M': [138.29, 138.32, 133.64, 126.57, 117, 138.21, 119.66, 129.67, 121.78, 110.33, 118.33, 127.49, 131.26, 122.57, 118.05, 116.5, 121.06, 132.14, 133.98, 143.71, 205.31, 212.24, 225.24, 243.6, 234.24, 223], '1Y': [127.5, 132.08, 152.41, 138.8, 145.27, 150.77, 135.6, 130.91, 127.25, 131.22, 136.68, 136.44, 138.65, 138.35, 145.26, 157.36, 158.74, 152.87, 156.47, 162.81, 191.24, 185.01, 157.55, 157.9, 154.28, 142.05, 140.39, 137.94, 137.1, 125.5, 123.46, 140.56, 115.71, 127.33, 120.6, 116.46, 118.33, 127.49, 131.26, 123.29, 118.67, 108.98, 123.47, 127.86, 132.19, 188.73, 205.31, 212.24, 225.24, 243.6, 234.24, 223] },
      velocityScore: { '1D': null, '1W': 0, '1M': null, '6M': null }, isNew: true,
      marketCap: '$79B', pe: 586.8, revenueGrowth: 32, eps: 0.38, grossMargin: 80, dividendYield: null,
      etfPresence: { PTF: false, WCLD: 2.82, IGV: 2.83, FDTX: 2.44, GTEK: false, ARKK: false, MARS: false, FRWD: false, BCTK: false, FWD: false, CBSE: false, FCUS: false, WGMI: false },
    ...
    {
      ticker: 'KLAC', name: 'KLAC', easyScore: 3, avgWeight: 2.12, proScore: 0.49, coverage: 0.231,
      price: 259.56, weeklyPrices: [254.54, 256.42, 237.33, 238.73, 259.56], weeklyChange: 1.97, dayChange: 8.73, sortRank: 0, periodReturns: { '1M': 47.8, '6M': 112.3, '1Y': 205.4 },
      priceHistory: { '1D': [238.73, 252.43, 256.59, 256.59, 254.06, 254.2, 254.29, 255.73, 257.27, 259.21, 259.14, 259.71, 259.3, 259.65, 258.59, 259.84, 259.47, 258.18, 258.67, 260.71, 261.4, 261.31, 263.46, 259.56], '1W': [254.54, 256.42, 237.33, 238.73, 259.56], '1M': [175.65, 174.06, 182.95, 184.22, 188.84, 195.72, 192.76, 192.17, 194, 204.52, 212.51, 213.11, 192.92, 210.81, 213.94, 241.16, 254.54, 256.42, 237.33, 238.73, 259.56], '6M': [122.24, 127.96, 135.24, 142.82, 148.62, 161.63, 135.55, 143.08, 148.03, 154.67, 147.59, 146.5, 148.24, 156.62, 147.24, 167.23, 174.81, 181.21, 181.62, 181.63, 184.97, 182.95, 192.76, 213.11, 241.16, 259.56], '1Y': [85, 88.99, 91.26, 92.18, 93.78, 92.32, 88.66, 91.48, 87.49, 87.03, 87.2, 90.9, 98.89, 107.13, 106.41, 113.97, 98.28, 110.67, 118.28, 120.87, 119.34, 113.43, 109.71, 115.72, 122.46, 122.51, 124.57, 126.04, 139.5, 144.18, 152, 162.72, 130.72, 147.95, 146.99, 152.43, 147.59, 146.5, 148.24, 154.38, 151.98, 172.73, 173.49, 181.54, 175.04, 176.32, 184.97, 182.95, 192.76, 213.11, 241.16, 259.56] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$339B', pe: 73.3, revenueGrowth: 12, eps: 3.54, grossMargin: 61, dividendYield: 0.35,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: false, GTEK: 1.75, ARKK: false, MARS: false, FRWD: false, BCTK: false, FWD: 1.68, CBSE: 2.94, FCUS: false, WGMI: false },
      tonyNote: 'KLA Corp is the semiconductor inspection and process control specialist, held in Semiconductor ETFs at a weighting that reflects its non-discretionary role in advanced fab builds. At $1921 per share and a substantial gross margin, KLAC is the most expensive name in the theme by share price; institutional ETF managers hold it as a quality compounder with pricing power that peers cannot replicate.',
    },
  ],
  ...
  'Industrials': [
    ...
    },
    {
      ...
      velocityScore: { '1D': 3, '1W': 3, '1M': -10, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      price: 297.2, weeklyPrices: [290.50, 294.75, 303.53, 292.70, 297.20], weeklyChange: 2.31, dayChange: 1.08, sortRank: 0, periodReturns: { '1M': 11.4, '6M': 181, '1Y': 408.3 },
      priceHistory: { '1D': [294.03, 293.83, 290.32, 287.45, 293.87, 294.27, 291.91, 290.17, 291.7, 295.59, 296.89, 297.15, 299.19, 299.76, 298.43, 298.66, 298.18, 297.33, 295.08, 294.96, 295.11, 296.39, 296.13, 297.2], '1W': [290.5, 294.75, 303.53, 292.7, 297.2], '1M': [266.8, 261.58, 271.05, 270.75, 279.22, 291.97, 295.94, 288.9, 284.42, 288.12, 299.73, 300.06, 284.87, 293.6, 283.51, 262.34, 290.5, 294.75, 303.53, 292.7, 297.2], '6M': [105.77, 112.06, 117.51, 121.83, 139.99, 141.15, 146.79, 187.3, 187.21, 186.39, 170.37, 176.51, 174.04, 180.86, 167.52, 201.7, 234.42, 240.97, 255.56, 294.69, 308.05, 261.58, 295.94, 299.73, 262.34, 297.2], '1Y': [58.47, 70.97, 71.96, 70.19, 73.64, 82.79, 75.89, 81.28, 84.88, 87.65, 88.72, 90.8, 100.68, 99.1, 96.99, 101.35, 100.35, 110.24, 121.66, 127.8, 121.79, 109.89, 98.12, 107.74, 114.04, 112.36, 110.97, 111.96, 120, 133.04, 142.76, 147.43, 151.08, 190.09, 180.99, 183, 170.96, 171.73, 167.41, 186.82, 180.36, 218.07, 229.73, 242.77, 253.49, 320.3, 300.84, 261.58, 295.94, 299.73, 262.34, 297.2] },
      velocityScore: { '1D': -3.8, '1W': -1.5, '1M': 11, '6M': null }, isNew: false,
      marketCap: '$11B', pe: 58.2, revenueGrowth: 7, eps: 5.11, grossMargin: 30, dividendYield: 0.12,
    ...
    },
    {
      ...
      marketCap: '$250B', pe: 34.9, revenueGrowth: 9, eps: 5.32, grossMargin: 20, dividendYield: 1.49,
  ...
  'Meme': [
    {
      ticker: 'NBIS', name: 'Nebius Group', easyScore: 3, avgWeight: 5.29, proScore: 5.29, coverage: 1,
      ...
      velocityScore: { '1D': 6.7, '1W': 21.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$73B', pe: 111.1, revenueGrowth: 684, eps: 2.58, grossMargin: 72, dividendYield: null,
      etfPresence: { BUZZ: 3.84, MEME: 6.84, RKNG: 5.18 },
    ...
    {
      ticker: 'IREN', name: 'IREN Ltd', easyScore: 3, avgWeight: 4.19, proScore: 4.19, coverage: 1,
      ...
      velocityScore: { '1D': 6.3, '1W': 50.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$21B', pe: 77.9, revenueGrowth: 0, eps: 0.77, grossMargin: 68, dividendYield: null,
      etfPresence: { BUZZ: 3.01, MEME: 6.27, RKNG: 3.28 },
    ...
    {
      ticker: 'ASTS', name: 'AST SpaceMobile', easyScore: 3, avgWeight: 3.93, proScore: 3.93, coverage: 1,
      ...
      velocityScore: { '1D': 6.8, '1W': 1.6, '1M': null, '6M': null }, isNew: false,
      marketCap: '$31B', pe: null, revenueGrowth: 1952, eps: -1.8, grossMargin: 45, dividendYield: null,
      etfPresence: { BUZZ: 3.12, MEME: 6.38, RKNG: 2.28 },
    ...
    {
      ticker: 'SNDK', name: 'Sandisk', easyScore: 2, avgWeight: 6.84, proScore: 4.56, coverage: 0.667,
      ...
      velocityScore: { '1D': 6.3, '1W': 11.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$324B', pe: 74.6, revenueGrowth: 251, eps: 29.28, grossMargin: 56, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: 6.48, RKNG: 7.19 },
    ...
    {
      ticker: 'AAOI', name: 'Applied Optoelectronics', easyScore: 2, avgWeight: 6.08, proScore: 4.05, coverage: 0.667,
      ...
      velocityScore: { '1D': 4.9, '1W': 19.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$13B', pe: null, revenueGrowth: 51, eps: -0.65, grossMargin: 30, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: 7.73, RKNG: 4.42 },
    ...
    {
      ticker: 'WDC', name: 'WDC', easyScore: 2, avgWeight: 5.49, proScore: 3.66, coverage: 0.667,
      price: 746.23, weeklyPrices: [562.93, 653.53, 681.08, 712.13, 746.23], weeklyChange: 32.56, dayChange: 4.79, sortRank: 0, periodReturns: { '1M': 62.7, '6M': 326.4, '1Y': 1158.6 },
      priceHistory: { '1D': [712.13, 790.36, 786.06, 783.76, 773.56, 770.57, 772.01, 774.04, 769.58, 762.15, 758.33, 753.26, 743.76, 751.17, 746.33, 744.85, 743.34, 741.61, 746.88, 745.57, 745.06, 751.68, 757, 746.23], '1W': [562.93, 653.53, 681.08, 712.13, 746.23], '1M': [458.68, 455.8, 459.62, 486.46, 484.28, 530.6, 531.18, 531.21, 546.2, 563.1, 594.11, 575.5, 511.72, 526.93, 517.72, 529.29, 562.93, 653.53, 681.08, 712.13, 746.23], '6M': [175.01, 181.54, 187.88, 212.14, 222.97, 252.66, 290.24, 262.56, 296.56, 290.95, 261.3, 268.81, 304.9, 301.05, 270.49, 338.78, 365, 389.1, 412.76, 483.15, 494.09, 459.62, 531.18, 575.5, 529.29, 746.23], '1Y': [59.29, 63.29, 65.22, 66.93, 68.74, 68.99, 76.55, 74.97, 75.06, 76.97, 80.34, 93.29, 102.39, 112.41, 116.74, 125.28, 115.42, 126.2, 129.43, 150.21, 162.96, 157.83, 139.19, 163.54, 169.78, 172.04, 181.08, 179.68, 219.38, 214, 241.9, 279.7, 269.41, 273.74, 284.67, 282.25, 261.3, 268.81, 304.9, 296.14, 297.73, 337.88, 361.69, 403.12, 434.52, 463.91, 494.09, 459.62, 531.18, 575.5, 529.29, 746.23] },
      velocityScore: { '1D': 105.6, '1W': 133.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$257B', pe: 44.6, revenueGrowth: 46, eps: 16.72, grossMargin: 45, dividendYield: 0.08,
      etfPresence: { BUZZ: false, MEME: 5.63, RKNG: 5.35 },
      tonyNote: 'Western Digital holds a 2.47% average weight across 5 AI ETFs — the broadest coverage of any storage name in the theme. Revenue up 46%, 45% gross margin, P/E of 32x. The 931% 1-year return is driven by HDD demand for AI training data storage, a durable structural demand shift. The weight score is climbing as ETF managers increase allocation following the NAND market recovery.',
    },
    {
      ticker: 'BE', name: 'Bloom Energy', easyScore: 2, avgWeight: 5.33, proScore: 3.55, coverage: 0.667,
      price: 328.91, weeklyPrices: [260.22, 274.50, 280.88, 284.99, 328.91], weeklyChange: 26.4, dayChange: 15.41, sortRank: 0, periodReturns: { '1M': 27.1, '6M': 310.1, '1Y': 1412.2 },
      priceHistory: { '1D': [284.99, 303.53, 303.66, 309.75, 310.73, 311.19, 312.5, 312.36, 310.6, 311.97, 310.6, 310.16, 310.11, 311.46, 311.58, 311.8, 309.27, 309.86, 309.92, 317.68, 321.56, 321.36, 326.42, 328.91], '1W': [260.22, 274.5, 280.88, 284.99, 328.91], '1M': [258.71, 261.34, 282.31, 307.88, 302.49, 293.8, 290.01, 285, 273.51, 302.85, 287.32, 291.37, 263.61, 253.57, 259.61, 248.88, 260.22, 274.5, 280.88, 284.99, 328.91], '6M': [80.21, 90.18, 103.87, 136.87, 151.75, 152.31, 168.89, 148.7, 157.27, 174.77, 164.78, 159.21, 156.58, 145.88, 135.49, 146.78, 213.84, 229.75, 287.97, 285.47, 289.76, 282.31, 290.01, 291.37, 248.88, 328.91], '1Y': [21.75, 22.18, 24.36, 25.96, 25.36, 34.78, 36.72, 36.8, 45.28, 48.54, 52.94, 53.44, 67.02, 86.27, 73.6, 86.97, 86.87, 111.5, 110.38, 132.16, 135.21, 111.89, 89.99, 98.93, 111.79, 89.58, 88.82, 88.41, 103.05, 139.77, 150.56, 165.39, 147.35, 155.54, 159, 168.57, 164.78, 159.21, 156.58, 150.22, 132.45, 160.13, 210.06, 237.57, 283.36, 258.64, 289.76, 282.31, 290.01, 291.37, 248.88, 328.91] },
      velocityScore: { '1D': 5.3, '1W': 98.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$94B', pe: null, revenueGrowth: 130, eps: -0.03, grossMargin: 30, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: 6.69, RKNG: 3.97 },
      tonyNote: 'Bloom Energy is a fringe AI infrastructure holding — 2 ETFs, 3.33% average weight — positioned on fuel cell power generation for data centers. Revenue grew 130% but EPS is -$0.03, gross margin 30%, and the P/E is not calculable. The 1443% 1-year return is the headline number; this is a high-conviction, small-weight speculative position for the ETF managers that hold it.',
    },
    {
      ticker: 'MU', name: 'MU', easyScore: 2, avgWeight: 4.93, proScore: 3.29, coverage: 0.667,
      price: 1133.99, weeklyPrices: [981.61, 1087.99, 1020.76, 1043.19, 1133.99], weeklyChange: 15.52, dayChange: 8.7, sortRank: 0, periodReturns: { '1M': 66.4, '6M': 356.2, '1Y': 817.5 },
      priceHistory: { '1D': [1043.19, 1099, 1106.11, 1118.26, 1121.66, 1124.56, 1128.4, 1126.12, 1122.69, 1126.87, 1127.72, 1125.45, 1127.32, 1129.46, 1134.23, 1134.65, 1138.57, 1141.99, 1142.73, 1144.29, 1139.82, 1142.21, 1147.02, 1133.99], '1W': [981.61, 1087.99, 1020.76, 1043.19, 1133.99], '1M': [681.54, 698.74, 731.99, 762.1, 751, 928.41, 923.52, 971, 1035.5, 1064.1, 1079.57, 996, 864.01, 949.28, 935.89, 995.87, 981.61, 1087.99, 1020.76, 1043.19, 1133.99], '6M': [248.55, 284.79, 312.15, 345.87, 365, 410.24, 419.44, 373.25, 420.95, 429, 400.77, 418.69, 461.73, 395.53, 337.84, 406.73, 456.23, 487.48, 518.46, 666.59, 803.63, 731.99, 923.52, 996, 995.87, 1133.99], '1Y': [123.6, 124.76, 119.92, 118.61, 113.23, 111.25, 104.88, 118.89, 120.87, 117.68, 119.01, 131.46, 157.77, 164.62, 163.9, 190.96, 181.6, 202.38, 219.02, 223.77, 237.92, 246.83, 207.37, 240.46, 246.92, 237.5, 265.92, 294.37, 343.43, 338.13, 389.11, 435.28, 379.4, 410.34, 417.35, 415.56, 400.77, 418.69, 461.73, 382.09, 367.85, 421.51, 457.23, 481.72, 517.16, 646.63, 803.63, 731.99, 923.52, 996, 995.87, 1133.99] },
      velocityScore: { '1D': -0.3, '1W': 7.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.3T', pe: 53.5, revenueGrowth: 196, eps: 21.21, grossMargin: 58, dividendYield: 0.05,
      etfPresence: { BUZZ: 4.07, MEME: false, RKNG: 5.79 },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
      ticker: 'APLD', name: 'Applied Digital', easyScore: 2, avgWeight: 4.82, proScore: 3.22, coverage: 0.667,
      ...
      velocityScore: { '1D': -18.7, '1W': -14.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$13B', pe: null, revenueGrowth: 139, eps: -0.38, grossMargin: 45, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: 5.81, RKNG: 3.84 },
    ...
    {
      ticker: 'LITE', name: 'LITE', easyScore: 2, avgWeight: 4.54, proScore: 3.03, coverage: 0.667,
      price: 850, weeklyPrices: [921.56, 957.24, 875.36, 869.98, 850.00], weeklyChange: -7.77, dayChange: -2.3, sortRank: 0, periodReturns: { '1M': -4, '6M': 152.1, '1Y': 848 },
      priceHistory: { '1D': [869.98, 871, 851.95, 858.55, 873.26, 873.96, 868.95, 857.01, 859.25, 857.78, 859.32, 846.43, 844, 847.6, 843.25, 839.42, 837.37, 837.95, 834.59, 835.86, 836.34, 837.85, 848.54, 850], '1W': [921.56, 957.24, 875.36, 869.98, 850], '1M': [884.98, 890.09, 868.07, 964.5, 946.9, 902.31, 860.62, 854.96, 905, 1029.15, 938, 945.08, 863.66, 895.4, 821.76, 889.59, 921.56, 957.24, 875.36, 869.98, 850], '6M': [337.13, 390.77, 357.05, 339.87, 356.83, 370.66, 435.1, 561.13, 594.26, 723.39, 680.8, 672, 700.81, 801.99, 702.76, 896.02, 824.01, 873.6, 858.32, 944.28, 1030.37, 868.07, 860.62, 945.08, 889.59, 850], '1Y': [89.66, 94.75, 91.08, 92.24, 103.84, 107.17, 106.68, 116.27, 115.86, 119.34, 132.81, 149.4, 168.77, 164.71, 162.58, 160.6, 149.61, 164.77, 179.3, 201.56, 240.11, 232.15, 255.59, 317.93, 342.56, 334.69, 371.43, 372.61, 397.42, 361.33, 362.44, 385, 465.54, 574.11, 635.64, 677, 680.8, 672, 700.81, 777.17, 764.65, 894.13, 891.22, 846.89, 902.32, 892.58, 1030.37, 868.07, 860.62, 945.08, 889.59, 850] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$66B', pe: 149.1, revenueGrowth: 90, eps: 5.7, grossMargin: 41, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: 5.68, RKNG: 3.4 },
      tonyNote: 'LITE appears in 2 of 3 Meme ETFs (67% coverage) with average weight 4.5% — high conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'IONQ', name: 'IonQ', easyScore: 2, avgWeight: 3.82, proScore: 2.55, coverage: 0.667,
      ...
      velocityScore: { '1D': 12.3, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$21B', pe: 145, revenueGrowth: 755, eps: 0.39, grossMargin: 36, dividendYield: null,
      etfPresence: { BUZZ: 1.76, MEME: 5.88, RKNG: false },
    ...
    {
      ticker: 'RGTI', name: 'Rigetti Computing', easyScore: 2, avgWeight: 3.2, proScore: 2.13, coverage: 0.667,
      ...
      etfPresence: { BUZZ: false, MEME: 3.25, RKNG: 3.14 },
    ...
    {
      ticker: 'RKLB', name: 'Rocket Lab', easyScore: 2, avgWeight: 2.74, proScore: 1.83, coverage: 0.667,
      ...
      velocityScore: { '1D': 0.5, '1W': -49, '1M': null, '6M': null }, isNew: false,
      marketCap: '$67B', pe: null, revenueGrowth: 64, eps: -0.32, grossMargin: 37, dividendYield: null,
      etfPresence: { BUZZ: 1.89, MEME: false, RKNG: 3.59 },
    ...
    {
      ticker: 'GOOGL', name: 'GOOGL', easyScore: 2, avgWeight: 2.14, proScore: 1.43, coverage: 0.667,
      price: 368.03, weeklyPrices: [359.68, 369.35, 373.25, 363.79, 368.03], weeklyChange: 2.32, dayChange: 1.17, sortRank: 0, periodReturns: { '1M': -7.3, '6M': 21.7, '1Y': 120.9 },
      priceHistory: { '1D': [363.79, 359.41, 362.07, 362.68, 363.13, 364.04, 363.53, 364, 365.22, 365.5, 365.45, 366.45, 366.71, 366.47, 367.85, 367.64, 368.33, 367.84, 367.51, 368.47, 367.22, 367.62, 369.28, 368.03], '1W': [359.68, 369.35, 373.25, 363.79, 368.03], '1M': [396.94, 387.66, 388.91, 387.66, 382.97, 388.83, 390.13, 380.34, 376.37, 361.85, 358.99, 372.19, 368.53, 363.31, 364.26, 357.77, 359.68, 369.35, 373.25, 363.79, 368.03], '6M': [302.46, 313.51, 316.54, 331.86, 322, 334.55, 339.71, 318.58, 303.33, 312.9, 303.13, 308.7, 307.69, 290.44, 287.56, 317.32, 337.12, 339.32, 349.94, 398.04, 402.62, 388.91, 390.13, 372.19, 357.77, 368.03], '1Y': [166.64, 178.53, 176.79, 181.56, 190.1, 192.58, 189.13, 201.42, 203.9, 206.09, 212.91, 234.04, 251.61, 252.53, 244.05, 250.43, 236.57, 253.3, 259.92, 281.19, 278.83, 276.41, 299.66, 314.89, 313.72, 308.22, 307.16, 313.56, 314.34, 335.97, 328.38, 336.01, 333.04, 310.96, 302.85, 307.38, 303.13, 308.7, 307.69, 290.93, 297.39, 318.49, 336.02, 338.89, 384.8, 397.99, 402.62, 388.91, 390.13, 372.19, 357.77, 368.03] },
      velocityScore: { '1D': 0.7, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4.5T', pe: 28.1, revenueGrowth: 22, eps: 13.1, grossMargin: 60, dividendYield: 0.24,
      etfPresence: { BUZZ: 1.56, MEME: false, RKNG: 2.72 },
      tonyNote: 'Alphabet holds a 4.95% average weight across 4 AI ETFs, but the 50% coverage is the constraint — half the theme ignores it. Revenue up 22%, gross margin at 60%, P/E of 29x makes it the cheapest mega-cap in the theme. The 1-year return of 121% shows the market has caught up to the AI value story, but at this valuation the upside case depends on sustained cloud and search margin expansion.',
    },
    {
      ...
      velocityScore: { '1D': 22, '1W': 14.6, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      velocityScore: { '1D': 8.6, '1W': 9.2, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'NVTS', name: 'Navitas Semiconductor', easyScore: 1, avgWeight: 5.26, proScore: 1.75, coverage: 0.333,
      ...
      velocityScore: { '1D': -41.3, '1W': -45.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$6B', pe: null, revenueGrowth: -39, eps: -0.63, grossMargin: 30, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: false, RKNG: 5.26 },
    ...
    {
      ticker: 'CRDO', name: 'CRDO', easyScore: 1, avgWeight: 4.96, proScore: 1.65, coverage: 0.333,
      price: 271.83, weeklyPrices: [250.81, 259.41, 239.18, 249.33, 271.83], weeklyChange: 8.38, dayChange: 9.02, sortRank: 0, periodReturns: { '1M': 73.9, '6M': 96.2, '1Y': 217.9 },
      priceHistory: { '1D': [249.33, 258.77, 253.95, 264.16, 266.46, 265.07, 267.13, 264.23, 262.47, 265.87, 263.93, 262.25, 262.1, 261.14, 262.04, 262.99, 262.64, 262.11, 262.66, 263.55, 264.64, 265.61, 270.1, 271.83], '1W': [250.81, 259.41, 239.18, 249.33, 271.83], '1M': [156.27, 168.99, 182.98, 193.39, 218.41, 221.23, 222.35, 236.03, 226.1, 229, 214.6, 217.5, 206.89, 222.27, 234.32, 264.76, 250.81, 259.41, 239.18, 249.33, 271.83], '6M': [138.57, 144.83, 140.24, 156.07, 153.22, 129.57, 111.31, 134.72, 127.91, 123.46, 102.54, 115.91, 101.72, 100.3, 93.87, 110.21, 168.35, 189.49, 175.77, 198.29, 189.36, 182.98, 222.35, 217.5, 264.76, 271.83], '1Y': [85.51, 93.49, 92.73, 98.7, 95.74, 107.95, 107.56, 120.41, 116.74, 114.04, 123.06, 147.53, 163.98, 164.1, 146.01, 147.42, 138.83, 143.61, 155.55, 187.62, 163.61, 145.52, 133.49, 171.13, 178.94, 142.02, 150.13, 144.7, 132.95, 161.38, 139.16, 129.66, 96.95, 128.4, 130.66, 114.48, 102.54, 115.91, 101.72, 103.91, 95.92, 107.93, 158.93, 185.54, 174.01, 188.29, 189.36, 182.98, 222.35, 217.5, 264.76, 271.83] },
      velocityScore: { '1D': -40.9, '1W': -46.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$51B', pe: 108.7, revenueGrowth: 157, eps: 2.5, grossMargin: 68, dividendYield: null,
      etfPresence: { BUZZ: false, MEME: false, RKNG: 4.96 },
      tonyNote: 'Credo Technology is a high-speed connectivity semiconductor company — SerDes IP, active electrical cables, and optical DSPs for data center networking at speeds from 100G to 1.6T. Revenue grew sharply as hyperscalers upgraded networking infrastructure for AI training. The ETF weight is building as managers recognize Credo\'s position at the intersection of AI and optical networking.',
    },
    {
      ...
      velocityScore: { '1D': null, '1W': -14, '1M': null, '6M': null }, isNew: true,
    ...
    {
      ticker: 'WULF', name: 'WULF', easyScore: 1, avgWeight: 4.3, proScore: 1.43, coverage: 0.333,
      ...
      etfPresence: { BUZZ: false, MEME: false, RKNG: 4.3 },
