...
export const INDEX_CHART_DATA: Record<Theme, Record<Period, ChartPeriodData>> = {
  ...
  'Broad Tech': {
    ...
    '1M': { top10: [100, 100.87, 102.33, 99.8, 98.99, 100.66, 102.38, 103.87, 107.14, 107.16, 108.87, 109.57, 111.67, 112.84, 110.92, 102.58, 104.63, 102.43, 99.95, 104.45, 104.74], spy: [100, 100.56, 101.35, 100.13, 100.06, 100.42, 100.62, 101.01, 101.68, 101.66, 102.22, 102.48, 102.76, 102.9, 102.18, 99.91, 100.14, 99.85, 98.27, 99.94, 100.48], top10Return: 4.7, spyReturn: 0.5, xLabels: ["May 17", "May 24", "May 31", "Jun 7", "Jun 14"] },
...
export const SCAN_TIMESTAMP    = '2026-06-14T15:35:18.662Z';
export const SCAN_TIMESTAMP_NY = 'June 14, 2026 at 11:35 AM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `MICRON TECHNOLOGY INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 14.23, bestProScore: 6.04, avgProScore: 4.74, price: 981.61, weeklyChange: 3.41 },
  { ticker: 'NVDA', name: `NVIDIA CORP`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.85, bestProScore: 6.61, avgProScore: 3.95, price: 205.19, weeklyChange: -1.65 },
  { ticker: 'AMD', name: `ADVANCED MICRO DEVICES INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.09, bestProScore: 5.12, avgProScore: 3.70, price: 511.57, weeklyChange: 4.33 },
  { ticker: 'AVGO', name: `BROADCOM INC`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 6.15, bestProScore: 2.99, avgProScore: 2.05, price: 382.07, weeklyChange: -3.66 },
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 5.77, bestProScore: 3.20, avgProScore: 2.88, price: 279.70, weeklyChange: -3.17 },
  { ticker: 'TSM', name: `Taiwan Semiconductor Manufacturing Co Ltd ADR`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 4.71, bestProScore: 2.82, avgProScore: 2.35, price: 423.93, weeklyChange: -0.67 },
  { ticker: 'POWL', name: `Powell Industries, Inc.`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 4.46, bestProScore: 2.37, avgProScore: 2.23, price: 294.75, weeklyChange: 0.39 },
  { ticker: 'LRCX', name: `LAM RESEARCH CORP`, themeCount: 2, themes: ['Semiconductors', 'Broad Tech'], aggregateScore: 3.73, bestProScore: 2.30, avgProScore: 1.86, price: 366.81, weeklyChange: 13.06 },
  { ticker: 'AMZN', name: `AMAZON.COM INC`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 3.31, bestProScore: 2.22, avgProScore: 1.66, price: 238.55, weeklyChange: -2.72 },
  { ticker: 'ALAB', name: `ASTERA LABS INC`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 3.26, bestProScore: 1.73, avgProScore: 1.63, price: 367.15, weeklyChange: 6.01 },
];
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'AI & ML': [
    {
      ticker: 'NVDA', name: 'NVIDIA CORP', easyScore: 9, avgWeight: 6.61, proScore: 6.61, coverage: 1,
      ...
      velocityScore: { '1D': 4.8, '1W': 11.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.0T', pe: 31.4, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.49,
      etfPresence: { AIS: false, ARTY: 3.5, BAI: 4.27, IGPT: 5.68, IVES: 4.76, ALAI: 13.1, CHAT: 6.82, AIFD: 6.42, SPRX: 4.13, AOTG: 10.78 },
    ...
    {
      ticker: 'MU', name: 'MICRON TECHNOLOGY INC', easyScore: 8, avgWeight: 6.69, proScore: 5.95, coverage: 0.889,
      ...
      velocityScore: { '1D': -2.6, '1W': 16.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.1T', pe: 46.3, revenueGrowth: 196, eps: 21.2, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { AIS: false, ARTY: 7.59, BAI: 6.03, IGPT: 12.28, IVES: 6.07, ALAI: 0.94, CHAT: 3.87, AIFD: 6.38, SPRX: false, AOTG: 10.38 },
    ...
    {
      ticker: 'AMD', name: 'ADVANCED MICRO DEVICES INC', easyScore: 8, avgWeight: 5.77, proScore: 5.12, coverage: 0.889,
      ...
      velocityScore: { '1D': 4.1, '1W': 10.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$834B', pe: 169.4, revenueGrowth: 38, eps: 3.02, grossMargin: 53, dividendYield: null,
      etfPresence: { AIS: false, ARTY: 7.58, BAI: 4.86, IGPT: 7.37, IVES: 5.06, ALAI: 1.19, CHAT: 4.08, AIFD: false, SPRX: 0.52, AOTG: 15.46 },
    ...
    {
      ticker: 'AVGO', name: 'BROADCOM INC', easyScore: 7, avgWeight: 3.84, proScore: 2.99, coverage: 0.778,
      ...
      velocityScore: { '1D': 4.9, '1W': 12, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.8T', pe: 63.7, revenueGrowth: 48, eps: 6, grossMargin: 76, dividendYield: 0.68,
      etfPresence: { AIS: false, ARTY: 3.36, BAI: 4.27, IGPT: false, IVES: 4.42, ALAI: 3.79, CHAT: 4.2, AIFD: 5.32, SPRX: false, AOTG: 1.53 },
    ...
    {
      ticker: 'GOOGL', name: 'ALPHABET INC CLASS A', easyScore: 6, avgWeight: 4.74, proScore: 3.16, coverage: 0.667,
      ...
      velocityScore: { '1D': 9.7, '1W': 5.7, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'ANET', name: 'ARISTA NETWORKS INC', easyScore: 6, avgWeight: 2.48, proScore: 1.65, coverage: 0.667,
      ...
      velocityScore: { '1D': 11.5, '1W': 13.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$206B', pe: 56.1, revenueGrowth: 35, eps: 2.91, grossMargin: 64, dividendYield: null,
      etfPresence: { AIS: false, ARTY: 2.04, BAI: 1.4, IGPT: false, IVES: false, ALAI: 0.98, CHAT: 2.24, AIFD: 4.91, SPRX: 3.29, AOTG: false },
      tonyNote: 'ARISTA NETWORKS INC appears in 6 of 9 AI & ML ETFs (67% coverage) with average weight 2.5% — high conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'TSM', name: 'TAIWAN SEMICONDUCTOR MANUFACTURING', easyScore: 5, avgWeight: 5.08, proScore: 2.82, coverage: 0.556,
      ...
      velocityScore: { '1D': -2.8, '1W': 11, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.2T', pe: 36.5, revenueGrowth: 35, eps: 11.62, grossMargin: 62, dividendYield: 0.9,
      etfPresence: { AIS: false, ARTY: false, BAI: 4.3, IGPT: false, IVES: 5.04, ALAI: 5.59, CHAT: false, AIFD: 3.24, SPRX: false, AOTG: 7.24 },
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 5, avgWeight: 4.62, proScore: 2.57, coverage: 0.556,
      ...
      velocityScore: { '1D': -9.2, '1W': 10.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$245B', pe: 96.1, revenueGrowth: 28, eps: 2.91, grossMargin: 52, dividendYield: 0.09,
      etfPresence: { AIS: false, ARTY: 9.05, BAI: 1.9, IGPT: false, IVES: false, ALAI: false, CHAT: 1.58, AIFD: 6.1, SPRX: 4.46, AOTG: false },
    ...
    {
      ticker: 'AMZN', name: 'AMAZON.COM INC', easyScore: 5, avgWeight: 4, proScore: 2.22, coverage: 0.556,
      ...
      velocityScore: { '1D': 8.3, '1W': 4.2, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 5, avgWeight: 3.47, proScore: 1.93, coverage: 0.556,
      ...
      velocityScore: { '1D': 8.4, '1W': 1, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'META', name: 'Meta Platforms Inc', easyScore: 5, avgWeight: 3.24, proScore: 1.8, coverage: 0.556,
      ...
      velocityScore: { '1D': 9.1, '1W': 3.4, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'LITE', name: 'LUMENTUM HOLDINGS INC', easyScore: 5, avgWeight: 2.99, proScore: 1.66, coverage: 0.556,
      ...
      velocityScore: { '1D': 22.1, '1W': 21.2, '1M': null, '6M': null }, isNew: false,
      ...
      tonyNote: 'LUMENTUM HOLDINGS INC appears in 5 of 9 AI & ML ETFs (56% coverage) with average weight 3.0% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'ALAB', name: 'ASTERA LABS INC', easyScore: 4, avgWeight: 3.43, proScore: 1.53, coverage: 0.444,
      ...
      velocityScore: { '1D': -3.8, '1W': 7.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$63B', pe: 249.8, revenueGrowth: 93, eps: 1.47, grossMargin: 76, dividendYield: null,
      etfPresence: { AIS: false, ARTY: 1.79, BAI: false, IGPT: false, IVES: false, ALAI: 1.5, CHAT: 2.68, AIFD: false, SPRX: 7.76, AOTG: false },
    ...
    {
      ticker: 'ORCL', name: 'ORACLE CORP', easyScore: 4, avgWeight: 2.97, proScore: 1.32, coverage: 0.444,
      ...
      velocityScore: { '1D': 7.3, '1W': -3.6, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'NBIS', name: 'NEBIUS GROUP NV', easyScore: 4, avgWeight: 2.97, proScore: 1.32, coverage: 0.444,
      ...
      velocityScore: { '1D': null, '1W': 17.9, '1M': null, '6M': null }, isNew: true,
    ...
    {
      ticker: 'CRWV', name: 'COREWEAVE INC CLASS A', easyScore: 4, avgWeight: 2.53, proScore: 1.13, coverage: 0.444,
      price: 100.55, weeklyPrices: [102.37, 98.45, 95.61, 95.74, 100.55], weeklyChange: -1.78, sortRank: 0, periodReturns: { '1M': -6.7, '6M': 27.9, '1Y': -31.7 },
      priceHistory: { '1W': [102.37, 98.45, 95.61, 95.74, 100.55], '1M': [107.75, 111.31, 114.21, 107.3, 103.77, 101.28, 107.58, 105.49, 105.89, 104.27, 106.86, 109.53, 124.82, 119.27, 110.93, 100.39, 102.37, 98.45, 95.61, 95.74, 100.55], '6M': [78.59, 83, 74.92, 77.94, 87.48, 94.05, 106.02, 82.46, 95.15, 97.14, 97.63, 74.82, 79.86, 82.82, 87.58, 78.44, 92, 119.56, 117.42, 111.6, 128.84, 114.21, 107.58, 109.53, 100.39, 100.55], '1Y': [147.19, 173.68, 163.06, 151.45, 140.59, 129.77, 110.28, 106.01, 139.78, 96.8, 92.38, 93.34, 100.22, 118.75, 130.89, 136.85, 133.85, 141.62, 127.06, 136.06, 126.32, 105.61, 75.33, 73.6, 76.03, 90.66, 72.35, 84.83, 73.9, 77.18, 89.8, 91.79, 99.53, 74.65, 95.7, 89.25, 97.63, 74.82, 79.86, 80.66, 80.45, 82.24, 102, 116.85, 110.14, 119.01, 128.84, 114.21, 107.58, 109.53, 100.39, 100.55] },
      velocityScore: { '1D': null, '1W': 27, '1M': null, '6M': null }, isNew: true,
      marketCap: '$55B', pe: null, revenueGrowth: 112, eps: -2.72, grossMargin: 69, dividendYield: null,
      etfPresence: { AIS: false, ARTY: 4.05, BAI: 1.27, IGPT: false, IVES: 2.12, ALAI: false, CHAT: 2.7, AIFD: false, SPRX: false, AOTG: false },
      tonyNote: 'COREWEAVE INC CLASS A appears in 4 of 9 AI & ML ETFs (44% coverage) with average weight 2.5% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'TSLA', name: 'TESLA INC', easyScore: 4, avgWeight: 2.53, proScore: 1.12, coverage: 0.444,
      price: 406.43, weeklyPrices: [408.95, 396.68, 381.59, 399.15, 406.43], weeklyChange: -0.62, sortRank: 0, periodReturns: { '1M': -6.2, '6M': -11.4, '1Y': 24.9 },
      priceHistory: { '1W': [408.95, 396.68, 381.59, 399.15, 406.43], '1M': [433.45, 445.27, 443.3, 422.24, 409.99, 417.26, 417.85, 426.01, 433.59, 440.36, 442.1, 435.79, 415.88, 423.74, 423.7, 391, 408.95, 396.68, 381.59, 399.15, 406.43], '6M': [458.96, 481.2, 459.64, 432.96, 447.2, 431.44, 431.46, 406.01, 428.27, 411.71, 408.58, 405.55, 395.01, 392.78, 385.95, 381.26, 345.62, 388.9, 373.72, 381.63, 411.79, 443.3, 417.85, 435.79, 391, 406.43], '1Y': [325.31, 348.68, 317.66, 297.81, 310.78, 332.11, 325.59, 309.26, 339.03, 335.16, 346.6, 329.36, 346.97, 421.62, 425.85, 444.72, 453.25, 435.9, 447.43, 452.42, 468.37, 445.23, 408.92, 417.78, 429.24, 445.17, 475.31, 488.73, 454.43, 431.41, 439.2, 449.36, 416.56, 397.21, 417.07, 411.82, 408.58, 405.55, 395.01, 380.3, 372.11, 360.59, 348.95, 400.62, 376.3, 390.82, 411.79, 443.3, 417.85, 435.79, 391, 406.43] },
      velocityScore: { '1D': 12, '1W': 12, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.5T', pe: 369.5, revenueGrowth: 16, eps: 1.1, grossMargin: 19, dividendYield: null,
      etfPresence: { AIS: false, ARTY: false, BAI: 1.08, IGPT: false, IVES: 4.49, ALAI: 2.59, CHAT: false, AIFD: 1.94, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'CRDO', name: 'CREDO TECHNOLOGY GROUP HOLDING LTD', easyScore: 4, avgWeight: 2.19, proScore: 0.97, coverage: 0.444,
      ...
      etfPresence: { AIS: false, ARTY: 1.33, BAI: 2.09, IGPT: false, IVES: false, ALAI: false, CHAT: 2.25, AIFD: false, SPRX: 3.09, AOTG: false },
    ...
    {
      ticker: 'SNOW', name: 'SNOWFLAKE INC', easyScore: 4, avgWeight: 1.81, proScore: 0.8, coverage: 0.444,
      price: 232.78, weeklyPrices: [240.45, 239.66, 239.90, 240.39, 232.78], weeklyChange: -3.19, sortRank: 0, periodReturns: { '1M': 53.2, '6M': 6.8, '1Y': 11.8 },
      priceHistory: { '1W': [240.45, 239.66, 239.9, 240.39, 232.78], '1M': [151.98, 152.37, 150.76, 157.47, 164.24, 166.97, 165.54, 172.2, 177.6, 175.26, 239.2, 255.55, 280.16, 261.14, 241.28, 238.26, 240.45, 239.66, 239.9, 240.39, 232.78], '6M': [217.93, 222.46, 222.9, 234.53, 209.39, 206.5, 216, 165.29, 178.83, 179.2, 173.06, 177.45, 177.25, 173.25, 160.61, 153.12, 132.24, 143.55, 146.4, 136.47, 153.72, 150.76, 165.54, 255.55, 238.26, 232.78], '1Y': [208.18, 213.71, 223.77, 223.5, 212.79, 212.25, 218.67, 208.48, 191.8, 198.24, 194.68, 233.6, 225.56, 215.95, 223.54, 225.55, 242.52, 247.27, 245.67, 265.97, 277.14, 268.51, 252.79, 241.99, 259.68, 222.6, 215.28, 226.84, 222.05, 233.5, 206.16, 211.13, 199.37, 156.71, 172.91, 172.5, 173.06, 177.45, 177.25, 175.4, 162.33, 151.85, 121.11, 143.98, 140.32, 141, 153.72, 150.76, 165.54, 255.55, 238.26, 232.78] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$81B', pe: null, revenueGrowth: 34, eps: -3.51, grossMargin: 67, dividendYield: null,
      etfPresence: { AIS: false, ARTY: 1.23, BAI: 1.6, IGPT: false, IVES: 3.4, ALAI: 0.99, CHAT: false, AIFD: false, SPRX: false, AOTG: false },
      tonyNote: 'SNOWFLAKE INC appears in 4 of 9 AI & ML ETFs (44% coverage) with average weight 1.8% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'DDOG', name: 'DATADOG INC CLASS A', easyScore: 4, avgWeight: 1.67, proScore: 0.74, coverage: 0.444,
      ...
      etfPresence: { AIS: false, ARTY: false, BAI: 1.33, IGPT: false, IVES: 2.75, ALAI: 0.44, CHAT: false, AIFD: 2.16, SPRX: false, AOTG: false },
      tonyNote: 'DATADOG INC CLASS A appears in 4 of 9 AI & ML ETFs (44% coverage) with average weight 1.7% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
  ],
  ...
  'Semiconductors': [
    {
      ticker: 'MU', name: 'MICRON TECHNOLOGY INC', easyScore: 4, avgWeight: 6.04, proScore: 6.04, coverage: 1,
      price: 981.61, weeklyPrices: [949.28, 935.89, 891.88, 995.87, 981.61], weeklyChange: 3.41, sortRank: 0, periodReturns: { '1M': 28.1, '6M': 307.1, '1Y': 749.1 },
      priceHistory: { '1W': [949.28, 935.89, 891.88, 995.87, 981.61], '1M': [766.58, 803.63, 776.01, 724.66, 681.54, 731.99, 762.1, 751, 895.88, 928.41, 923.52, 971, 1035.5, 1064.1, 1079.57, 864.01, 949.28, 935.89, 891.88, 995.87, 981.61], '6M': [241.14, 265.92, 294.37, 343.43, 338.13, 389.11, 435.28, 379.4, 410.34, 417.35, 415.56, 397.05, 405.35, 461.73, 382.09, 367.85, 421.51, 457.23, 481.72, 517.16, 646.63, 776.01, 762.1, 971, 864.01, 981.61], '1Y': [115.6, 122.08, 123.25, 124.42, 120.11, 109.22, 111.25, 107.77, 123.72, 123.55, 116.42, 118.48, 135.24, 158.82, 166.41, 167.32, 190.96, 192.77, 206.77, 220.1, 234.7, 253.3, 241.95, 223.93, 239.49, 252.42, 237.5, 276.59, 292.63, 339.55, 333.35, 397.58, 435.79, 382.89, 413.97, 428.17, 415.56, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 455.07, 496.72, 542.21, 646.63, 776.01, 762.1, 971, 864.01, 981.61] },
      velocityScore: { '1D': -3.4, '1W': 3.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.1T', pe: 46.3, revenueGrowth: 196, eps: 21.2, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { SOXX: 11.21, PSI: 5.3, XSD: 3.63, DRAM: 4.01 },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
      ticker: 'AMD', name: 'ADVANCED MICRO DEVICES INC', easyScore: 3, avgWeight: 5.84, proScore: 4.38, coverage: 0.75,
      price: 511.57, weeklyPrices: [490.33, 475.51, 452.40, 488.45, 511.57], weeklyChange: 4.33, sortRank: 0, periodReturns: { '1M': 14.1, '6M': 142.7, '1Y': 340.4 },
      priceHistory: { '1W': [490.33, 475.51, 452.4, 488.45, 511.57], '1M': [448.29, 445.5, 449.7, 424.1, 420.99, 447.58, 449.59, 467.51, 503.89, 495.54, 518.09, 516.1, 510.13, 521.54, 542.52, 466.38, 490.33, 475.51, 452.4, 488.45, 511.57], '6M': [210.78, 213.43, 215.61, 214.35, 220.97, 249.8, 252.74, 200.19, 213.58, 203.37, 203.68, 199.45, 197.74, 199.46, 220.27, 210.21, 236.64, 278.26, 305.33, 354.49, 408.46, 449.7, 449.59, 516.1, 466.38, 511.57], '1Y': [116.16, 129.58, 141.9, 137.82, 155.61, 154.72, 173.66, 176.78, 172.28, 176.14, 163.36, 162.32, 155.82, 160.46, 160.9, 161.79, 203.71, 216.42, 240.56, 259.67, 259.65, 243.98, 240.52, 215.05, 215.24, 221.62, 207.58, 214.95, 215.34, 210.02, 223.6, 253.73, 252.18, 192.5, 205.94, 200.15, 203.68, 199.45, 197.74, 205.27, 203.77, 217.5, 245.04, 278.39, 347.81, 360.54, 408.46, 449.7, 449.59, 516.1, 466.38, 511.57] },
      velocityScore: { '1D': 2.1, '1W': -1.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$834B', pe: 169.4, revenueGrowth: 38, eps: 3.02, grossMargin: 53, dividendYield: null,
      etfPresence: { SOXX: 8.98, PSI: 4.91, XSD: 3.63, DRAM: false },
      tonyNote: 'AMD scores highest in Semiconductors at 7.0% average weight, held by 3 of 4 chip ETFs. Revenue grew 38% with 53% gross margins and EPS of $2.99 — improving but still stretched at a P/E of 172x. The 1-year return of 366% compresses future upside; the weight score says ETF managers are committed, but valuation is the variable to watch.',
    },
    {
      ticker: 'INTC', name: 'INTEL CORPORATION', easyScore: 3, avgWeight: 5.01, proScore: 3.76, coverage: 0.75,
      ...
      velocityScore: { '1D': 3.3, '1W': 11.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$626B', pe: null, revenueGrowth: 7, eps: -0.6, grossMargin: 37, dividendYield: null,
      etfPresence: { SOXX: 6.43, PSI: 4.88, XSD: 3.72, DRAM: false },
    ...
    {
      ticker: 'NVDA', name: 'NVIDIA CORP', easyScore: 3, avgWeight: 3.92, proScore: 2.94, coverage: 0.75,
      price: 205.19, weeklyPrices: [208.64, 208.19, 200.42, 204.87, 205.19], weeklyChange: -1.65, sortRank: 0, periodReturns: { '1M': -7.1, '6M': 17.2, '1Y': 44.5 },
      priceHistory: { '1W': [208.64, 208.19, 200.42, 204.87, 205.19], '1M': [220.78, 225.83, 235.74, 225.32, 222.32, 223.47, 219.51, 215.33, 214.86, 212.6, 214.25, 211.14, 224.36, 222.82, 214.75, 205.1, 208.64, 208.19, 200.42, 204.87, 205.19], '6M': [175.02, 180.99, 188.22, 187.24, 185.81, 183.32, 191.52, 174.19, 190.05, 187.9, 184.89, 183.34, 183.14, 180.4, 178.68, 175.75, 183.91, 198.35, 199.64, 199.57, 211.5, 235.74, 219.51, 211.14, 205.1, 205.19], '1Y': [141.97, 144.17, 157.99, 160, 170.7, 167.03, 176.75, 180, 182.06, 182.01, 179.81, 170.78, 170.76, 174.88, 178.43, 186.58, 185.54, 188.32, 182.64, 191.49, 206.88, 199.05, 186.6, 182.55, 181.46, 184.97, 176.29, 183.69, 187.54, 189.11, 183.14, 184.84, 192.51, 171.88, 186.94, 189.82, 184.89, 183.34, 183.14, 178.56, 171.24, 177.39, 188.63, 201.68, 208.27, 198.45, 211.5, 235.74, 219.51, 211.14, 205.1, 205.19] },
      velocityScore: { '1D': -1.7, '1W': -10.4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.0T', pe: 31.4, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.49,
      etfPresence: { SOXX: 5.46, PSI: 4.62, XSD: 1.68, DRAM: false },
      tonyNote: 'NVIDIA sits at 88% AI ETF coverage with a 5.6% average weight — the broadest institutional consensus in the theme. At a $5.1T market cap and 74% gross margin, the business is printing cash, but the 1-year return of 56% signals the easy money has been made. The score reflects the depth of institutional commitment, not a fresh entry signal.',
    },
    {
    ...
    {
      ticker: 'MRVL', name: 'MARVELL TECHNOLOGY INC', easyScore: 2, avgWeight: 6.4, proScore: 3.2, coverage: 0.5,
      price: 279.7, weeklyPrices: [288.85, 266.88, 252.59, 280.71, 279.70], weeklyChange: -3.17, sortRank: 0, periodReturns: { '1M': 70, '6M': 231.3, '1Y': 316.3 },
      priceHistory: { '1W': [288.85, 266.88, 252.59, 280.71, 279.7], '1M': [164.5, 177.95, 182.58, 176.89, 168.93, 186.8, 190.69, 196.33, 208.26, 198.7, 204.83, 205, 219.43, 290.79, 301.65, 263.47, 288.85, 266.88, 252.59, 280.71, 279.7], '6M': [84.43, 84.09, 85.76, 88.23, 83.05, 82.55, 83.62, 73.73, 81.34, 79.61, 79.29, 75.68, 87.67, 87.62, 98.45, 106.71, 119.93, 133.37, 165.56, 165.15, 160.01, 182.58, 190.69, 205, 263.47, 279.7], '1Y': [67.19, 70.78, 77.4, 71.95, 72.41, 71.99, 75.91, 76.53, 77.28, 76.74, 72.95, 64.6, 66.84, 68.86, 74.62, 84.07, 88.92, 89.39, 85.84, 88.71, 90.37, 93.23, 83.45, 83.79, 92.89, 88.9, 84.26, 84.8, 86.76, 84.64, 81.21, 83.1, 81.34, 74.21, 78.23, 79.48, 79.29, 75.68, 87.67, 89.53, 97.68, 107.11, 128.49, 139.69, 164.31, 164.95, 160.01, 182.58, 190.69, 205, 263.47, 279.7] },
      velocityScore: { '1D': -1.2, '1W': -1.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$245B', pe: 96.1, revenueGrowth: 28, eps: 2.91, grossMargin: 52, dividendYield: 0.09,
      etfPresence: { SOXX: 8.06, PSI: false, XSD: 4.73, DRAM: false },
      tonyNote: 'Marvell scores across three themes — AI, Semiconductors, and Broad Tech — at average weights of 3.7-4.7%. Revenue grew 28%, gross margin at 52%, P/E of 70x. Custom AI silicon for hyperscalers is the thesis, and the 241% 1-year return says the market is pricing it aggressively. The cross-theme ETF presence is the strongest signal of institutional conviction.',
    },
    {
    ...
    {
      ticker: 'AVGO', name: 'BROADCOM INC', easyScore: 2, avgWeight: 3.68, proScore: 1.84, coverage: 0.5,
      price: 382.07, weeklyPrices: [396.60, 392.16, 372.10, 385.57, 382.07], weeklyChange: -3.66, sortRank: 0, periodReturns: { '1M': -8.9, '6M': 6.2, '1Y': 53.6 },
      priceHistory: { '1W': [396.6, 392.16, 372.1, 385.57, 382.07], '1M': [419.3, 416.79, 439.79, 425.19, 420.71, 417.76, 414.57, 414.14, 422.01, 421.86, 426.58, 446.77, 459.97, 481.57, 479.23, 385.73, 396.6, 392.16, 372.1, 385.57, 382.07], '6M': [359.93, 340.36, 349.39, 343.77, 354.61, 328.8, 333.24, 308.05, 342.76, 333.99, 321.7, 332.77, 335.97, 315.93, 318.81, 313.49, 354.91, 398.47, 419.94, 417.43, 412.56, 439.79, 414.57, 446.77, 385.73, 382.07], '1Y': [248.7, 253.77, 275.65, 271.8, 280.94, 278.59, 294.3, 297.72, 303.9, 305.76, 294.23, 298.24, 336.67, 360, 338.94, 329.91, 335.49, 356.7, 349.24, 362.05, 362.55, 358.39, 342.65, 377.96, 381.57, 406.29, 339.81, 341.45, 349.85, 343.5, 339.89, 325.49, 330.73, 310.51, 331.17, 332.65, 321.7, 332.77, 335.97, 319.84, 309.42, 314.55, 371.55, 406.54, 422.76, 421.28, 412.56, 439.79, 414.57, 446.77, 385.73, 382.07] },
      velocityScore: { '1D': -1.6, '1W': -8.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.8T', pe: 63.7, revenueGrowth: 48, eps: 6, grossMargin: 76, dividendYield: 0.68,
      etfPresence: { SOXX: 5.63, PSI: false, XSD: 1.72, DRAM: false },
      tonyNote: 'Broadcom appears in 6 of 8 AI ETFs and 3 of 4 Semiconductor ETFs, making it one of the most consistent cross-theme holdings. Revenue grew 30%, gross margin is 77% — the highest in the theme — and it pays a 0.58% dividend. The 87x P/E is the only friction; ETF managers are paying a premium for a recurring-revenue AI infrastructure name.',
    },
    {
      ticker: 'ALAB', name: 'ASTERA LABS INC', easyScore: 2, avgWeight: 3.46, proScore: 1.73, coverage: 0.5,
      price: 367.15, weeklyPrices: [346.33, 341.70, 330.86, 367.47, 367.15], weeklyChange: 6.01, sortRank: 0, periodReturns: { '1M': 79.6, '6M': 146.7, '1Y': 309.2 },
      priceHistory: { '1W': [346.33, 341.7, 330.86, 367.47, 367.15], '1M': [204.42, 224.09, 228.64, 232.68, 215.58, 287.48, 297.84, 306.88, 318.72, 325.33, 349.17, 342.85, 320.09, 355.76, 363.54, 317.06, 346.33, 341.7, 330.86, 367.47, 367.15], '6M': [148.85, 164.4, 170.1, 161.01, 180.56, 176.01, 167.9, 144.67, 143.71, 132.62, 124.67, 120, 119.9, 126.34, 120.33, 106.33, 129.46, 170.81, 197.54, 194.74, 195.65, 228.64, 297.84, 342.85, 317.06, 367.15], '1Y': [89.73, 85.95, 90.42, 92.3, 92.36, 116.91, 124.05, 137.93, 179.43, 186.43, 174.15, 174.24, 214.49, 238.79, 230.11, 195.8, 220.81, 199.53, 156.31, 170.28, 191.56, 173.74, 141.39, 147.75, 142.94, 167.08, 143.66, 172.62, 170.84, 165.77, 172.14, 176.35, 160.46, 142.82, 126.58, 129.68, 124.67, 120, 119.9, 126.16, 113.61, 117.14, 149.05, 174.05, 212.84, 202.68, 195.65, 228.64, 297.84, 342.85, 317.06, 367.15] },
      velocityScore: { '1D': -0.6, '1W': 8.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$63B', pe: 249.8, revenueGrowth: 93, eps: 1.47, grossMargin: 76, dividendYield: null,
      etfPresence: { SOXX: 2.43, PSI: false, XSD: 4.49, DRAM: false },
      tonyNote: 'Astera Labs is a connectivity silicon company for AI data centers — high bandwidth, low latency PCIe and CXL interconnects that GPU clusters require. Revenue growth is strong and the company is one of the cleaner AI infrastructure pure-plays in the semiconductor universe; ETF managers have begun building positions but coverage is still selective.',
    },
    {
      ...
      velocityScore: { '1D': 1.4, '1W': -11, '1M': null, '6M': null }, isNew: false,
      marketCap: '$223B', pe: 22.8, revenueGrowth: -4, eps: 9.29, grossMargin: 55, dividendYield: 1.74,
      etfPresence: { SOXX: 3.5, PSI: false, XSD: 2.3, DRAM: false },
    ...
    {
      ticker: 'MPWR', name: 'MONOLITHIC POWER SYSTEMS INC', easyScore: 2, avgWeight: 2.75, proScore: 1.38, coverage: 0.5,
      ...
      etfPresence: { SOXX: 3.25, PSI: false, XSD: 2.26, DRAM: false },
    ...
    {
      ticker: 'NXPI', name: 'NXP SEMICONDUCTORS NV', easyScore: 2, avgWeight: 2.73, proScore: 1.37, coverage: 0.5,
      ...
      etfPresence: { SOXX: 3.16, PSI: false, XSD: 2.3, DRAM: false },
    ...
    {
      ticker: 'CRDO', name: 'CREDO TECHNOLOGY GROUP HOLDING LTD', easyScore: 2, avgWeight: 2.73, proScore: 1.36, coverage: 0.5,
      price: 250.81, weeklyPrices: [222.27, 234.32, 237.68, 264.76, 250.81], weeklyChange: 12.84, sortRank: 0, periodReturns: { '1M': 26.3, '6M': 74.3, '1Y': 241.3 },
      priceHistory: { '1W': [222.27, 234.32, 237.68, 264.76, 250.81], '1M': [198.57, 189.36, 184.54, 172.17, 156.27, 182.98, 193.39, 218.41, 221.64, 221.23, 222.35, 236.03, 226.1, 229, 214.6, 206.89, 222.27, 234.32, 237.68, 264.76, 250.81], '6M': [143.91, 150.13, 144.7, 132.95, 161.38, 139.16, 129.66, 96.95, 128.4, 130.66, 114.48, 114.74, 111.57, 101.72, 103.91, 95.92, 107.93, 158.93, 185.54, 174.01, 188.29, 184.54, 193.39, 236.03, 206.89, 250.81], '1Y': [73.49, 84.57, 92.59, 93.36, 102.59, 92.93, 107.95, 114.7, 118.57, 118.74, 115.41, 124.27, 149.03, 164.42, 162.26, 145.61, 147.42, 149.9, 151.66, 154.96, 180.64, 170.16, 145.58, 150.85, 188.44, 170.29, 142.02, 149.94, 144.92, 141, 156.84, 135.1, 129.47, 98.06, 121.78, 124.06, 114.48, 114.74, 111.57, 107.09, 96.44, 101.45, 119.59, 160.69, 195.04, 184.38, 188.29, 184.54, 193.39, 236.03, 206.89, 250.81] },
      velocityScore: { '1D': -2.9, '1W': 17.2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$46B', pe: 137.1, revenueGrowth: 157, eps: 1.83, grossMargin: 68, dividendYield: null,
      etfPresence: { SOXX: 1.97, PSI: false, XSD: 3.48, DRAM: false },
      tonyNote: 'Credo Technology is a high-speed connectivity semiconductor company — SerDes IP, active electrical cables, and optical DSPs for data center networking at speeds from 100G to 1.6T. Revenue grew sharply as hyperscalers upgraded networking infrastructure for AI training. The ETF weight is building as managers recognize Credo\'s position at the intersection of AI and optical networking.',
    },
    {
      ...
      etfPresence: { SOXX: 2.23, PSI: false, XSD: 2.98, DRAM: false },
    ...
    },
    {
      ...
      etfPresence: { SOXX: 2.46, PSI: false, XSD: 2.16, DRAM: false },
  ...
  'Broad Tech': [
    {
      ...
      marketCap: '$5.0T', pe: 31.4, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.49,
      etfPresence: { PTF: 4.27, WCLD: false, IGV: false, FDTX: 4.62, GTEK: false, ARKK: 1.77, MARS: false, FRWD: 8.55, BCTK: 6.5, FWD: 2.02, CBSE: false, FCUS: false, WGMI: 2.13 },
      tonyNote: 'NVIDIA sits at 88% AI ETF coverage with a 5.6% average weight — the broadest institutional consensus in the theme. At a $5.1T market cap and 74% gross margin, the business is printing cash, but the 1-year return of 56% signals the easy money has been made. The score reflects the depth of institutional commitment, not a fresh entry signal.',
    },
    {
    ...
    {
      ticker: 'TSM', name: 'Taiwan Semiconductor Manufacturing Co Ltd ADR', easyScore: 6, avgWeight: 4.1, proScore: 1.89, coverage: 0.462,
      price: 423.93, weeklyPrices: [426.80, 427.92, 408.75, 421.07, 423.93], weeklyChange: -0.67, sortRank: 0, periodReturns: { '1M': 6.7, '6M': 45.2, '1Y': 100.8 },
      priceHistory: { '1W': [426.8, 427.92, 408.75, 421.07, 423.93], '1M': [397.28, 399.8, 417.72, 404.35, 395.95, 401.62, 407.15, 404.52, 412.32, 422.73, 424.86, 418.45, 435.63, 446.69, 436.69, 415.17, 426.8, 427.92, 408.75, 421.07, 423.93], '6M': [292.04, 288.95, 300.92, 327.43, 331.21, 326.12, 342.3, 325.74, 374.09, 360.39, 376.81, 353.86, 336.71, 339.57, 347.75, 341.49, 365.49, 363.35, 382.66, 396.06, 414.15, 417.72, 407.15, 418.45, 415.17, 423.93], '1Y': [211.1, 210.32, 226.49, 227.86, 236.95, 234.6, 242.75, 239, 242.09, 241.41, 235.59, 228.39, 250.92, 262.06, 282.71, 279.29, 302.4, 302.89, 297.7, 298.25, 304.86, 295.27, 282.01, 284.64, 292.09, 303.41, 287.74, 293.28, 299.58, 318.68, 327.11, 327.37, 339.55, 330.73, 368.1, 370.54, 376.81, 353.86, 336.71, 338.79, 326.11, 339.04, 370.6, 370.5, 402.46, 397.67, 414.15, 417.72, 407.15, 418.45, 415.17, 423.93] },
      velocityScore: { '1D': -1, '1W': 14.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.2T', pe: 36.5, revenueGrowth: 35, eps: 11.62, grossMargin: 62, dividendYield: 0.9,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 6, GTEK: false, ARKK: 1.02, MARS: false, FRWD: 5.83, BCTK: 8.59, FWD: false, CBSE: 2.52, FCUS: false, WGMI: 0.62 },
      tonyNote: 'TSMC is the essential picks-and-shovels play in AI hardware, held by 4 AI ETFs at 4.23% average weight. Revenue up 35%, gross margin 62%, P/E 36x — the cleanest risk-adjusted fundamental profile in the semiconductor space. Geopolitical risk is the discount the market applies; the ETF weights say institutional managers are accepting it.',
    },
    {
      ...
      price: 511.57, weeklyPrices: [490.33, 475.51, 452.40, 488.45, 511.57], weeklyChange: 4.33, sortRank: 0, periodReturns: { '1M': 14.1, '6M': 142.7, '1Y': 340.4 },
      priceHistory: { '1W': [490.33, 475.51, 452.4, 488.45, 511.57], '1M': [448.29, 445.5, 449.7, 424.1, 420.99, 447.58, 449.59, 467.51, 503.89, 495.54, 518.09, 516.1, 510.13, 521.54, 542.52, 466.38, 490.33, 475.51, 452.4, 488.45, 511.57], '6M': [210.78, 213.43, 215.61, 214.35, 220.97, 249.8, 252.74, 200.19, 213.58, 203.37, 203.68, 199.45, 197.74, 199.46, 220.27, 210.21, 236.64, 278.26, 305.33, 354.49, 408.46, 449.7, 449.59, 516.1, 466.38, 511.57], '1Y': [116.16, 129.58, 141.9, 137.82, 155.61, 154.72, 173.66, 176.78, 172.28, 176.14, 163.36, 162.32, 155.82, 160.46, 160.9, 161.79, 203.71, 216.42, 240.56, 259.67, 259.65, 243.98, 240.52, 215.05, 215.24, 221.62, 207.58, 214.95, 215.34, 210.02, 223.6, 253.73, 252.18, 192.5, 205.94, 200.15, 203.68, 199.45, 197.74, 205.27, 203.77, 217.5, 245.04, 278.39, 347.81, 360.54, 408.46, 449.7, 449.59, 516.1, 466.38, 511.57] },
      velocityScore: { '1D': -0.6, '1W': -6.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$834B', pe: 169.4, revenueGrowth: 38, eps: 3.02, grossMargin: 53, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: false, GTEK: false, ARKK: 4.95, MARS: false, FRWD: 6.98, BCTK: 3.76, FWD: 1.98, CBSE: false, FCUS: 3.05, WGMI: false },
      tonyNote: 'AMD scores highest in Semiconductors at 7.0% average weight, held by 3 of 4 chip ETFs. Revenue grew 38% with 53% gross margins and EPS of $2.99 — improving but still stretched at a P/E of 172x. The 1-year return of 366% compresses future upside; the weight score says ETF managers are committed, but valuation is the variable to watch.',
    },
    {
      ...
      price: 382.07, weeklyPrices: [396.60, 392.16, 372.10, 385.57, 382.07], weeklyChange: -3.66, sortRank: 0, periodReturns: { '1M': -8.9, '6M': 6.2, '1Y': 53.6 },
      priceHistory: { '1W': [396.6, 392.16, 372.1, 385.57, 382.07], '1M': [419.3, 416.79, 439.79, 425.19, 420.71, 417.76, 414.57, 414.14, 422.01, 421.86, 426.58, 446.77, 459.97, 481.57, 479.23, 385.73, 396.6, 392.16, 372.1, 385.57, 382.07], '6M': [359.93, 340.36, 349.39, 343.77, 354.61, 328.8, 333.24, 308.05, 342.76, 333.99, 321.7, 332.77, 335.97, 315.93, 318.81, 313.49, 354.91, 398.47, 419.94, 417.43, 412.56, 439.79, 414.57, 446.77, 385.73, 382.07], '1Y': [248.7, 253.77, 275.65, 271.8, 280.94, 278.59, 294.3, 297.72, 303.9, 305.76, 294.23, 298.24, 336.67, 360, 338.94, 329.91, 335.49, 356.7, 349.24, 362.05, 362.55, 358.39, 342.65, 377.96, 381.57, 406.29, 339.81, 341.45, 349.85, 343.5, 339.89, 325.49, 330.73, 310.51, 331.17, 332.65, 321.7, 332.77, 335.97, 319.84, 309.42, 314.55, 371.55, 406.54, 422.76, 421.28, 412.56, 439.79, 414.57, 446.77, 385.73, 382.07] },
      velocityScore: { '1D': 5.6, '1W': 1.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.8T', pe: 63.7, revenueGrowth: 48, eps: 6, grossMargin: 76, dividendYield: 0.68,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 0.79, GTEK: false, ARKK: 1.19, MARS: false, FRWD: 5.39, BCTK: 7.31, FWD: 2.43, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'Broadcom appears in 6 of 8 AI ETFs and 3 of 4 Semiconductor ETFs, making it one of the most consistent cross-theme holdings. Revenue grew 30%, gross margin is 77% — the highest in the theme — and it pays a 0.58% dividend. The 87x P/E is the only friction; ETF managers are paying a premium for a recurring-revenue AI infrastructure name.',
    },
    {
    ...
    {
      ticker: 'AMZN', name: 'Amazon.com Inc', easyScore: 4, avgWeight: 3.53, proScore: 1.09, coverage: 0.308,
      price: 238.55, weeklyPrices: [245.22, 244.19, 238.00, 241.51, 238.55], weeklyChange: -2.72, sortRank: 0, periodReturns: { '1M': -10.3, '6M': 5.5, '1Y': 12.5 },
      priceHistory: { '1W': [245.22, 244.19, 238, 241.51, 238.55], '1M': [265.82, 270.13, 267.22, 264.14, 264.86, 265.01, 268.46, 266.32, 265.29, 271.85, 274, 270.64, 261.26, 256.52, 250.02, 246.03, 245.22, 244.19, 238, 241.51, 238.55], '6M': [226.19, 227.35, 232.07, 240.93, 242.6, 231.31, 243.01, 232.99, 204.08, 204.86, 207.92, 218.94, 209.53, 209.87, 211.71, 210.57, 233.65, 249.7, 255.08, 265.06, 271.17, 267.22, 268.46, 270.64, 246.03, 238.55], '1Y': [212.1, 208.47, 219.39, 219.36, 226.35, 227.47, 232.79, 211.65, 221.3, 231.49, 227.94, 225.34, 238.24, 234.05, 220.71, 219.57, 220.9, 220.07, 216.48, 226.97, 254, 248.4, 232.87, 226.28, 234.42, 227.92, 222.54, 228.43, 232.53, 241.56, 236.65, 234.34, 241.73, 222.69, 199.6, 210.11, 207.92, 218.94, 209.53, 208.76, 207.54, 209.77, 238.38, 250.56, 263.99, 268.26, 271.17, 267.22, 268.46, 270.64, 246.03, 238.55] },
      velocityScore: { '1D': -2.7, '1W': -10.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.6T', pe: 31.6, revenueGrowth: 17, eps: 7.54, grossMargin: 51, dividendYield: null,
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 4.01, GTEK: false, ARKK: 2.6, MARS: false, FRWD: 3, BCTK: 4.5, FWD: false, CBSE: false, FCUS: false, WGMI: false },
      tonyNote: 'Amazon is a selective AI holding — 3 of 8 ETFs, 4.7% average weight — positioned on AWS rather than hardware. Revenue growth of 17% looks modest against pure-play AI names, but 51% gross margin and a $2.9T market cap reflect the cloud platform advantage. The 32% 1-year return underperforms the theme; ETF managers hold it as a diversifier, not a conviction AI bet.',
    },
    {
      ...
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 2.89, GTEK: false, ARKK: 4.53, MARS: false, FRWD: 1.96, BCTK: 2.72, FWD: false, CBSE: false, FCUS: false, WGMI: false },
    ...
    },
    {
      ...
      etfPresence: { PTF: false, WCLD: false, IGV: 6.81, FDTX: 2.87, GTEK: false, ARKK: 3.04, MARS: false, FRWD: false, BCTK: false, FWD: false, CBSE: false, FCUS: false, WGMI: false },
    ...
    {
      ticker: 'GOOG', name: 'Alphabet Inc Class C', easyScore: 3, avgWeight: 3.78, proScore: 0.87, coverage: 0.231,
      ...
      etfPresence: { PTF: false, WCLD: false, IGV: false, FDTX: 3.66, GTEK: false, ARKK: 1.95, MARS: false, FRWD: false, BCTK: 5.74, FWD: false, CBSE: false, FCUS: false, WGMI: false },
  ...
  'Electrification': [
    {
      ticker: 'BE', name: 'BLOOM ENERGY CORP', easyScore: 3, avgWeight: 3.57, proScore: 2.68, coverage: 0.75,
      ...
      velocityScore: { '1D': 25.8, '1W': 27, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'PWR', name: 'QUANTA SERVICES INC', easyScore: 2, avgWeight: 4.96, proScore: 2.48, coverage: 0.5,
      ...
      velocityScore: { '1D': -14.2, '1W': 34.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$106B', pe: 97.1, revenueGrowth: 26, eps: 7.29, grossMargin: 15, dividendYield: 0.06,
      etfPresence: { POW: false, VOLT: 5.5, PBD: false, PBW: false, IVEP: 4.41 },
    ...
    {
      ticker: 'POWL', name: 'POWELL INDUSTRIES INC', easyScore: 2, avgWeight: 4.73, proScore: 2.37, coverage: 0.5,
      ...
      velocityScore: { '1D': -28.4, '1W': -9.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$11B', pe: 57.5, revenueGrowth: 7, eps: 5.13, grossMargin: 30, dividendYield: 0.12,
      etfPresence: { POW: false, VOLT: 7.59, PBD: false, PBW: 1.88, IVEP: false },
    ...
    {
      ticker: 'ETN', name: 'EATON CORP PLC', easyScore: 2, avgWeight: 4.54, proScore: 2.27, coverage: 0.5,
      ...
      velocityScore: { '1D': -15, '1W': 26.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$152B', pe: 38.3, revenueGrowth: 17, eps: 10.22, grossMargin: 37, dividendYield: 1.12,
      etfPresence: { POW: false, VOLT: 5.21, PBD: false, PBW: false, IVEP: 3.88 },
    ...
    {
      ticker: 'NEE', name: 'NEXTERA ENERGY INC', easyScore: 2, avgWeight: 4.34, proScore: 2.17, coverage: 0.5,
      ...
      velocityScore: { '1D': 4.8, '1W': 59.6, '1M': null, '6M': null }, isNew: false,
      marketCap: '$179B', pe: 21.8, revenueGrowth: 7, eps: 3.94, grossMargin: 61, dividendYield: 2.9,
      etfPresence: { POW: false, VOLT: 5.03, PBD: false, PBW: false, IVEP: 3.65 },
    ...
    {
      ticker: 'GEV', name: 'GE VERNOVA INC', easyScore: 2, avgWeight: 3.84, proScore: 1.92, coverage: 0.5,
      ...
      velocityScore: { '1D': -10.7, '1W': 45.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$253B', pe: 27.5, revenueGrowth: 16, eps: 34.24, grossMargin: 20, dividendYield: 0.21,
      etfPresence: { POW: false, VOLT: 3.89, PBD: false, PBW: false, IVEP: 3.8 },
    ...
    {
      ticker: 'VRT', name: 'VERTIV HOLDINGS CO', easyScore: 2, avgWeight: 3.2, proScore: 1.6, coverage: 0.5,
      ...
      velocityScore: { '1D': 25, '1W': null, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'NVT', name: 'NVENT ELECTRIC PLC', easyScore: 2, avgWeight: 3.19, proScore: 1.59, coverage: 0.5,
      ...
      etfPresence: { POW: false, VOLT: 3.12, PBD: false, PBW: false, IVEP: 3.25 },
    ...
    {
      ticker: 'HUBB', name: 'HUBBELL INC', easyScore: 2, avgWeight: 2.86, proScore: 1.43, coverage: 0.5,
      ...
      velocityScore: { '1D': -16.9, '1W': 27.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$25B', pe: 28.2, revenueGrowth: 11, eps: 16.93, grossMargin: 36, dividendYield: 1.19,
      etfPresence: { POW: false, VOLT: 3.27, PBD: false, PBW: false, IVEP: 2.45 },
    ...
    {
      ticker: 'JCI', name: 'JOHNSON CONTROLS INTERNATIONAL PLC', easyScore: 2, avgWeight: 2.58, proScore: 1.29, coverage: 0.5,
      ...
      tonyNote: 'JOHNSON CONTROLS INTERNATIONAL PLC appears in 2 of 4 Electrification ETFs (50% coverage) with average weight 2.6% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'WMB', name: 'WILLIAMS COS INC/THE', easyScore: 2, avgWeight: 2.57, proScore: 1.29, coverage: 0.5,
      ...
      tonyNote: 'WILLIAMS COS INC/THE appears in 2 of 4 Electrification ETFs (50% coverage) with average weight 2.6% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'BWXT', name: 'BWX TECHNOLOGIES INC', easyScore: 2, avgWeight: 2.12, proScore: 1.06, coverage: 0.5,
      ...
      velocityScore: { '1D': 23.3, '1W': null, '1M': null, '6M': null }, isNew: false,
    ...
    {
      ticker: 'NRG', name: 'NRG ENERGY INC', easyScore: 2, avgWeight: 1.55, proScore: 0.78, coverage: 0.5,
      ...
      velocityScore: { '1D': 8.3, '1W': null, '1M': null, '6M': null }, isNew: false,
      marketCap: '$26B', pe: 136.4, revenueGrowth: 20, eps: 0.92, grossMargin: 16, dividendYield: 1.51,
      etfPresence: { POW: false, VOLT: 0.92, PBD: false, PBW: false, IVEP: 2.19 },
      tonyNote: 'NRG ENERGY INC appears in 2 of 4 Electrification ETFs (50% coverage) with average weight 1.6% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'SHLS', name: 'Shoals Technologies Group Inc', easyScore: 2, avgWeight: 1.53, proScore: 0.77, coverage: 0.5,
      price: 10.43, weeklyPrices: [10.88, 9.63, 9.25, 9.89, 10.43], weeklyChange: -4.14, sortRank: 0, periodReturns: { '1M': 20.9, '6M': 17.9, '1Y': 104.1 },
      priceHistory: { '1W': [10.88, 9.63, 9.25, 9.89, 10.43], '1M': [8.63, 9.11, 9.28, 10.33, 9.66, 9.68, 9.55, 9.91, 10.82, 12.12, 12.2, 12.45, 12.18, 12.46, 12.39, 10.81, 10.88, 9.63, 9.25, 9.89, 10.43], '6M': [8.85, 8.96, 8.96, 9.24, 9.65, 9.05, 10.15, 10.18, 9.79, 10.19, 6.35, 5.85, 6.12, 5.95, 6.91, 6.9, 6.97, 6.92, 7.78, 7.94, 7.84, 9.28, 9.55, 12.45, 10.81, 10.43], '1Y': [5.11, 4.95, 4.25, 5.72, 5.83, 6, 5.83, 5.38, 4.46, 6.04, 6.8, 6.72, 6.65, 7.11, 7.2, 7.41, 8.74, 9.25, 10.54, 10.54, 10.34, 9.39, 7.95, 7.76, 7.82, 8.08, 8.67, 9.32, 8.57, 8.84, 9.14, 9.66, 10.02, 9.65, 9.66, 10.61, 6.35, 5.85, 6.12, 6.04, 6.47, 6.82, 6.98, 7.16, 7.93, 8.16, 7.84, 9.28, 9.55, 12.45, 10.81, 10.43] },
      velocityScore: { '1D': null, '1W': -26, '1M': null, '6M': null }, isNew: true,
      marketCap: '$2B', pe: 52.1, revenueGrowth: 75, eps: 0.2, grossMargin: 33, dividendYield: null,
      etfPresence: { POW: false, VOLT: false, PBD: 1.09, PBW: 1.97, IVEP: false },
      tonyNote: 'Shoals Technologies Group Inc appears in 2 of 4 Electrification ETFs (50% coverage) with average weight 1.5% — moderate conviction across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
    {
      ticker: 'BELFB', name: 'BEL FUSE INC', easyScore: 1, avgWeight: 7.85, proScore: 1.96, coverage: 0.25,
      ...
      velocityScore: { '1D': -15.5, '1W': -18, '1M': null, '6M': null }, isNew: false,
      marketCap: '$4B', pe: 71, revenueGrowth: 17, eps: 4.14, grossMargin: 39, dividendYield: 0.1,
      etfPresence: { POW: false, VOLT: 7.85, PBD: false, PBW: false, IVEP: false },
    ...
    {
      ticker: 'HYLN', name: 'Hyliion Holdings Corp', easyScore: 1, avgWeight: 4.6, proScore: 1.15, coverage: 0.25,
      price: 7.4, weeklyPrices: [7.22, 6.34, 6.92, 7.51, 7.40], weeklyChange: 2.49, sortRank: 0, periodReturns: { '1M': 176.1, '6M': 281.4, '1Y': 410.3 },
      priceHistory: { '1W': [7.22, 6.34, 6.92, 7.51, 7.4], '1M': [2.68, 3.59, 3.69, 4.67, 4.2, 4.09, 4.2, 5.99, 6.6, 6.94, 7.19, 6.99, 6.25, 6.79, 6.46, 6.9, 7.22, 6.34, 6.92, 7.51, 7.4], '6M': [1.94, 1.86, 1.93, 1.94, 2.08, 2.16, 2.1, 2.07, 2.05, 2.06, 2.15, 2.01, 2.08, 1.91, 1.89, 1.75, 1.81, 1.92, 1.89, 1.91, 2.47, 3.69, 4.2, 6.99, 6.9, 7.4], '1Y': [1.45, 1.41, 1.32, 1.43, 1.45, 1.66, 1.63, 1.49, 1.57, 1.65, 1.76, 1.61, 1.61, 1.82, 2.14, 1.97, 2.07, 2.38, 2.13, 2.22, 2.2, 2.06, 1.64, 1.78, 1.81, 1.92, 1.84, 1.93, 1.9, 1.94, 2.1, 2.27, 2.13, 1.87, 1.99, 2.01, 2.15, 2.01, 2.08, 1.9, 1.78, 1.72, 1.84, 2, 1.92, 2.04, 2.47, 3.69, 4.2, 6.99, 6.9, 7.4] },
      velocityScore: { '1D': null, '1W': -17.9, '1M': null, '6M': null }, isNew: true,
      marketCap: '$1B', pe: null, revenueGrowth: 479, eps: -0.3, grossMargin: 6, dividendYield: null,
      etfPresence: { POW: false, VOLT: false, PBD: false, PBW: 4.6, IVEP: false },
    ...
    {
      ticker: 'AEIS', name: 'ADVANCED ENERGY INDUSTRIES INC', easyScore: 1, avgWeight: 4.51, proScore: 1.13, coverage: 0.25,
      ...
      velocityScore: { '1D': 3.7, '1W': -11.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$14B', pe: 73.5, revenueGrowth: 26, eps: 4.82, grossMargin: 39, dividendYield: 0.11,
      etfPresence: { POW: false, VOLT: 4.51, PBD: false, PBW: false, IVEP: false },
    ...
    {
      ticker: 'APH', name: 'AMPHENOL CORP', easyScore: 1, avgWeight: 4.27, proScore: 1.07, coverage: 0.25,
      ...
      velocityScore: { '1D': 0.9, '1W': -18.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$189B', pe: 44.2, revenueGrowth: 58, eps: 3.48, grossMargin: 38, dividendYield: 0.65,
      etfPresence: { POW: false, VOLT: 4.27, PBD: false, PBW: false, IVEP: false },
    ...
    {
      ticker: 'AEP', name: 'AMERICAN ELECTRIC POWER CO INC', easyScore: 1, avgWeight: 4.25, proScore: 1.06, coverage: 0.25,
      ...
      velocityScore: { '1D': -7, '1W': -26.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$70B', pe: 19.1, revenueGrowth: 10, eps: 6.76, grossMargin: 47, dividendYield: 2.94,
      etfPresence: { POW: false, VOLT: 4.25, PBD: false, PBW: false, IVEP: false },
    ...
    {
      ticker: 'COHR', name: 'COHERENT CORP', easyScore: 1, avgWeight: 4.09, proScore: 1.02, coverage: 0.25,
      price: 385.03, weeklyPrices: [401.93, 355.94, 354.77, 363.58, 385.03], weeklyChange: -4.2, sortRank: 0, periodReturns: { '1M': 2.9, '6M': 115.9, '1Y': 397.6 },
      priceHistory: { '1W': [401.93, 355.94, 354.77, 363.58, 385.03], '1M': [374.01, 403.71, 404.94, 382.45, 362.83, 358.5, 378, 377.57, 381.35, 380.18, 376.95, 361.47, 362.9, 426.89, 417.43, 376.99, 401.93, 355.94, 354.77, 363.58, 385.03], '6M': [178.34, 185.83, 189.02, 194.11, 190.03, 201.46, 221.14, 211, 223.69, 232.48, 250.14, 253.87, 241.27, 257.21, 272.04, 247.8, 284.17, 328, 337.68, 319.71, 319.19, 404.94, 378, 361.47, 376.99, 385.03], '1Y': [77.37, 80.64, 89.21, 90.4, 96.07, 97.02, 104.3, 106.74, 113.6, 90.49, 90.5, 87.8, 99.22, 104.47, 109.29, 107.72, 114.77, 115.13, 120.2, 134.99, 132, 166.72, 139.07, 151.81, 164.89, 192.73, 178.45, 190.98, 186.81, 191.62, 184.11, 202.72, 215.86, 209.24, 216.1, 248.18, 250.14, 253.87, 241.27, 275.57, 243.29, 258.16, 307.5, 345.02, 336.09, 329.5, 319.19, 404.94, 378, 361.47, 376.99, 385.03] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$75B', pe: 181.6, revenueGrowth: 21, eps: 2.12, grossMargin: 37, dividendYield: null,
      etfPresence: { POW: false, VOLT: false, PBD: false, PBW: false, IVEP: 4.09 },
      tonyNote: 'COHERENT CORP appears in 1 of 4 Electrification ETFs (25% coverage) with average weight 4.1% — selective across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
  ],
  ...
  'Meme': [
    {
      ticker: 'NBIS', name: 'Nebius Group', easyScore: 3, avgWeight: 4.44, proScore: 4.44, coverage: 1,
      price: 232.36, weeklyPrices: [218.00, 220.12, 211.69, 222.24, 232.36], weeklyChange: 6.59, sortRank: 0, periodReturns: { '1M': 29.7, '6M': 165, '1Y': 393 },
      priceHistory: { '1W': [218, 220.12, 211.69, 222.24, 232.36], '1M': [179.11, 207.27, 221.15, 219.94, 199.86, 191.82, 219.93, 214.77, 208.06, 208.37, 226.34, 231.09, 264.51, 260.58, 251.68, 227.81, 218, 220.12, 211.69, 222.24, 232.36], '6M': [87.69, 89.46, 86.04, 100.24, 105.43, 98.87, 100.43, 82.39, 88.61, 107.61, 104.88, 95.65, 108.04, 118.56, 115.09, 101.95, 136.33, 165.34, 157.08, 138.23, 184.77, 221.15, 219.93, 231.09, 227.81, 232.36], '1Y': [47.13, 47.48, 55.33, 47.1, 53.53, 51.01, 52.75, 54.17, 70.24, 72.54, 70.02, 65.72, 95.72, 89.43, 107.8, 112.27, 124.94, 135.46, 109, 125.43, 120.47, 109.95, 85.98, 91.9, 96.45, 96.41, 81.14, 93.23, 85.17, 96.21, 101.98, 96.85, 94.91, 73.87, 89.73, 97.92, 104.88, 95.65, 108.04, 121.52, 105.97, 108.82, 144.97, 157.14, 147.16, 154.49, 184.77, 221.15, 219.93, 231.09, 227.81, 232.36] },
      velocityScore: { '1D': 1.8, '1W': -4.7, '1M': null, '6M': null }, isNew: false,
      marketCap: '$59B', pe: 90.1, revenueGrowth: 684, eps: 2.58, grossMargin: 72, dividendYield: null,
      etfPresence: { BUZZ: 3.02, MEME: 5.47, RKNG: 4.82 },
      tonyNote: 'Nebius is the highest-growth name in the AI theme — 684% revenue growth, 72% gross margin, held by 3 ETFs. At $59B market cap and a P/E of 89x, it is pricing in continued hypergrowth. The 529% 1-year return is extraordinary for a name this size; the 38% ETF coverage says a minority of AI ETF managers are taking the bet, and those who did have been well rewarded.',
    },
    {
      ...
      etfPresence: { BUZZ: 3.33, MEME: 5.67, RKNG: 2.6 },
    ...
    {
      ticker: 'IREN', name: 'IREN Ltd', easyScore: 3, avgWeight: 3.83, proScore: 3.83, coverage: 1,
      ...
      velocityScore: { '1D': 37.3, '1W': 34.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$21B', pe: 77.6, revenueGrowth: 0, eps: 0.77, grossMargin: 68, dividendYield: null,
      etfPresence: { BUZZ: 2.78, MEME: 5.52, RKNG: 3.18 },
    ...
    },
    {
      ...
      velocityScore: { '1D': -2.4, '1W': 0.3, '1M': null, '6M': null }, isNew: false,
      marketCap: '$12B', pe: null, revenueGrowth: 139, eps: -0.38, grossMargin: 45, dividendYield: null,
      etfPresence: { BUZZ: 2.26, MEME: 5.09, RKNG: 3.67 },
    ...
    {
      ticker: 'RKLB', name: 'Rocket Lab', easyScore: 3, avgWeight: 3.65, proScore: 3.65, coverage: 1,
      ...
      velocityScore: { '1D': 1.7, '1W': 2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$64B', pe: null, revenueGrowth: 64, eps: -0.32, grossMargin: 37, dividendYield: null,
      etfPresence: { BUZZ: 1.92, MEME: 5.07, RKNG: 3.95 },
    ...
    {
      ticker: 'MU', name: 'MU', easyScore: 2, avgWeight: 4.53, proScore: 3.02, coverage: 0.667,
      price: 981.61, weeklyPrices: [949.28, 935.89, 891.88, 995.87, 981.61], weeklyChange: 3.41, sortRank: 0, periodReturns: { '1M': 28.1, '6M': 307.1, '1Y': 749.1 },
      priceHistory: { '1W': [949.28, 935.89, 891.88, 995.87, 981.61], '1M': [766.58, 803.63, 776.01, 724.66, 681.54, 731.99, 762.1, 751, 895.88, 928.41, 923.52, 971, 1035.5, 1064.1, 1079.57, 864.01, 949.28, 935.89, 891.88, 995.87, 981.61], '6M': [241.14, 265.92, 294.37, 343.43, 338.13, 389.11, 435.28, 379.4, 410.34, 417.35, 415.56, 397.05, 405.35, 461.73, 382.09, 367.85, 421.51, 457.23, 481.72, 517.16, 646.63, 776.01, 762.1, 971, 864.01, 981.61], '1Y': [115.6, 122.08, 123.25, 124.42, 120.11, 109.22, 111.25, 107.77, 123.72, 123.55, 116.42, 118.48, 135.24, 158.82, 166.41, 167.32, 190.96, 192.77, 206.77, 220.1, 234.7, 253.3, 241.95, 223.93, 239.49, 252.42, 237.5, 276.59, 292.63, 339.55, 333.35, 397.58, 435.79, 382.89, 413.97, 428.17, 415.56, 397.05, 405.35, 444.27, 355.46, 366.24, 420.59, 455.07, 496.72, 542.21, 646.63, 776.01, 762.1, 971, 864.01, 981.61] },
      velocityScore: { '1D': -1.6, '1W': 2, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.1T', pe: 46.3, revenueGrowth: 196, eps: 21.2, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { BUZZ: 3.63, MEME: false, RKNG: 5.43 },
      tonyNote: 'Micron is the top-ranked AI hardware name on the weight score, held by 7 of 8 AI ETFs and all 4 Semiconductor ETFs at average weights above 6.7%. Revenue grew 196% year-over-year, gross margin is at 58% and expanding, and EPS hit $21.17 — the fundamentals back up the institutional conviction. The 1-year return of 928% is not a typo; HBM memory demand from data center AI build-outs is the driver, and the ETF managers are positioned accordingly.',
    },
    {
    ...
    {
      ticker: 'IONQ', name: 'IonQ', easyScore: 2, avgWeight: 3.47, proScore: 2.32, coverage: 0.667,
      price: 57.85, weeklyPrices: [62.80, 56.69, 56.63, 57.99, 57.85], weeklyChange: -7.88, sortRank: 0, periodReturns: { '1M': 3.5, '6M': 14.9, '1Y': 52.9 },
      priceHistory: { '1W': [62.8, 56.69, 56.63, 57.99, 57.85], '1M': [55.87, 55.26, 57.47, 51.95, 49.31, 52.47, 58.89, 63.64, 63.62, 65.4, 70.14, 72.07, 69.28, 71.4, 68.23, 56.78, 62.8, 56.69, 56.63, 57.99, 57.85], '6M': [50.35, 48.48, 45.25, 50.76, 48.94, 48.33, 45.8, 35.34, 33.61, 33.43, 40.88, 36.02, 33.03, 32.38, 31.96, 27.79, 28.08, 44.68, 43.63, 45.12, 47.68, 57.47, 58.89, 72.07, 56.78, 57.85], '1Y': [37.84, 41.14, 42.97, 44.97, 41.47, 41.94, 42.34, 39.86, 44.94, 40.23, 38.68, 42.99, 44, 62.26, 75.14, 61.5, 78.99, 82.09, 59.94, 62.8, 58.4, 55.37, 47.79, 46.76, 46.93, 54.44, 46.07, 53.86, 45.31, 49.78, 50.88, 49.33, 43.24, 30.43, 31.3, 31.9, 40.88, 36.02, 33.03, 31.9, 29.84, 29.3, 28.79, 46.09, 42.69, 46.2, 47.68, 57.47, 58.89, 72.07, 56.78, 57.85] },
      ...
      etfPresence: { BUZZ: 1.9, MEME: 5.05, RKNG: false },
    ...
    },
    {
      ...
      price: 59.38, weeklyPrices: [57.22, 58.58, 54.65, 58.60, 59.38], weeklyChange: 3.77, sortRank: 0, periodReturns: { '1M': 76.6, '6M': 287.3, '1Y': 291.4 },
      priceHistory: { '1W': [57.22, 58.58, 54.65, 58.6, 59.38], '1M': [33.63, 38.5, 37.99, 37.23, 36.95, 40.16, 42.17, 47.25, 50.37, 48.9, 52.24, 52.05, 55.99, 62.49, 63.97, 57.2, 57.22, 58.58, 54.65, 58.6, 59.38], '6M': [15.33, 14.87, 14.9, 16.56, 16, 19.05, 19.27, 19.86, 20.19, 19.71, 19.45, 17.13, 17.15, 17.49, 18.29, 18.41, 21.33, 26.25, 27.33, 28.97, 32.59, 37.99, 42.17, 52.05, 57.2, 59.38], '1Y': [15.17, 15.39, 15.88, 17.35, 16.99, 17.52, 17.06, 16.18, 13.97, 14.76, 15.3, 14.85, 15.25, 15.2, 15.21, 15.3, 16.08, 15.88, 17.5, 17.34, 16.78, 14.68, 12.65, 12.85, 14.05, 15.35, 15.15, 14.93, 14.78, 16.2, 17.05, 19.08, 20.17, 19.65, 19.38, 19.67, 19.45, 17.13, 17.15, 17.73, 17.47, 18.58, 22.47, 25.92, 28.19, 29.58, 32.59, 37.99, 42.17, 52.05, 57.2, 59.38] },
      velocityScore: { '1D': null, '1W': null, '1M': null, '6M': null }, isNew: true,
      marketCap: '$8B', pe: 5938, revenueGrowth: 17, eps: 0.01, grossMargin: 20, dividendYield: 0.67,
    ...
    },
    {
      ...
      price: 55.26, weeklyPrices: [55.26], weeklyChange: -2.18, sortRank: 0, periodReturns: { '1M': 0, '6M': 0, '1Y': 0 },
    ...
    {
      ticker: 'WULF', name: 'WULF', easyScore: 1, avgWeight: 4.05, proScore: 1.35, coverage: 0.333,
      ...
      tonyNote: 'WULF appears in 1 of 3 Meme ETFs (33% coverage) with average weight 4.0% — selective across the institutional products tracked. Analysis pending — check back for Tony\'s full thesis.',
    },
  ],
