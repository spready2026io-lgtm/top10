...
export const SCAN_TIMESTAMP    = '2026-06-18T22:26:10.633Z';
export const SCAN_TIMESTAMP_NY = 'June 18, 2026 at 6:26 PM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 14.75, bestProScore: 6.24, avgProScore: 4.92, price: 1133.99, weeklyChange: 15.52 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.12, bestProScore: 6.00, avgProScore: 3.71, price: 210.69, weeklyChange: 2.68 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 10.98, bestProScore: 4.98, avgProScore: 3.66, price: 537.37, weeklyChange: 5.04 },
  { ticker: 'AVGO', name: `Broadcom Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 5.80, bestProScore: 2.74, avgProScore: 1.93, price: 411.35, weeklyChange: 7.66 },
  { ticker: 'MRVL', name: `MARVELL TECHNOLOGY INC`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 6.03, bestProScore: 3.30, avgProScore: 3.01, price: 310.58, weeklyChange: 11.04 },
  { ticker: 'POWL', name: `Powell Industries, Inc.`, themeCount: 2, themes: ['Electrification', 'Industrials'], aggregateScore: 5.25, bestProScore: 3.15, avgProScore: 2.63, price: 297.20, weeklyChange: 0.83 },
  { ticker: 'INTC', name: `INTEL CORPORATION`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 5.14, bestProScore: 3.71, avgProScore: 2.57, price: 133.99, weeklyChange: 7.56 },
  { ticker: 'TSM', name: `Taiwan Semiconductor Manufacturing Co Ltd ADR`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 4.66, bestProScore: 2.84, avgProScore: 2.33, price: 462.12, weeklyChange: 9.01 },
  { ticker: 'LRCX', name: `LAM RESEARCH CORP`, themeCount: 2, themes: ['Semiconductors', 'Broad Tech'], aggregateScore: 3.62, bestProScore: 2.34, avgProScore: 1.81, price: 389.04, weeklyChange: 6.06 },
  { ticker: 'WDC', name: `Western Digital Corp`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 3.36, bestProScore: 1.85, avgProScore: 1.68, price: 746.23, weeklyChange: 32.56 },
];
...
export const SAMPLE_DATA: Record<Theme, Equity[]> = {
  ...
  'Electrification': [
    ...
    },
    {
      ...
      price: 93.09, weeklyPrices: [94.00, 93.82, 94.31, 92.53, 93.09], weeklyChange: -0.97, dayChange: 0.61, sortRank: 0, periodReturns: { '1M': -0.7, '6M': 6.7, '1Y': 4.2 },
      priceHistory: { '1D': [92.53, 93.14, 92.9, 93.05, 93.42, 93.79, 93.99, 93.82, 94, 93.99, 94, 93.89, 93.95, 93.78, 93.75, 93.17, 93.22, 93.34, 93.37, 93.13, 92.77, 92.98, 92.73, 93.09], '1W': [94, 93.82, 94.31, 92.53, 93.09], '1M': [93.71, 94.14, 93.62, 94.24, 94.55, 93.74, 92.52, 92.05, 89.03, 90.51, 90.49, 91.62, 92.6, 91.28, 92.95, 93.27, 94, 93.82, 94.31, 92.53, 93.09], '6M': [87.22, 87.17, 86.87, 86.74, 88.82, 88.84, 90.13, 90.72, 91.04, 95.92, 97.63, 96.26, 96.54, 93.98, 96.52, 97.17, 94.64, 91.87, 93.51, 93.51, 93.14, 93.62, 92.52, 91.62, 93.27, 93.09], '1Y': [89.3, 90.9, 91.66, 92.68, 94.79, 94.3, 94.99, 94.69, 94.07, 94.48, 92.3, 90.83, 92.28, 92.33, 93.91, 95.49, 98.29, 97.8, 95.88, 94.04, 91.44, 90.69, 89.27, 89.01, 85.56, 86, 85.28, 87.54, 87.52, 87.55, 89.15, 88.33, 90.29, 90.86, 95.05, 96.35, 97.63, 96.26, 96.54, 94.61, 96.94, 97.59, 94.9, 93.91, 96.7, 92.43, 93.14, 93.62, 92.52, 91.62, 93.27, 93.09] },
      velocityScore: { '1D': -1.3, '1W': null, '1M': null, '6M': null }, isNew: false,
    ...
    },
    {
      ...
      price: 77.41, weeklyPrices: [79.22, 79.35, 78.98, 77.46, 77.41], weeklyChange: -2.28, dayChange: -0.06, sortRank: 0, periodReturns: { '1M': -0.9, '6M': 5.2, '1Y': 16.2 },
      priceHistory: { '1D': [77.46, 77.98, 77.81, 77.77, 78.05, 78.3, 78.5, 78.35, 78.39, 78.48, 78.39, 78.15, 78.21, 78.1, 77.93, 77.25, 77.31, 77.39, 77.32, 77.07, 76.92, 77.25, 77.21, 77.41], '1W': [79.22, 79.35, 78.98, 77.46, 77.41], '1M': [78.1, 79.73, 79.86, 80.2, 81.08, 81, 79.26, 79.5, 76.41, 77.87, 77.39, 77.77, 79.04, 77.62, 77.87, 78.27, 79.22, 79.35, 78.98, 77.46, 77.41], '6M': [73.61, 74.42, 74.07, 74, 76.21, 76.33, 75.95, 77.5, 79.68, 83.55, 83.04, 81, 80.02, 77.96, 79.44, 81.46, 78.65, 78.11, 78.82, 80.55, 79.91, 79.86, 79.26, 77.77, 78.27, 77.41], '1Y': [66.64, 67.78, 67.88, 69.17, 71.57, 71.14, 73.47, 73.33, 71.93, 74.26, 72.39, 71.75, 73.05, 72.35, 80.05, 81, 80.93, 81.16, 80.39, 81.17, 80.91, 80.58, 79.67, 79.73, 75.73, 75.72, 72.67, 74.12, 74.43, 74.94, 76.51, 76.01, 76.2, 77.92, 80.82, 83.47, 83.04, 81, 80.02, 77.7, 79.71, 82.77, 81.05, 79.48, 82.95, 80.43, 79.91, 79.86, 79.26, 77.77, 78.27, 77.41] },
