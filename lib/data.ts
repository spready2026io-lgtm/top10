...
export const SCAN_TIMESTAMP    = '2026-06-13T15:28:18.127Z';
export const SCAN_TIMESTAMP_NY = 'June 13, 2026 at 11:28 AM ET';
...
export const CROSS_THEME_TOP10: CrossThemeEntry[] = [
  { ticker: 'MU', name: `Micron Technology Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 14.49, bestProScore: 6.18, avgProScore: 4.83, price: 981.61, weeklyChange: 3.41 },
  { ticker: 'NVDA', name: `NVIDIA Corp`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 11.52, bestProScore: 6.22, avgProScore: 3.84, price: 205.19, weeklyChange: -1.65 },
  { ticker: 'AMD', name: `Advanced Micro Devices Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 10.82, bestProScore: 4.94, avgProScore: 3.61, price: 511.57, weeklyChange: 4.33 },
  { ticker: 'AVGO', name: `Broadcom Inc`, themeCount: 3, themes: ['AI & ML', 'Semiconductors', 'Broad Tech'], aggregateScore: 6.00, bestProScore: 2.81, avgProScore: 2.00, price: 382.07, weeklyChange: -3.66 },
  ...
  { ticker: 'TSM', name: `Taiwan Semiconductor Manufacturing Co Ltd ADR`, themeCount: 2, themes: ['AI & ML', 'Broad Tech'], aggregateScore: 4.58, bestProScore: 2.88, avgProScore: 2.29, price: 423.93, weeklyChange: -0.67 },
  ...
  { ticker: 'ALAB', name: `Astera Labs Inc`, themeCount: 2, themes: ['AI & ML', 'Semiconductors'], aggregateScore: 3.32, bestProScore: 1.74, avgProScore: 1.66, price: 367.15, weeklyChange: 6.01 },
];
  ...
  'AI & ML': [
    {
      ...
      velocityScore: { '1D': -1.4, '1W': 11.9, '1M': null, '6M': null }, isNew: false,
      marketCap: '$5.0T', pe: 31.4, revenueGrowth: 85, eps: 6.53, grossMargin: 74, dividendYield: 0.49,
      etfPresence: { AIS: 2.44, ARTY: 3.56, BAI: 4.36, IGPT: 5.73, IVES: 4.76, ALAI: 13.49, CHAT: 6.82, AIFD: 6.43, SPRX: 3.66, AOTG: 10.91 },
    ...
    {
      ticker: 'AMD', name: 'Advanced Micro Devices Inc', easyScore: 9, avgWeight: 5.49, proScore: 4.94, coverage: 0.9,
      ...
      velocityScore: { '1D': 0.4, '1W': 4, '1M': null, '6M': null }, isNew: false,
      marketCap: '$834B', pe: 169.4, revenueGrowth: 38, eps: 3.02, grossMargin: 53, dividendYield: null,
      etfPresence: { AIS: 4.63, ARTY: 7.39, BAI: 4.74, IGPT: 7.12, IVES: 5.06, ALAI: 1.08, CHAT: 4.08, AIFD: false, SPRX: 0.52, AOTG: 14.81 },
    ...
    },
    {
      ...
      velocityScore: { '1D': -0.7, '1W': 6.5, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.1T', pe: 46.3, revenueGrowth: 196, eps: 21.2, grossMargin: 58, dividendYield: 0.06,
      etfPresence: { AIS: 8.03, ARTY: 7.85, BAI: 6.23, IGPT: 12.59, IVES: 6.07, ALAI: false, CHAT: 3.87, AIFD: 6.49, SPRX: false, AOTG: 9.61 },
    ...
    },
    {
      ...
      velocityScore: { '1D': -1.4, '1W': 8.1, '1M': null, '6M': null }, isNew: false,
      marketCap: '$1.8T', pe: 63.7, revenueGrowth: 48, eps: 6, grossMargin: 76, dividendYield: 0.68,
      etfPresence: { AIS: 0.67, ARTY: 3.46, BAI: 4.41, IGPT: false, IVES: 4.42, ALAI: 4.04, CHAT: 4.2, AIFD: 5.38, SPRX: false, AOTG: 1.53 },
    ...
    {
      ticker: 'TSM', name: 'Taiwan Semiconductor Manufacturing Co Ltd', easyScore: 6, avgWeight: 4.8, proScore: 2.88, coverage: 0.6,
      ...
      velocityScore: { '1D': -0.7, '1W': 11.6, '1M': null, '6M': null }, isNew: false,
      marketCap: '$2.2T', pe: 36.5, revenueGrowth: 35, eps: 11.62, grossMargin: 62, dividendYield: 0.9,
      etfPresence: { AIS: 3.17, ARTY: false, BAI: 4.37, IGPT: false, IVES: 5.04, ALAI: 5.73, CHAT: false, AIFD: 3.23, SPRX: false, AOTG: 7.26 },
    ...
    {
      ticker: 'ANET', name: 'Arista Networks Inc', easyScore: 6, avgWeight: 2.23, proScore: 1.34, coverage: 0.6,
      ...
      velocityScore: { '1D': -9.5, '1W': -8.8, '1M': null, '6M': null }, isNew: false,
      marketCap: '$206B', pe: 56.1, revenueGrowth: 35, eps: 2.91, grossMargin: 64, dividendYield: null,
      etfPresence: { AIS: 1.42, ARTY: 2, BAI: 1.38, IGPT: false, IVES: false, ALAI: false, CHAT: 2.24, AIFD: 4.71, SPRX: 1.63, AOTG: false },
    ...
    {
      ticker: 'AMZN', name: 'AMAZON.COM INC', easyScore: 5, avgWeight: 4.07, proScore: 2.04, coverage: 0.5,
      ...
      etfPresence: { AIS: false, ARTY: false, BAI: false, IGPT: false, IVES: 4.34, ALAI: 5.88, CHAT: 2.44, AIFD: 3.44, SPRX: false, AOTG: 4.25 },
    ...
    {
      ticker: 'MSFT', name: 'MICROSOFT CORP', easyScore: 5, avgWeight: 3.57, proScore: 1.79, coverage: 0.5,
      ...
      etfPresence: { AIS: false, ARTY: 1.73, BAI: false, IGPT: false, IVES: 4.56, ALAI: 5.43, CHAT: 2.27, AIFD: false, SPRX: false, AOTG: 3.87 },
    ...
    {
      ticker: 'META', name: 'Meta Platforms Inc', easyScore: 5, avgWeight: 3.3, proScore: 1.65, coverage: 0.5,
      ...
      etfPresence: { AIS: false, ARTY: false, BAI: false, IGPT: 4.56, IVES: 4.39, ALAI: 4.23, CHAT: 2.12, AIFD: false, SPRX: false, AOTG: 1.18 },
    ...
    {
      ticker: 'ALAB', name: 'Astera Labs Inc', easyScore: 5, avgWeight: 3.16, proScore: 1.58, coverage: 0.5,
      ...
      etfPresence: { AIS: 1.92, ARTY: 1.83, BAI: false, IGPT: false, IVES: false, ALAI: 1.61, CHAT: 2.68, AIFD: false, SPRX: 7.76, AOTG: false },
    ...
    {
      ticker: 'LITE', name: 'LUMENTUM HOLDINGS INC', easyScore: 4, avgWeight: 3.56, proScore: 1.43, coverage: 0.4,
      ...
      velocityScore: { '1D': 5.1, '1W': 12.6, '1M': null, '6M': null }, isNew: false,
      marketCap: '$72B', pe: 161.4, revenueGrowth: 90, eps: 5.71, grossMargin: 41, dividendYield: null,
      etfPresence: { AIS: false, ARTY: false, BAI: 2.85, IGPT: false, IVES: false, ALAI: false, CHAT: 1.57, AIFD: 6.1, SPRX: 3.74, AOTG: false },
    ...
    },
    {
      ...
      etfPresence: { AIS: 1.59, ARTY: 2.72, BAI: 2.91, IGPT: false, IVES: false, ALAI: 4.3, CHAT: false, AIFD: false, SPRX: false, AOTG: false },
    ...
    {
      ticker: 'STX', name: 'Seagate Technology Holdings PLC', easyScore: 4, avgWeight: 2.81, proScore: 1.13, coverage: 0.4,
      ...
      etfPresence: { AIS: 2.83, ARTY: 3.05, BAI: false, IGPT: 3.3, IVES: false, ALAI: 2.08, CHAT: false, AIFD: false, SPRX: false, AOTG: false },
    ...
    },
    {
      ...
      etfPresence: { AIS: false, ARTY: false, BAI: 1.09, IGPT: false, IVES: 4.49, ALAI: 2.56, CHAT: false, AIFD: 1.91, SPRX: false, AOTG: false },
